...
public final class ListCityAction extends ListAction {

	public void setTotalResults(ListForm listForm) throws ApplicationException {
		
		// Set the default ordering
		if (listForm.getOrderBy() == null) {
			listForm.setOrderBy("City");
		}
	...
	public ActionMessages setLineItems(ListForm listForm)
		...
		CityBD bd = new CityBD(this.getSessionFactoryClusterMap());
		listForm.setLineItems(bd.findCitysByCity(listForm));
		bd=null;
