 ...
 * 	
 */
public final class BuildDischargeorder
{
	...
	public void build(
		...
		try {
			...
			String title=
				resourceProps.getString("title.dischargeorder");
	...
	public void doBody1() throws DocumentException, BadElementException,  Exception
	{
		...
		org.w3c.dom.Element elementOrdhdr1 = null;
		org.w3c.dom.Element elementOrdhdr1Dchaddrkey = null;
		...
		org.w3c.dom.Element elementDespmovcleaning = null;
		org.w3c.dom.Element elementDespmovcleaningFraddrkey = null;



		elementOrdhdr1=(org.w3c.dom.Element) elementDocument.getElementsByTagName("Ordhdr1").item(0);

		try{elementOrdhdr1Dchaddrkey=(org.w3c.dom.Element) elementOrdhdr1.getElementsByTagName("dchaddrkey").item(0);}catch(Exception e){}
		...
		try{elementDespmovcleaning=(org.w3c.dom.Element) elementOrdhdr1.getElementsByTagName("despmovcleaning").item(0);}catch(Exception e){}
		try{elementDespmovcleaningFraddrkey=(org.w3c.dom.Element) elementDespmovcleaning.getElementsByTagName("fraddrkey").item(0);}catch(Exception e){}
		...
		try {
			...
			label.setPhrase(new Phrase(resourceProps.getString("prompt.pickupat"),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(": "+getTagValue("g4ldesc",elementDespmovshippingToaddrkey)+", "+xmlToPdf.countryRule(elementDespmovshippingToaddrkey),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(resourceProps.getString("prompt.dischargeat"),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(": "+getTagValue("name",elementOrdhdr1Dchaddrkey)+", "+getTagValue("addr1",elementOrdhdr1Dchaddrkey),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);	
			label.setPhrase(new Phrase(resourceProps.getString("prompt.emptyreturn"),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(": "+getTagValue("name",elementDespmovcleaningFraddrkey)+", "+getTagValue("addr1",elementDespmovcleaningFraddrkey),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
		...
		try {
			...
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(resourceProps.getString("prompt.blno"),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
		...
		try {
			float[] widths = {0.04f, 0.15f, 0.21f, 0.22f, 0.14f, 0.24f};
			...
			_text.addCell(new Phrase(resourceProps.getString("heading.dischargedatetime"),font));	
	...
	public void doBody2() throws DocumentException, BadElementException,  Exception
	{
		...
		elementOrdhdr1=(org.w3c.dom.Element) elementDocument.getElementsByTagName("Ordhdr1").item(0);
		try{elementOrdhdr1Ordtxt2=(org.w3c.dom.Element) elementOrdhdr1.getElementsByTagName("ordtxt2").item(0);}catch(Exception e){}
		...
		try {
			...
			label.setPhrase(new Phrase(resourceProps.getString("prompt.imo"),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(": "+getTagValue("imo",elementProdcode),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			...
			label.setPhrase(new Phrase(resourceProps.getString("prompt.adrrid"),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(": "+getTagValue("adr",elementOrdprod10Prodcode),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);	
			...
			label.setPhrase(new Phrase(resourceProps.getString("prompt.flashpoint"),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(": "+getTagValue("flashp",elementOrdprod10Prodcode),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
		...
		try {
			...
			label.setPhrase(new Phrase(resourceProps.getString("prompt.specialproducttext"),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(": "+getTagValue("txt2",elementProdcode),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
		...
		try {
			...
			//use notes		
			notes="";
			notes=notes+" "+getTagValue("txt",elementOrdhdr1Ordtxt2)+" "+getTagValue("txt2",elementOrdhdr1Ordtxt2);
	...
	) throws DocumentException, BadElementException,  Exception
	{
		...
		try {
			...
			// plan_loading_date / time
			_text =  new PdfPTable(1);			
			_text.getDefaultCell().setBorder(0);						
			_text.getDefaultCell().setHorizontalAlignment(Element.ALIGN_LEFT);

			_text.addCell(new Phrase(
					xmlToPdf.formatDate(getTagValue("frldgdate",elementOrdhdr))+
					" / "+
					getTagValue("frldgtime",elementOrdhdr),
					font
			));	
	...
	public class HeaderFooterPageEvent extends PdfPageEventHelper {
		...
		public PdfPTable doHeader1() throws DocumentException
		{
			...
			try{elementUserLocationContact1=(org.w3c.dom.Element) elementParamdetails.getElementsByTagName("UserLocation").item(0);}catch(Exception e){}
			...
			try {
				...
				label.setPhrase(new Phrase(resourceProps.getString("prompt.attn"),font));
				label.setHorizontalAlignment(Element.ALIGN_LEFT);
				wrapper.addCell(label);
