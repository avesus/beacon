...
<div id="nav" style="position:absolute; left:10; top:28px; width:120px; height:449px; z-index:1; visibility: visible"> 
...
iPlusDays=document.frmCalendarSample.iPlusDays.value;
//alert(daySel + "" + iMonth + "" + iYear);

document.frmCalendarSample.action="/beacon/ListTimetrack.do?searchDate1dd=" + daySel +"&amp;searchDate1mm=" + iMonth +"&amp;searchDate1yyyy=" + iYear+"&amp;searchString1=" + iUnit+"&amp;searchString2=N"+"&amp;searchString3="+iPlusDays;
...
<script languaje="javascript">  
	document.writeln('<form name="frmCalendarSample" method="post" action="">');
		...
		document.writeln('<input type="hidden" name="calSelectedDate" value="">');
				document.writeln('<input type="hidden" name="iPlusDays" value="5">');
