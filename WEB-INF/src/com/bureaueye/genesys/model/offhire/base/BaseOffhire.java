...
/**
 * This is an object that contains data related to the offhire table.
...
public abstract class BaseOffhire  implements Serializable {

	public static String REF = "Offhire";
	...
	public static String PROP_ESTDELDATE = "Estdeldate";
	 ...
	 */
	public BaseOffhire (java.lang.Integer offhireId) {
		this.setOffhireId(offhireId);
		initialize();
	}
	...
	private java.util.Date estdeldate;
	...
	/**
	 * Return the value associated with the column: estdeldate
	 */
	public java.util.Date getEstdeldate () {
		return estdeldate;
	}

	/**
	 * Set the value related to the column: estdeldate
	 * @param estdeldate the estdeldate value
	 */
	public void setEstdeldate (java.util.Date estdeldate) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.bureaueye.genesys.model.offhire.Offhire)) return false;
		else {
			com.bureaueye.genesys.model.offhire.Offhire offhire = (com.bureaueye.genesys.model.offhire.Offhire) obj;
			if (null == this.getOffhireId() || null == offhire.getOffhireId()) return false;
			else return (this.getOffhireId().equals(offhire.getOffhireId()));
		}
	}

	public int hashCode () {
		if (Integer.MIN_VALUE == this.hashCode) {
			if (null == this.getOffhireId()) return super.hashCode();
			else {
				String hashStr = this.getClass().getName() + ":" + this.getOffhireId().hashCode();
