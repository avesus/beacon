...
<head>
<logic:equal name="JobcostForm" property="action"
...
<!-- BREADCRUMBS -----------------> 
	...
	<bean:message key="prompt.orderno"/>&nbsp;-&nbsp;<bean:write name="ListJobcostForm" property="headerInfo1" scope="session"/>&nbsp;
</span>
		    <span class="header2">
    			<logic:equal name="JobcostForm" property="action" scope="session" value="Create">
		    		<bean:message key="jobcost.title.create"/>
    			</logic:equal>
		    	<logic:equal name="JobcostForm" property="action" scope="session" value="Delete">
		      		<bean:message key="jobcost.title.delete"/>
      			</logic:equal>
		    	<logic:equal name="JobcostForm" property="action" scope="session" value="Edit">
		        	<bean:message key="jobcost.title.edit"/>
     			</logic:equal>	
		    	<logic:equal name="JobcostForm" property="action" scope="session" value="View">
...
<html:link action="/ListJobcost"><span class="header4"><bean:message key="jobcost.title.list"/></span></html:link>
<span class="header2">&gt;</span> 
...
<html:form action="/SaveJobcost" focus="vendoraddrkey.addrkey" onsubmit="return amtCalc();">
...
<html:hidden property="poststatus"/>
	...
	<logic:notEqual name="JobcostForm" property="action"  scope="session" value="Delete"> 
...
<logic:notEqual name="JobcostForm" property="action" scope="session" value="View">         
