...
<img class="NavigationSprite Expand" title="Show More Information" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;"/>
    ...
    <tr>
      <td class="label10"><bean:write name="ListJobhdrcostForm" property="headerInfo1" scope="session"/></td>
      <td class="label10"><bean:write name="ListJobhdrcostForm" property="headerInfo2" scope="session"/></td>
      <td class="label10"></td>              
    </tr>
...
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>  
    	...
    	<tr>
		    <td class="label10"><bean:write name="ListJobhdrcostForm" property="headerInfo9" scope="session"/></td>
		    <td class="label10"><bean:write name="ListJobhdrcostForm" property="headerInfo6" scope="session"/></td>
		    <td class="label10"><bean:write name="ListJobhdrcostForm" property="headerInfo10" scope="session"/></td>                 
		</tr>
	</table>
</div>
...
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>        
    	...
    	<tr>
		    <td class="label10" colspan="3"><bean:write name="ListJobhdrcostForm" property="headerInfo4" scope="session"/></td>               
		</tr>               
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>  
    	<tr>
    	...
    	<tr>
		    <td class="label10"><bean:write name="ListJobhdrcostForm" property="headerInfo3" scope="session"/></td>
		    <td class="label10"><bean:write name="ListJobhdrcostForm" property="headerInfo5" scope="session"/></td>
		    <td class="label10"></td>                 
		</tr>
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>  
    	<tr>
    	...
    	<tr>
		    <td class="label10"><bean:write name="ListJobhdrcostForm" property="headerInfo7" scope="session"/></td>
		    <td class="label10"></td>
		    <td class="label10"></td>                 
		</tr>
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>  
    	...
    	<tr>
		    <td class="label10"><bean:write name="ListJobhdrcostForm" property="headerInfo8" scope="session"/></td>
		    <td class="label10"></td>
		    <td class="label10"></td>                 
		</tr>
...
<html:hidden property="gotoPage" />
	<html:hidden name="ListJobhdrcostForm" property="headerInfo1"/>        
	<html:hidden name="ListJobhdrcostForm" property="id"/>            
...
document.location.href='EditJobhdrcost.do?'+
'&amp;jobhdrId='+
 						...
 						<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
							<tr>
		  						<td class="column-header1" width="35%">              
                    				<button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListJobhdrcost.do?orderBy=Vendoraddrkey&gotoPage=0'">
										<span><bean:message key="heading.vendoraccount"/></span>                        
										<logic:notEqual name="ListJobhdrcostForm" property="orderBy" scope="session" value="Vendoraddrkey">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListJobhdrcostForm" property="orderBy" scope="session" value="Vendoraddrkey">              
		  						...
		  						<td class="column-header2" width="10%">
							         <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListJobhdrcost.do?orderBy=Costkey&gotoPage=0'">
										<span><bean:message key="heading.cost"/></span>          
										<logic:notEqual name="ListJobhdrcostForm" property="orderBy" scope="session" value="Costkey">              
											<img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListJobhdrcostForm" property="orderBy" scope="session" value="Costkey">              
											<img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>  
							        </button>                                                             
								</td>
					  			...
					  			<td class="column-header2" width="10%">
 							        <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListJobhdrcost.do?orderBy=Costtype&gotoPage=0'">
										<span><bean:message key="heading.type"/></span>        
										<logic:notEqual name="ListJobhdrcostForm" property="orderBy" scope="session" value="Costtype">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListJobhdrcostForm" property="orderBy" scope="session" value="Costtype">              
									         <img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>   
							        </button>                        	
								</td>  
					  			...
					  			<td class="column-header2" width="10%">
 							        <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListJobhdrcost.do?orderBy=Ccykey&gotoPage=0'">
										<span><bean:message key="heading.localccy"/></span>        
										<logic:notEqual name="ListJobhdrcostForm" property="orderBy" scope="session" value="Ccykey">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListJobhdrcostForm" property="orderBy" scope="session" value="Ccykey">              
									         <img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>   
							        </button>                        	
								</td>                                  
					  			...
					  			<td class="column-header2" width="10%">
 							        <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListJobhdrcost.do?orderBy=Cstamt&gotoPage=0'">
										<span><bean:message key="heading.amount"/></span>        
										<logic:notEqual name="ListJobhdrcostForm" property="orderBy" scope="session" value="Cstamt">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListJobhdrcostForm" property="orderBy" scope="session" value="Cstamt">              
									         <img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>   
							        </button>                        	
								</td>   
...
<%int row=0;%>			
	<logic:iterate id="jobhdrcostLineItem" name="ListJobhdrcostForm" property="lineItems">
...
<!-- row1 -->            
		<tr>
									<td class="<%= _class2 %>">
						<bean:write name="jobhdrcostLineItem" property="vendoraddrkey.name" filter="true"/>
                                    </td> 
									<td class="<%= _class2 %>">
						<bean:write name="jobhdrcostLineItem" property="costkey.costkey" filter="true"/></td> 
									<td class="<%= _class2 %>">
						<bean:write name="jobhdrcostLineItem" property="costtype" filter="true"/>
                        			</td>									
                                    <td class="<%= _class2 %>">
						<bean:write name="jobhdrcostLineItem" property="ccykey" filter="true"/>
                        			</td>                                    
                                    <td class="<%= _class2 %>" align="right">
						<bean:write name="jobhdrcostLineItem" property="cstamt" filter="true"/>
                        			</td>                                                                                                                                         					 
									<td>
										<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
							<tr>
