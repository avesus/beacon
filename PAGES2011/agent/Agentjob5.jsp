...
<html:form action="/EditAgentjob6" focus="">
...
<table width="1200" border="0" cellspacing="0" cellpadding="0">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
  	...
  	<td align="left" bgcolor="#B0C8E0"><html:img src="images/crumbs/crumb_jobsections3.jpg" width="119" height="34" alt="job sections" border="0"/></td>
  	<td align="left" bgcolor="#B0C8E0"><html:img src="images/crumbs/crumb_notes2.jpg" width="91" height="34" alt="notes" border="0"/></td>
...
<html:link action="/EditAgentJobmov?action=Create">Add a Movement</html:link>  
...
<html:link action="/ListAgentJobcost.do" paramId="jobmovId" paramName="jobmovLineItem" paramProperty="key"><bean:message key="prompt.costs"/></html:link>  																								
&nbsp;|&nbsp;
<html:link action="/EditAgentJobmov.do?action=Delete" paramId="jobmovId" paramName="jobmovLineItem" paramProperty="key">
<bean:message key="prompt.delete"/>
</html:link> 																													
&nbsp;|&nbsp;
<html:link action="/EditAgentJobmov.do?action=Edit" paramId="jobmovId" paramName="jobmovLineItem" paramProperty="key"><bean:message key="prompt.edit"/></html:link>                         
