...
public final class DisplayDocumentversionAction extends BaseAction {
	/**
	...
	throws Exception {
		...
		String xversiondocumentId = request.getParameter("xdocumentversionId");

		Xdocumentversion dao = new XdocumentversionBD(this.getSessionFactoryClusterMap()).read(new Integer(xversiondocumentId));
