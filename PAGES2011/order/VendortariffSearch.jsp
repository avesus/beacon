...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
  <tr>
   <td bgcolor="#f6f6f6"><html:img src="images/icons/icon_vendortariff_search.png" alt="Search" border="0" align="middle"/><span class="heading9">Tariff Search</span></td>  
  </tr>
...
<html:form action="/ListOrderVendortariffSearch" focus="searchString1">
	...
	<div style="OVERFLOW:auto; width:700px; height:450px;">
                      ...
                      <tr>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              <td><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#ffffff">
                                  <tr>
                                    <td width="22%" class="td2"><div align="right">Vendor: </div></td>
		...
		<html:select property="searchString1" styleClass="ftforminputsmall">
			...
			<html:options collection="vendors" property="addrkey" labelProperty="name"/>	
                                  ...
                                  <tr>
                                    <td width="22%" class="td2"><div align="right">Cost: </div></td>
                                    <td width="78%" class="td2">
		<html:select property="searchString2" styleClass="ftforminputsmall"> 
			...
			<html:options collection="costs" property="costkey" labelProperty="descr"/> 
                                  ...
                                  <tr>
                                    <td width="22%" class="td2"><div align="right"> From Location: </div></td>
                                    <td width="78%" class="td2">
		<html:select property="searchString3" styleClass="ftforminputsmall">
			...
			<html:options collection="locations" property="locationkey" labelProperty="labelProperty"/>	
                                  ...
                                  <tr>
                                    <td width="22%" class="td2"><div align="right"> Transhipment Location: </div></td>
                                    <td width="78%" class="td2">
		<html:select property="searchString5" styleClass="ftforminputsmall">
			...
			<html:options collection="locations" property="locationkey" labelProperty="labelProperty"/>	
                                  ...
                                  <tr>
                                    <td width="22%" class="td2"><div align="right"> To Location: </div></td>
                                    <td width="78%" class="td2">
