...
function tariffSearch(){
	...
	var url     = 'EditOrderVendortariffSearch.do?maxResults=999'+
						'&searchString1='+
						...
						'&searchString8='+
                      	document.forms[0].ordermovId.value+
					  	'&searchString9='+
						costtypeValue+ 
					  	'&searchString10='+ 
...
<html:link action="/ListOrdercost"><span class="header4"><bean:message key="ordercost.title.list"/></span></html:link>
<span class="header2">&gt;</span>                             
...
<html:form action="/SaveOrdercost" focus="vendoraddrkey.addrkey" onsubmit="return amtCalc();">
