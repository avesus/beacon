...
<html:html>
  <head>
  <title>
  <bean:message key="billingview.title"/>
  </title>
...
onMouseOver="MM_swapImage('reportButton','','/beacon/images/buttons/btn_report.png','reportButton','','/beacon/images/buttons/btn_report_over.png',1);"/>
          <bean:message key="billingview.title.search"/>
        </h1></td>
    </tr>
    <tr>
    ...
    <tr>
      <td class="billingrunSearchText"><bean:message key="prompt.month"/>
        : </td>
      <td class="billingrunSearchText"><bean:message key="prompt.year"/>
        : </td>		
    </tr>
    <tr>
