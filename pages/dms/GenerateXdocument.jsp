...
<logic:equal name="GenerateXdocumentForm" property="jobmovId" scope="session" value="">
	<html:link action="/ListOrderhdr"><span class="header4"><bean:message key="orderhdr.title.list"/></span></html:link>  
</logic:equal>    
<logic:notEqual name="GenerateXdocumentForm" property="jobmovId" scope="session" value="">
...
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>  
    	...
    	<tr>
		    ...
		    <td class="label10"><bean:write name="GenerateXdocumentForm" property="headerInfo[7]" scope="session"/></td>
		    <td class="label10"></td>                 
		</tr>
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>  
    	<tr>
...
<html:form action="/GenerateXdocument2">
...
<%--                <button class="btnBG2 btnFF" type="submit" name="btnSubmit" value="PRINT"><bean:message key="button.print"/></button>--%>
...
<%--                <button class="btnBG2 btnFF" type="submit" name="btnSubmit" value="EMAIL"><bean:message key="button.email"/></button>--%>
