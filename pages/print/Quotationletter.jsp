...
All business is undertaken subject to the <bean:write name="PrinthdrForm" property="companyheader.companyName" scope="session"/> International Bill of Lading conditions<br/>
<br/>
Commercial Invoices: <bean:write name="PrinthdrForm" property="companyheader.companyName" scope="session"/> is not party to and does not accept any liability due to disputes between Shipper & Consignee <br/>
