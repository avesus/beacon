...
<span class="header2"><bean:message key="quonotecust.title.list"/></span>
...
<img class="NavigationSprite Expand" title="Show More Information" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;"/>
    ...
    <tr>
      <td class="label10"><bean:write name="ListQuonotecustForm" property="headerInfo1" scope="session"/></td>
      <td class="label10"><bean:write name="ListQuonotecustForm" property="headerInfo2" scope="session"/></td>
      <td class="label10"></td>              
    </tr>
...
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>        
    	...
    	<tr>
		    <td class="label10" colspan="3"><bean:write name="ListQuonotecustForm" property="headerInfo4" scope="session"/></td>               
		</tr>           
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>  
    	<tr>
    	...
    	<tr>
		    <td class="label10"><bean:write name="ListQuonotecustForm" property="headerInfo3" scope="session"/></td>
		    <td class="label10"><bean:write name="ListQuonotecustForm" property="headerInfo5" scope="session"/></td>
		    <td class="label10"></td>                 
		</tr>
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>  
    	<tr>
    	...
    	<tr>
		    <td class="label10"><bean:write name="ListQuonotecustForm" property="headerInfo6" scope="session"/></td>
		    <td class="label10"><bean:write name="ListQuonotecustForm" property="headerInfo7" scope="session"/></td>
		    <td class="label10"></td>                 
		</tr>
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>  
    	<tr>
    	...
    	<tr>
		    <td class="label10"><bean:write name="ListQuonotecustForm" property="headerInfo8" scope="session"/></td>
		    <td class="label10"></td>
		    <td class="label10"></td>                 
		</tr>
...
<html:hidden property="gotoPage" />
	<html:hidden name="ListQuonotecustForm" property="headerInfo1"/>        
	<html:hidden name="ListQuonotecustForm" property="id"/>            
...
document.location.href='EditQuonotecust.do?'+
'&amp;quohdrId='+
 						...
 						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
		  						<td class="column-header1" width="10%">              
                    				<button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListQuonotecust.do?orderBy=Createdate&gotoPage=0'">
										<span><bean:message key="heading.date"/></span>                        
										<logic:notEqual name="ListQuonotecustForm" property="orderBy" scope="session" value="Createdate">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListQuonotecustForm" property="orderBy" scope="session" value="Createdate">              
		  						...
		  						<td class="column-header2" width="8%">
							         <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListQuonotecust.do?orderBy=Createtime&gotoPage=0'">
										<span><bean:message key="heading.time"/></span>          
										<logic:notEqual name="ListQuonotecustForm" property="orderBy" scope="session" value="Createtime">              
											<img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListQuonotecustForm" property="orderBy" scope="session" value="Createtime">              
											<img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>  
							        </button>                                                             
								</td>
					  			...
					  			<td class="column-header2" width="8%">
 							        <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListQuonotecust.do?orderBy=Createuserid&gotoPage=0'">
										<span><bean:message key="heading.userid"/></span>        
										<logic:notEqual name="ListQuonotecustForm" property="orderBy" scope="session" value="Createuserid">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListQuonotecustForm" property="orderBy" scope="session" value="Createuserid">              
									         <img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>   
							        </button>                        	
								</td>  
					  			...
					  			<td class="column-header2" width="10%">
 							        <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListQuonotecust.do?orderBy=Category&gotoPage=0'">
										<span><bean:message key="heading.category"/></span>        
										<logic:notEqual name="ListQuonotecustForm" property="orderBy" scope="session" value="Category">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListQuonotecustForm" property="orderBy" scope="session" value="Category">              
									         <img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>   
							        </button>                        	
								</td>                                 
					  			...
					  			<td class="column-header2" width="45%">
 							        <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListQuonotecust.do?orderBy=Note1&gotoPage=0'">
										<span><bean:message key="heading.notes"/></span>        
										<logic:notEqual name="ListQuonotecustForm" property="orderBy" scope="session" value="Note1">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListQuonotecustForm" property="orderBy" scope="session" value="Note1">              
									         <img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>   
							        </button>                        	
								</td> 
...
<%int row=0;%>			
	<logic:iterate id="lineItem" name="ListQuonotecustForm" property="lineItems">
                            
<%String _class = "column-cell1";if ((row % 2) == 0) _class = "column-cell2";%>          
<%row++;%>	

<%
com.bureaueye.beacon.model.quotation.Quonotecust note = 
	(com.bureaueye.beacon.model.quotation.Quonotecust)lineItem;
if (note.getPriority().equals("1")) _class = _class+"Red";
if (note.getPriority().equals("2")) _class = _class+"Blue";
if (note.getPriority().equals("3")) _class = _class+"Green";
%>
		...
		<tr>
					...
					<td class="<%= _class %>" valign="top">
						<bean:write name="lineItem" property="note1" filter="true"/>&nbsp;					
							...
							<tr>				
								<td align="right">
<html:link action="/EditQuonotecust.do?action=Edit" paramId="quonotecustId" paramName="lineItem" paramProperty="quonotecustId"><bean:message key="prompt.edit"/></html:link>
<span class="label5">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
<html:link action="/EditQuonotecust.do?action=Copy" paramId="quonotecustId" paramName="lineItem" paramProperty="quonotecustId"><bean:message key="prompt.copy"/></html:link>
<span class="label5">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
<html:link action="/EditQuonotecust.do?action=Delete" paramId="quonotecustId" paramName="lineItem" paramProperty="quonotecustId">
