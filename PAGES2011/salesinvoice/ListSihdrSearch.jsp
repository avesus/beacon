...
<INPUT name="searchButton" border="0" type="image" id="searchButton" src="images/refreshButtonBorderGrey.gif" align="bottom" onMouseOut="MM_swapImgRestore();" onMouseOver="MM_swapImage('searchButton','','images/refreshButtonBorderGrey.gif','searchButton','','images/refreshButtonBorderGrey_over_blue.gif',1);"/>
    ...
    <tr>
      <td class="text7"><bean:message key="prompt.invoiceno"/>
        : </td>
    </tr>
    <tr>
      <td class="text7"><html:text property="searchString1" size="30" maxlength="40" styleClass="ftforminputsmall" onkeypress="return noenter()"/>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td class="text7"><bean:message key="prompt.docid"/>
        : </td>
    </tr>
    <tr>
      <td class="text7"><html:text property="searchString2" size="30" maxlength="40" styleClass="ftforminputsmall" onkeypress="return noenter()"/>
      </td>
    </tr>
    <tr>
      <td><img src="images/spacer.gif" height="5"/></td>
    ...
    <tr>
      <td class="text7"><bean:message key="prompt.createdate"/>: </td>
    </tr>
    <tr>
