...
<html:html>
<head>
<logic:equal name="QuotationAddressForm" property="action"
            scope="request" value="Create">
<title><bean:message key="title.create"/></title>
</logic:equal><logic:equal name="QuotationAddressForm" property="action"
	...
	<div style="OVERFLOW:auto; width:650px; height:650px; position:relative;">
        <table border="0" cellpadding="5" cellspacing="5" width="100%" bgcolor="#ffffff">
          <tr>
			...
			<html:form action="/SaveAddressCreate" focus="addrkey"> 
                        ...
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#ffffff">
                                  <tr>
                                    <td class="td7"><strong> 
									<logic:equal name="QuotationAddressForm" property="action" scope="request" value="Create"> 
									<bean:message key="address.title.create"/> 
									</logic:equal> 
									<logic:equal name="QuotationAddressForm" property="action" scope="request" value="Delete"> 
									<bean:message key="address.title.delete"/> 
									</logic:equal> <logic:equal name="QuotationAddressForm" property="action" scope="request" value="Edit"> 
...
<logic:notEqual name="QuotationAddressForm" property="action" scope="request" value="Create"> 
					<strong><html:hidden property="addrkey" write="true"/></strong>  
</logic:notEqual> 
										</td>
                                  </tr>
								  <logic:notEqual name="QuotationAddressForm" property="action"
                     scope="request" value="Create">
                                  <tr>
                                    <td width="22%" class="td2"><div align="right"> <bean:message key="prompt.type"/>: </div></td>
                                    <td width="78%" class="td2">
									<strong><html:hidden property="typekey" write="true"/></strong>
									</td>
                                  </tr>								  
								  				 </logic:notEqual>
												 								  <logic:equal name="QuotationAddressForm" property="action"
		...
		<html:select property="rentaddrkey" 
			...
			<html:options collection="customers" property="addrkey" labelProperty="name"/>	
							...
							<tr>
                              <td><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#ffffff">
                                  <tr>
                                    <td class="td1"><logic:equal name="QuotationAddressForm" property="action"
                  scope="request" value="Create"> <html:submit styleClass="button1"> <bean:message key="button.add"/> </html:submit> </logic:equal> <logic:equal name="QuotationAddressForm" property="action"
                  scope="request" value="Delete"> <html:submit styleClass="button1"> <bean:message key="button.confirm"/> </html:submit> </logic:equal> <logic:equal name="QuotationAddressForm" property="action"
                  scope="request" value="Edit"> <html:submit styleClass="button1"> <bean:message key="button.save"/> </html:submit> </logic:equal> <logic:notEqual name="QuotationAddressForm" property="action"
