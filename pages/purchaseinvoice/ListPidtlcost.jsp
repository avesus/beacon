...
<div id="header" style="position:absolute; left:5px; width:600px; height:50px; z-index:10; visibility: visible; border-left:solid 1px #C6C6C6;  border-right:solid 1px #C6C6C6; border-bottom:solid 1px #C6C6C6; background-color:#FFF;">
    ...
    <tr>
		    ...
		    <td class="label11" width="25%"><bean:message key="prompt.jobno"/>&nbsp;/&nbsp;<bean:message key="prompt.orderno"/></td>                  
...
<img class="NavigationSprite Expand" title="Show More Information" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;"/>
    ...
    <tr>
		    <td class="label10"><bean:write name="ListPidtlcostForm" property="headerInfo1" scope="session"/></td>
		    <td class="label10"><bean:write name="ListPidtlcostForm" property="headerInfo3" scope="session"/></td> 
		    <td class="label10"><bean:write name="ListPidtlcostForm" property="headerInfo8" scope="session"/>&nbsp;/&nbsp;<bean:write name="ListPidtlcostForm" property="headerInfo9" scope="session"/></td>              
    </tr>
...
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>        
    	...
    	<tr>
		    <td class="label10" colspan="4"><bean:write name="ListPidtlcostForm" property="headerInfo5" scope="session"/></td>               
		</tr>           
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>  
    	<tr>
    	...
    	<tr>
		    <td class="label10" colspan="2"><bean:write name="ListPidtlcostForm" property="headerInfo2" scope="session"/></td>
		    <td class="label10" colspan="2"><bean:write name="ListPidtlcostForm" property="headerInfo4" scope="session"/></td>               
		</tr>
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>  
    	<tr>
      		<td class="label11" colspan="2"><bean:message key="prompt.invoiceamt"/></td>
		    <td class="label11" colspan="2">&nbsp;</td>  
 		</tr>       
    	<tr>
		    <td class="label10" colspan="2"><bean:write name="ListPidtlcostForm" property="headerInfo7" scope="session"/></td>
...
<html:hidden property="gotoPage" />
	<html:hidden name="ListPidtlcostForm" property="headerInfo1"/> <!--pino--> 
	<html:hidden name="ListPidtlcostForm" property="headerInfo10"/> <!--postedflag-->       
	<html:hidden name="ListPidtlcostForm" property="id"/>            
...
<c:if test="${!ListPidtlcostForm.headerInfo10}">                                   
						<button id="addButton" class="btn btnFF" type="button" onClick="
document.location.href='EditPidtlcost.do?'+
'&amp;pidtlId='+
       				...
       				<td width="100%">   
 						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
		  						...
		  						<td width="10%" class="column-header3" nowrap>&nbsp;</td>
							</tr>
                
<%int row=0;%>			
	<logic:iterate id="lineItem" name="ListPidtlcostForm" property="lineItems">
