...
public final class EditOnhireAction extends BaseAction {
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		OnhireForm editForm = (OnhireForm) form;
		...
		if (!(action == null || action.equals("Create"))) {
			...
			dto = new OnhireBD(this.getSessionFactoryClusterMap())
