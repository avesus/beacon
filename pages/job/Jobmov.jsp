...
<!-- BREADCRUMBS -----------------> 
	...
	<bean:message key="prompt.orderno"/>&nbsp;-&nbsp;<bean:write name="ListJobmovForm" property="headerInfo1" scope="session"/>&nbsp;
</span>
		    <span class="header2">
    			<logic:equal name="JobmovForm" property="action" scope="session" value="Create">
		    		<bean:message key="jobmov.title.create"/>
    			</logic:equal>
		    	<logic:equal name="JobmovForm" property="action" scope="session" value="Delete">
		      		<bean:message key="jobmov.title.delete"/>
      			</logic:equal>
		    	<logic:equal name="JobmovForm" property="action" scope="session" value="Edit">
		        	<bean:message key="jobmov.title.edit"/>
     			</logic:equal>	
		    	<logic:equal name="JobmovForm" property="action" scope="session" value="View">
...
<html:form action="/SaveJobmov" focus="sectionkey.sectionkey" onsubmit="javascript:return WebForm_OnSubmit();">
...
<td class="label2"><html:img src="images/spacer.gif" alt="default" border="0" align="middle" width="18" height="18"/></td>                                    
                                    <td class="label2">                                                                       
		<html:select property="actfromdatedd" disabled="true" styleClass="forminput1">
			<html:option value=""><bean:message key="prompt.day"/></html:option>				
			<html:options collection="days" property="value" labelProperty="label"/>	
		</html:select>		  
		<html:select property="actfromdatemm" disabled="true" styleClass="forminput1">
			<html:option value=""><bean:message key="prompt.month"/></html:option>				
			<html:options collection="months" property="value" labelProperty="label"/>	
		</html:select>
		<html:select property="actfromdateyyyy" disabled="true" styleClass="forminput1">
			<html:option value=""><bean:message key="prompt.year"/></html:option>				
			<html:options collection="years" property="value" labelProperty="label"/>	
		</html:select>
		/
		<html:select property="actfromtimehh" disabled="true" styleClass="forminput1">
			<html:option value="00">HH</html:option>				
			<html:options collection="hours" property="value" labelProperty="label"/>	
		</html:select>:		  
		<html:select property="actfromtimemm" disabled="true" styleClass="forminput1">
			<html:option value="00">MM</html:option>				
			<html:options collection="minutes" property="value" labelProperty="label"/>	
		</html:select>		
                                    </td>
<td class="label2"><html:img src="images/spacer.gif" alt="default" border="0" align="middle" width="18" height="18"/></td>                                    
<td class="label2">
		<html:select property="acttodatedd" disabled="true" styleClass="forminput1">
			<html:option value=""><bean:message key="prompt.day"/></html:option>				
			<html:options collection="days" property="value" labelProperty="label"/>	
		</html:select>		  
		<html:select property="acttodatemm" disabled="true" styleClass="forminput1">
			<html:option value=""><bean:message key="prompt.month"/></html:option>				
			<html:options collection="months" property="value" labelProperty="label"/>	
		</html:select>
		<html:select property="acttodateyyyy" disabled="true" styleClass="forminput1">
			<html:option value=""><bean:message key="prompt.year"/></html:option>				
			<html:options collection="years" property="value" labelProperty="label"/>	
		</html:select>
		/
		<html:select property="acttotimehh" disabled="true" styleClass="forminput1">
			<html:option value="00">HH</html:option>				
			<html:options collection="hours" property="value" labelProperty="label"/>	
		</html:select>:		  
		<html:select property="acttotimemm" disabled="true" styleClass="forminput1">
			<html:option value="00">MM</html:option>				
			<html:options collection="minutes" property="value" labelProperty="label"/>	
		</html:select> 	 
                                    </td>                                    
