...
<tr><td><table border="0" cellpadding="1" cellspacing="3" bgcolor="#ffffff" width="210px">      
    ...
    <tr>
      <td class="label2"><bean:message key="prompt.pino"/>:</td>
    </tr>
    <tr>
      <td class="label2">
...
<tr><td><table border="0" cellpadding="1" cellspacing="3" bgcolor="#ffffff" width="210px">   
    ...
    <tr>
      <td class="label2"><bean:message key="prompt.vendor"/>: </td>
    </tr>
    <tr>
      <td class="label2">
<html:select property="searchString3" styleClass="forminput1">
    ...
    <tr>
      <td class="label2"><bean:message key="prompt.invoicedate"/>: </td>
    </tr>
    <tr>
      <td class="label2">
...
<tr><td><table border="0" cellpadding="1" cellspacing="3" bgcolor="#ffffff" width="210px">  
    ...
    <tr>
      <td class="label2"><bean:message key="prompt.sortorder"/>
        :</td>
    </tr>
    <tr>
      <td class="label2">
			<html:select property="orderByDesc" styleClass="forminput1">
