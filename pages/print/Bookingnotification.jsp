...
<html:form action="/SaveBookingnotification">
...
<table width="100%"  border="0" cellpadding="3" cellspacing="3">
        <tr>
          <td width="30%" class="body3black">Shipper:</td>
          <td width="70%" class="body2"><bean:write name="PrinthdrForm" property="shipper" scope="session"/>&nbsp;</td>
        </tr>
        <tr>
          <td width="30%" class="body3black">Consignee:</td>
          <td width="70%" class="body2"><bean:write name="PrinthdrForm" property="consignee" scope="session"/>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          <td width="30%" class="body3black">Pickup at:</td>
          <td width="70%" class="body2"><bean:write name="PrinthdrForm" property="pickupPlant" scope="session"/>&nbsp;</td>
        </tr>
    </table>
</td>
<td width="70%">
<table width="100%"  border="0" cellpadding="3" cellspacing="3">
        <tr>
          <td width="15%" class="body3black">Shipper Ref:</td>
          <td width="85%" class="body2"><bean:write name="PrinthdrForm" property="shipperRef" scope="session"/></td>
        </tr>
        <tr>
          <td width="15%" class="body3black">Consignee Ref:</td>
          <td width="85%" class="body2"><bean:write name="PrinthdrForm" property="consigneeRef" scope="session"/></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td width="85%" class="body3black">&nbsp;</td>
        </tr>
    </table>
</td>
</tr>
