...
<!-- BREADCRUMBS -----------------> 
	...
	<bean:message key="prompt.quotno"/>&nbsp;-&nbsp;<bean:write name="ListQuochargeForm" property="headerInfo1" scope="session"/>&nbsp;
</span>
		    <span class="header2">
    			<logic:equal name="QuochargeForm" property="action" scope="session" value="Create">
		    		<bean:message key="quocharge.title.create"/>
    			</logic:equal>
		    	<logic:equal name="QuochargeForm" property="action" scope="session" value="Delete">
		      		<bean:message key="quocharge.title.delete"/>
      			</logic:equal>
		    	<logic:equal name="QuochargeForm" property="action" scope="session" value="Edit">
		        	<bean:message key="quocharge.title.edit"/>
     			</logic:equal>	
		    	<logic:equal name="QuochargeForm" property="action" scope="session" value="View">
...
<html:link action="/ListQuocharge"><span class="header4"><bean:message key="quocharge.title.list"/></span></html:link>
<span class="header2">&gt;</span>                             
        ...
        <html:text property="chgamt" size="20" readonly="true" maxlength="20" styleClass="forminput1"/>	
							...
							<table border="0" cellpadding="5" cellspacing="5" width="100%" bgcolor="#ffffff">   
         							...
         							<tr><td class="label2"><bean:message key="prompt.tariffid"/>:</td></tr>
              						<tr><td class="label2">
        <html:text property="custtarfhdrId" size="20" maxlength="20" styleClass="forminput1"/>
              						</td></tr>
