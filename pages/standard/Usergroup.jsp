...
<head>
<logic:equal name="UsergroupForm" property="action"
...
<!-- BREADCRUMBS -----------------> 
		<tr bgcolor="#F1F1F1"><td><span class="header2">
    			<logic:equal name="UsergroupForm" property="action" scope="request" value="Create">
		    		<bean:message key="usergroup.title.create"/>
    			</logic:equal>
		    	<logic:equal name="UsergroupForm" property="action" scope="request" value="Delete">
		      		<bean:message key="usergroup.title.delete"/>
      			</logic:equal>
		    	<logic:equal name="UsergroupForm" property="action" scope="request" value="Edit">
		        	<bean:message key="usergroup.title.edit"/>
     			</logic:equal>		  
          		&gt;
            </span>
...
<html:form action="/SaveUsergroup" focus="usergroupid">
...
<html:hidden property="readonly"/>
								...
								<td><html:img src="images/spacer.gif" border="0" width="1" height="1"/></td>
       							...
       							<td width="100%">      
				      				<table border="0" cellpadding="5" cellspacing="5" width="100%" bgcolor="#ffffff">
							    		...
							    		<tr><td class="label2">
                                        <html:text property="usergroupid" size="20" maxlength="150" disabled="true" styleClass="forminput1"/>
				        	...
				        	<logic:notEqual name="UsergroupForm" property="action"  scope="request" value="Delete"> 
								...
								<table border="0" cellpadding="5" cellspacing="5" width="100%" bgcolor="#ffffff">                                    
									<tr><td class="label2"><bean:message key="prompt.usergroupid"/>:</td></tr>
              						<tr><td class="label2">
		  <c:if test="${UsergroupForm.action == 'Create'}">
        	<html:text property="usergroupid" size="30" maxlength="20" styleClass="forminput1"/>
		  </c:if>
		  <c:if test="${UsergroupForm.action != 'Create'}">
        	<html:text property="usergroupid" size="30" disabled="true" maxlength="20" styleClass="forminput1"/>
			<html:hidden property="usergroupid"/>			
		  </c:if>	                                    
                                    </td></tr>
                        		...
                        		<tr><td colspan="2"><img src="images/spacer.gif" height="5"/></td></tr>  
             					...
             					<tr><td class="label1" colspan="2">Email Details</td></tr>  
