...
<tr>
	<td class="tdwht"><span class="heading2">     
		...
		<span class="heading2">
			<html:link action="/ListG1code" styleClass="link4">
...
<logic:equal name="G1codeForm" property="action"
  ...
  <tr>
	...
	<table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#999999">  				
        ...
        <logic:notEqual name="G1codeForm" property="action"
                     scope="request" value="Delete"> 
  <tr>
    <td><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#999999">
        <tr>
		  ...
		  <c:if test="${G1codeForm.action == 'Create'}">
        	<html:text property="g1codekey" size="30" maxlength="20" styleClass="ftforminputsmall"/>
		  </c:if>
		  <c:if test="${G1codeForm.action != 'Create'}">
