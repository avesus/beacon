...
public final class QuomovcostForm extends BaseForm {
	...
	// primary key
	private java.lang.String _quocostId;
     ...
     *  column="QUOCOST_ID"
     */
	public java.lang.String getQuocostId () {
		return _quocostId;
	}
	/**
	 ...
	 */
	public void setQuocostId (java.lang.String _quocostId) {
	 ...
	 * @param _quomovId the QUOMOV_ID value
	 */
	...
	protected ArrayList keysToSkip() {
		...
		keysToSkip.add("vendtarfhdrId");
		keysToSkip.add("quotno");
		keysToSkip.add("vendorEmail");
		keysToSkip.add("unitname");
