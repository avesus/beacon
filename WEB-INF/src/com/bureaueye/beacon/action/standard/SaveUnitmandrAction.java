...
public final class SaveUnitmandrAction extends BaseAction {
	...
	throws Exception {
		...
		UnitmandrForm saveForm = (UnitmandrForm) form;
		...
		UnitmandrBD bd = new UnitmandrBD(this.getSessionFactoryClusterMap());
		
		// set primary key
		Integer pk = null;		
		try {
			pk = new Integer(saveForm.getUnitmandrId());			
		} catch (Exception e) {}
		// find data-access-object using primary key
		Unitmandr dto = bd.read(pk);
		...
		if (action.equals("Delete")) {		
			bd.delete(new Unitmandr(pk), user);		
		} else {
