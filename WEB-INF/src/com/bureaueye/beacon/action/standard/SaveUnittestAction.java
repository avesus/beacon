...
public final class SaveUnittestAction extends BaseAction {
	...
	throws Exception {
		...
		UnittestForm saveForm = (UnittestForm) form;
		...
		UnittestBD bd = new UnittestBD(this.getSessionFactoryClusterMap());
		
		// set primary key
		Integer pk = null;		
		try {
			pk = new Integer(saveForm.getUnittestId());			
		} catch (Exception e) {}
		// find data-access-object using primary key
		Unittest dto = bd.read(pk);
		...
		if (action.equals("Delete")) {		
			bd.delete(new Unittest(pk), user);		
		} else {
