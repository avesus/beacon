 ...
 * 	
 */
public final class BuildLoadingorder
{
	...
	public void build(
		...
		try {
			...
			String title=
				resourceProps.getString("title.loadingorder");
	...
	public void doBody1() throws DocumentException, BadElementException,  Exception
	{
		...
		org.w3c.dom.Element elementOrdhdr1 = null;
		org.w3c.dom.Element elementOrdhdr1Ldgaddrkey = null;

		org.w3c.dom.Element elementOrdlogis03= null;//export agent
		...
		try{elementOrdhdr1Ldgaddrkey=(org.w3c.dom.Element) elementOrdhdr1.getElementsByTagName("ldgaddrkey").item(0);}catch(Exception e){}
		...
		try {
			...
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(resourceProps.getString("prompt.loadreturned"),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(": "+getTagValue("g4ldesc",elementDespmovshippingToaddrkey)+", "+xmlToPdf.countryRule(elementDespmovselectedToaddrkey),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);	
			label.setPhrase(new Phrase(resourceProps.getString("prompt.loadingat"),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(": "+getTagValue("name",elementOrdhdr1Ldgaddrkey)+", "+getTagValue("addr1",elementOrdhdr1Ldgaddrkey),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
		...
		try {
			...
			label.setPhrase(
					new Phrase(
							...
							" "+
							getTagValue("frtime",elementDespmovshipping)+
							" / "+
		...
		try {
			...
			label.setPhrase(new Phrase(resourceProps.getString("prompt.agent"),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(": "+getTagValue("name",elementOrdlogis03),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
		...
		try {
			float[] widths = {0.04f, 0.11f, 0.17f, 0.18f, 0.15f, 0.15f, 0.20f};
	...
	public void doBody2() throws DocumentException, BadElementException,  Exception
	{
		...
		try {
			...
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(": "+getTagValue("adr",elementProdcode),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
	...
	public void doFooter() throws DocumentException, BadElementException, Exception
	{
		...
		try {
			...
			label.setPhrase(new Phrase(resourceProps.getString("prompt.additionaltransportationcharges"),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
