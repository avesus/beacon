...
<html:html>
  <head>
  <title>
  <bean:message key="contract.title"/>
  </title>
...
<%--      <td height="20" bgcolor="#CCCCCC">&nbsp;</td>--%>
      <td class="tdwht" colspan="4"><span class="heading2"> <strong>
        ...
        <html:link action="/ListContract" styleClass="link5">
...
<html:form action="/ListContract" focus="searchString1">
	<html:hidden property="gotoPage" />
          <jsp:include page="/pages/contract/ListContractSearch.jsp" flush="true" />
          <jsp:include page="/pages/contract/ListContractResults.jsp" flush="true" />
</html:form>	
