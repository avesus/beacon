...
<head>
<logic:equal name="OrdermovcostForm" property="action"
...
<!-- BREADCRUMBS -----------------> 
	...
	<bean:message key="prompt.orderno"/>&nbsp;-&nbsp;<bean:write name="ListOrdermovcostForm" property="headerInfo1" scope="session"/>&nbsp;
</span>
		    <span class="header2">
    			<logic:equal name="OrdermovcostForm" property="action" scope="session" value="Create">
		    		<bean:message key="ordermovcost.title.create"/>
    			</logic:equal>
		    	<logic:equal name="OrdermovcostForm" property="action" scope="session" value="Delete">
		      		<bean:message key="ordermovcost.title.delete"/>
      			</logic:equal>
		    	<logic:equal name="OrdermovcostForm" property="action" scope="session" value="Edit">
		        	<bean:message key="ordermovcost.title.edit"/>
     			</logic:equal>	
		    	<logic:equal name="OrdermovcostForm" property="action" scope="session" value="View">
		        	<bean:message key="ordermovcost.title.view"/>
     			</logic:equal>	 
                </span>
                <span class="header2">&gt;</span>               	  

<html:link action="/ListOrdermovcost"><span class="header4"><bean:message key="ordermovcost.title.list"/></span></html:link>
<span class="header2">&gt;</span>  			             
...
<html:form action="/SaveOrdermovcost" focus="vendoraddrkey.addrkey" onsubmit="return amtCalc();">
...
<html:hidden name="user" property="securitylevel"/>
		...
		<html:select property="costkey" disabled="true" styleClass="forminput1"> 
			...
			<html:options collection="costs" property="costkey" labelProperty="descr"/> 
				        	...
				        	<logic:notEqual name="OrdermovcostForm" property="action"  scope="session" value="Delete"> 
...
<logic:notEqual name="OrdermovcostForm" property="action" scope="session" value="View">         
