...
<script type="text/javascript" language="javascript">
  ...
  <title><bean:message key="ordernote.title.create"/></title>
</logic:equal>
<logic:equal name="OrdernoteForm" property="action"
            scope="request" value="Delete">
  <title><bean:message key="ordernote.title.delete"/></title>
</logic:equal>
<logic:equal name="OrdernoteForm" property="action"
            scope="request" value="Edit">
  <title><bean:message key="ordernote.title.edit"/></title>
</logic:equal>
<logic:equal name="OrdernoteForm" property="action"
            scope="request" value="View">
  <title><bean:message key="ordernote.title.view"/></title>
</logic:equal> 
...
<logic:equal name="OrdernoteForm" property="action"
  ...
  <bean:message key="ordernote.title.view"/>
      ...
      <logic:notEqual name="OrdernoteForm" property="action"
                     scope="request" value="Delete">  
  ...
  <tr>
	...
	<table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#999999">
      <tr>
		...
		&nbsp;<bean:write name="OrdernoteForm" property="createdate_" format="dd-MMM-yyyy" scope="request"/>
</span>
		</td>	      </tr>
      <tr>  
        <td width="40%" class="td2">
        ...
        <td width="60%" class="td2">
		<span  styleClass="ftforminputsmall">
		&nbsp;<bean:write name="OrdernoteForm" property="createtime_" scope="request"/>		
</span>
		</td>			
      </tr>	  
      <tr>  
