...
<html:html>
<head>
<title>Job Cost Actuals Vs Estimate</title>
...
<tr>
	<td class="tdwht"><span class="heading2">     
		<strong>Job Cost Actuals Vs Estimate</strong> 
		</span>					
	</td> 
</tr>  
...
<html:form action="/ReportJobActualEstimate" focus="searchString2">
...
&nbsp;
      ...
      <tr>
        <td align="left" class="text7"><bean:message key="prompt.vendor"/>:</td>
      </tr>
      <tr>
     ...
     <tr>
      <td align="left" class="text7"><bean:message key="prompt.jobno"/>
        :</td>
    </tr>
    <tr>
      ...
      <tr>
        <td align="left" class="text7"><bean:message key="prompt.cost"/>:</td>
      </tr>
      <tr>
        <td align="left" >
      ...
      <tr>
        <td align="left" valign="top"><span class="ftformradiosmall"> </span> <span class="ftformradiosmall">
          <html:select property="orderBy" styleClass="ftforminputsmall">
            <html:option value="Orderno">Order Number</html:option>
            <html:option value="Orderdate">Order Date</html:option>
          </html:select>
