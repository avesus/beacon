...
<%--      <td height="20" bgcolor="#CCCCCC">&nbsp;</td>--%>  
	<td class="tdwht"><span class="heading2">     
		<strong><bean:message key="location.title"/></strong> 
		</span>
		<span class="heading2">
			<html:link action="/ListLocation" styleClass="link5">
...
&nbsp;<bean:message key="prompt.location.search"/>
</h1>
</td></tr>
...
<logic:equal name="ListLocationForm" property="orderBy"
			scope="session" value="LocationType">
	<html:link action="/ListLocation?orderBy=LocationName&gotoPage=0" styleClass="link6"><bean:message key="prompt.name"/></html:link>	
</logic:equal>
<logic:equal name="ListLocationForm" property="orderBy"
			scope="session" value="LocationName">
...
<logic:equal name="ListLocationForm" property="orderBy"
			scope="session" value="LocationName">
			<span class="link4">
	<html:link action="/ListLocation?orderBy=LocationType&gotoPage=0" styleClass="link6"><bean:message key="prompt.type"/></html:link>	
			</span>
</logic:equal>
	</td>	
  </tr>
...
<table border="0" cellpadding="2" cellspacing="2" width="100%" bgcolor="#ffffff">
  <tr>
	<td align="right">
<%--<logic:equal name="ListLocationForm" property="firstPage"
			scope="session" value="false">			
<INPUT type="image" id="startButton" name="startButton" src="images/arrow_start.gif"/>
 </logic:equal>	
<logic:notEqual name="ListLocationForm" property="firstPage"
			scope="session" value="false">
...
<logic:equal name="ListLocationForm" property="lastPage"
			scope="session" value="false">
<INPUT type="image" id="nextButton" name="nextButton" src="images/arrow_next.gif"/>				
</logic:equal>
<logic:notEqual name="ListLocationForm" property="lastPage"
			scope="session" value="false">
	...
	<tr>
		<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
				<tr>
		  			<td class="tddkgry" width="100%" colspan="2">
...
<html:link action="/EditLocation?action=Create"><bean:message key="prompt.location.add"/></html:link>								
								</td>
							</tr>
						</table>
					</td>										
				...
				<span class="text2">
					<td width="100%" colspan="2" class="<%= _class %>">
						<table border="0" cellspacing="0" cellpadding="0" width="100%">
							<tr>
								<td class="text2">
									<bean:write name="locationLineItem" property="locationName" filter="true"/>
								</td>
								<td align="right">												
...
<app:linkLocationLineItem page="/EditLocation.do?action=Copy"><bean:message key="prompt.copy"/></app:linkLocationLineItem>							  
				...
				<span class="text2">
					<td class="<%= _class %>" width="10%">
						<bean:write name="locationLineItem" property="locationType" filter="true"/>
					</td> 
					<td class="<%= _class %>" width="90%">
						<bean:write name="locationLineItem" property="address1" filter="true"/>
						<bean:write name="locationLineItem" property="address2" filter="true"/>&nbsp;
						<bean:write name="locationLineItem" property="address3" filter="true"/>&nbsp;
						<bean:write name="locationLineItem" property="city" filter="true"/>&nbsp;						
						<bean:write name="locationLineItem" property="postalcode" filter="true"/>																		
					</td> 										 
				</span>
  				</tr>				
			</logic:iterate>
