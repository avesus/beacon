...
<tr bgcolor="#F1F1F1"><td><span class="header2">Location Lookup List</span></td></tr> 
...
<html:radio property="searchString15" idName="locationSearchLineItem" value="locationkey" onclick="setLocation(this.value)"/>
                          ...
                          <td class="<%= _class %>"><bean:write name="locationSearchLineItem" property="locationName" filter="true"/></td> 

									<td class="<%= _class %>"><bean:write name="locationSearchLineItem" property="locationType" filter="true"/></td>                                    
									<td class="<%= _class %>">
