...
<!-- BREADCRUMBS -----------------> 
	...
	<bean:message key="prompt.quotno"/>&nbsp;-&nbsp;<bean:write name="ListQuoprodForm" property="headerInfo1" scope="session"/>&nbsp;
</span>
		    <span class="header2">
    			<logic:equal name="QuoprodForm" property="action" scope="session" value="Create">
		    		<bean:message key="quoprod.title.create"/>
    			</logic:equal>
		    	<logic:equal name="QuoprodForm" property="action" scope="session" value="Delete">
		      		<bean:message key="quoprod.title.delete"/>
      			</logic:equal>
		    	<logic:equal name="QuoprodForm" property="action" scope="session" value="Edit">
		        	<bean:message key="quoprod.title.edit"/>
     			</logic:equal>	
		    	<logic:equal name="QuoprodForm" property="action" scope="session" value="View">
		        	<bean:message key="quoprod.title.view"/>
     			</logic:equal>	 
                </span>
                <span class="header2">&gt;</span>               	  

			             
<html:link action="/ListQuoprod"><span class="header4"><bean:message key="quoprod.title.list"/></span></html:link>
<span class="header2">&gt;</span>                             
...
<html:hidden property="quohdrId"/>
        ...
        <html:text property="comprt" size="10" maxlength="5" disabled="true" styleClass="forminput1"/>
				        	...
				        	<logic:notEqual name="QuoprodForm" property="action"  scope="session" value="Delete"> 
