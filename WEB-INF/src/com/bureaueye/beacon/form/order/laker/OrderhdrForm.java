package com.bureaueye.beacon.form.order.laker;
...
public final class OrderhdrForm extends BaseForm  {
	...
	private java.lang.String shipvessel2;	
	...
	public java.lang.String getShipvessel2 () {
		return shipvessel2;
	}
	public void setShipvessel2 (java.lang.String shipvessel2) {
		this.shipvessel2 = shipvessel2;
	}
	...
	public ActionErrors validate(ActionMapping mapping,
		...
		if ((_ldglocationkey2 == null) || (_ldglocationkey2.length() < 1))
			errors.add("ldglocationkey2",
					new ActionMessage("error.portlocation.required"));      	


		if (shipvessel.equals("") && shipvessel2.equals("")) {
			errors.add("shipvessel",
					new ActionMessage("error.vesselkey.required"));    
		}
		...
		if (date == null) errors.add("ldgfromdatedd", new ActionMessage("error.fromdate.required")); 
		...
		if (date == null) errors.add("ldgtodatedd", new ActionMessage("error.todate.required")); 
		...
		try {
			...
			if (calendarDchfromDate.before(calendarLdgfromDate))
				errors.add("ldgtodatedd",
						new ActionMessage("error.todate.afterfromdate"));  
