/*
 * $Id: WorkflowLineItem.java 12/09/2005 ntankard
 */
...
public final class WorkflowLineItem extends ActionForm {
	...
	public WorkflowLineItem (
				Quoapprove quoapprove, 
				Quohdr quohdr
				) {
	 ...
	 * @param _quoapproveId the new ID
	 */
	 ...
	 * @param _expirydate the expirydate value
	 */
    ...
    /**
     */
    public java.util.Date getQuotedate() {	return (this._quotedate); }
    public void setQuotedate(java.util.Date _quotedate) { this._quotedate = _quotedate; }
