...
document.location.href='EditOrderfile.do?'+
'&amp;orderhdrId='+
 						...
 						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
		  						<td class="column-header1" width="10%">              
                    				<button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListOrderfile.do?orderBy=Createdate&gotoPage=0'">
		  						...
		  						<td class="column-header2" width="10%">
							         <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListOrderfile.do?orderBy=Createtime&gotoPage=0'">
					  			...
					  			<td class="column-header2" width="10%">
 							        <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListOrderfile.do?orderBy=Createuserid&gotoPage=0'">
					  			...
					  			<td class="column-header2" width="50%">
 							        <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListOrderfile.do?orderBy=Description&gotoPage=0'">
...
<orderapp:linkOrderfileLineItem page="/EditOrderfile.do?action=View"><bean:message key="prompt.view"/></orderapp:linkOrderfileLineItem><span class="label5">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
