 ...
 * 	
 */
public final class BuildArrivalnotice
{
	...
	public void build(
		...
		try {
			...
			String title=
				resourceProps.getString("title.arrivalnotice");
	...
	public void doBody1() throws DocumentException, BadElementException,  Exception
	{
		...
		try {
			...
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(": "+getTagValue("name",elementDespmovselectedFraddrkey)+", "+getTagValue("addr1",elementDespmovselectedFraddrkey),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);

			label.setPhrase(new Phrase(resourceProps.getString("prompt.portofloading"),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(": "+getTagValue("g4ldesc",elementDespmovshippingFraddrkey)+", "+xmlToPdf.countryRule(elementDespmovshippingFraddrkey),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);

			label.setPhrase(new Phrase(resourceProps.getString("prompt.portofdischarge"),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			...
			label.setPhrase(new Phrase(resourceProps.getString("prompt.arrivalterminal"),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(": "+getTagValue("ITLoc",elementOrdhdr1),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);	


			if (getTagValue("descr",elementDelterm).endsWith("DOOR")) {
				label.setPhrase(new Phrase(resourceProps.getString("prompt.dischargeaddress"),font));
				label.setHorizontalAlignment(Element.ALIGN_LEFT);
				wrapper.addCell(label);
		...
		try {
			...
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(resourceProps.getString("prompt.lloydsno"),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(": "+getTagValue("VesselLloydsNo",elementDespmovshipping),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);			
		...
		try {
			float[] widths = {0.04f, 0.21f, 0.25f, 0.25f, 0.25f};
			...
			_text.addCell(new Phrase(resourceProps.getString("heading.releaseref"),font));			
			...
			PdfPCell _wrapperCell9 = new PdfPCell(_wrapper);
			_wrapperCell9.setBackgroundColor(colorLinen);

			_Table1.addCell(_wrapperCell9);  
	...
	public void doBody2() throws DocumentException, BadElementException,  Exception
	{
		...
		try {
			...
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(resourceProps.getString("prompt.hscode"),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(": "+getTagValue("IHSCode",elementProdcode),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);						
	...
	) throws DocumentException, BadElementException,  Exception
	{
		...
		try {
			...
			_text.addCell(new Phrase(getTagValue("movref",elementDespmovselected),font));

			PdfPCell _wrapperCell6 = new PdfPCell(_text);
			_wrapperCell6.setFixedHeight(15f);	
			_wrapper.addCell(_wrapperCell6);
			...
			//main
			_wrapper.getDefaultCell().setBorder(1);
			PdfPCell _wrapperCell10 = new PdfPCell(_wrapper);

			_Table1.addCell(_wrapperCell10);  
	...
	public void doFooter() throws DocumentException, BadElementException, Exception
	{
		...
		try {
			...
			wrapper.setSpacingAfter(0f);
			wrapper.setSpacingBefore(0f);
			String pleaseContactText=
				resourceProps.getString("prompt.pleasecontact1")+
				" "+
				getTagValue("name",elementUserLocation)+
				" "+
				resourceProps.getString("prompt.pleasecontact2")
				;				
			label.setPhrase(new Phrase(pleaseContactText,font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
