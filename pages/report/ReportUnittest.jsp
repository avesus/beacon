...
<html:html>
<head>
<title>Unit Test Due Report</title>
...
<%--      <td height="20" bgcolor="#CCCCCC">&nbsp;</td>--%>  
	<td class="tdwht"><span class="heading2">     
		<strong>Unit Test Due Report</strong> 
		</span>					
	</td> 
</tr>  
...
<html:form action="/ReportUnittest" focus="searchDate1dd">
...
<html:radio property="searchString9" value="EXCEL"/>Excel
  	...
  	<tr>
		...
		<html:select property="orderBy" styleClass="ftforminputsmall">
			<html:option value="unit.Unitkey">Unit</html:option>
			<html:option value="Duedate">Due Date</html:option>
		</html:select>
		</span>
		&nbsp;
		<span class="ftformradiosmall">
