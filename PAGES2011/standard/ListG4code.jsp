...
<tr>
	<td class="tdwht"><span class="heading2">     
		...
		<span class="heading2">
			<html:link action="/ListG4code" styleClass="link5">
...
<logic:notEqual name="ListG4codeForm" property="orderBy"
			scope="session" value="G1codekey">
	<html:link action="/ListG4code?orderBy=G1codekey&gotoPage=0" styleClass="link6"><bean:message key="prompt.g1code"/></html:link>	
</logic:notEqual>
<logic:equal name="ListG4codeForm" property="orderBy"
			scope="session" value="G1codekey">
...
<logic:notEqual name="ListG4codeForm" property="orderBy"
	...
	<html:link action="/ListG4code?orderBy=G2codekey&gotoPage=0" styleClass="link6"><bean:message key="prompt.g2code"/></html:link>	
</logic:notEqual>
<logic:equal name="ListG4codeForm" property="orderBy"
			scope="session" value="G2codekey">
...
<logic:notEqual name="ListG4codeForm" property="orderBy"
	...
	<html:link action="/ListG4code?orderBy=G3codekey&gotoPage=0" styleClass="link6"><bean:message key="prompt.g3code"/></html:link>	
</logic:notEqual>
<logic:equal name="ListG4codeForm" property="orderBy"
			scope="session" value="G3codekey">
...
&nbsp;|&nbsp;
<logic:notEqual name="ListG4codeForm" property="orderBy"
			scope="session" value="G4codekey">
	<html:link action="/ListG4code?orderBy=G4codekey&gotoPage=0" styleClass="link6"><bean:message key="prompt.g4code"/></html:link>	
</logic:notEqual>
<logic:equal name="ListG4codeForm" property="orderBy"
			scope="session" value="G4codekey">
	<strong><bean:message key="prompt.g4code"/></strong>
</logic:equal>
    &nbsp;|&nbsp;	
<logic:notEqual name="ListG4codeForm" property="orderBy"
			scope="session" value="Ldesc">
	<html:link action="/ListG4code?orderBy=Ldesc&gotoPage=0" styleClass="link6"><bean:message key="prompt.description"/></html:link>	
</logic:notEqual>
<logic:equal name="ListG4codeForm" property="orderBy"
			scope="session" value="Ldesc">
...
<html:link action="/EditG4code?action=Create"><bean:message key="prompt.addagcode"/></html:link>								
						</td>
					</tr>
					</table>									
					</td>
...
<bean:write name="lineItem" property="g3codekey" filter="true"/>
                    					...
                    					<td class="<%= _class %>" width="10%">
<bean:write name="lineItem" property="g4codekey" filter="true"/>
					</td>                     
