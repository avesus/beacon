...
function setTariff(params)	{
	if (params != "") {	
		...
		window.opener.document.forms[0].vendtarfhdrId2.value = paramsArray[0];
...
<html:form action="/ListStandardVendortariffSearch">
...
<table border="0" cellpadding="2" cellspacing="2" width="100%" bgcolor="#ffffff">
  <tr>
	<td align="right">
<logic:equal name="ListVendortariffSearchForm" property="firstPage"
			scope="session" value="false">			
<INPUT type="image" id="startButton" name="startButton" src="images/arrow_start.gif"/>
 </logic:equal>	
<logic:notEqual name="ListVendortariffSearchForm" property="firstPage"
			scope="session" value="false">
...
<logic:equal name="ListVendortariffSearchForm" property="lastPage"
			scope="session" value="false">
<INPUT type="image" id="nextButton" name="nextButton" src="images/arrow_next.gif"/>				
</logic:equal>
<logic:notEqual name="ListVendortariffSearchForm" property="lastPage"
			scope="session" value="false">
