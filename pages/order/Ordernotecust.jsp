...
<head>
<logic:equal name="OrdernotecustForm" property="action"
...
<!-- BREADCRUMBS -----------------> 
	...
	<bean:message key="prompt.orderno"/>&nbsp;-&nbsp;<bean:write name="ListOrdernotecustForm" property="headerInfo1" scope="session"/>&nbsp;
</span>
		    <span class="header2">
    			<logic:equal name="OrdernotecustForm" property="action" scope="request" value="Create">
		    		<bean:message key="ordernotecust.title.create"/>
    			</logic:equal>
		    	<logic:equal name="OrdernotecustForm" property="action" scope="request" value="Delete">
		      		<bean:message key="ordernotecust.title.delete"/>
      			</logic:equal>
		    	<logic:equal name="OrdernotecustForm" property="action" scope="request" value="Edit">
		        	<bean:message key="ordernotecust.title.edit"/>
     			</logic:equal>	
		    	<logic:equal name="OrdernotecustForm" property="action" scope="request" value="View">
		        	<bean:message key="ordernotecust.title.view"/>
     			</logic:equal>	 
                </span>
                <span class="header2">&gt;</span>               	  

			             
<html:link action="/ListOrdernotecust"><span class="header4"><bean:message key="ordernotecust.title.list"/></span></html:link>
<span class="header2">&gt;</span>                             
...
<html:form action="/SaveOrdernotecust" focus="priority">
<html:hidden property="action"/>
<html:hidden property="ordernotecustId"/>
        ...
        <html:text property="status" size="20" maxlength="10" styleClass="forminput1" disabled="true"/>                                  
							...
							<table border="0" cellpadding="5" cellspacing="5" width="100%" bgcolor="#ffffff">   
         							...
         							<tr><td class="label2"><bean:message key="prompt.createdate"/>:<html:img src="images/spacer.gif" border="0" width="1" height="15"/></td></tr>                                   
              						<tr><td class="label2">
<bean:write name="OrdernotecustForm" property="createdate_" format="dd-MMM-yyyy" scope="request"/><html:img src="images/spacer.gif" border="0" width="1" height="15"/>
              						</td></tr>	  
         							<tr><td class="label2"><bean:message key="prompt.createtime"/>:<html:img src="images/spacer.gif" border="0" width="1" height="15"/></td></tr>                                    
              						<tr><td class="label2">
<bean:write name="OrdernotecustForm" property="createtime_" scope="request"/><html:img src="images/spacer.gif" border="0" width="1" height="15"/>
              						</td></tr>                                
          							<tr><td class="label2"><bean:message key="prompt.createdby"/>:<html:img src="images/spacer.gif" border="0" width="1" height="15"/></td></tr>                                  
              						<tr><td class="label2">
<bean:write name="OrdernotecustForm" property="createuserid_" scope="request"/>
              						</td></tr>                                                                                                                                                                        
     						</table>
					    </td>
				        	...
				        	<logic:notEqual name="OrdernotecustForm" property="action"  scope="request" value="Delete"> 
