...
<html:html>
  <head>
  <title>
  <bean:message key="unitenquiry.title"/>
  </title>
...
<%--      <td height="20" bgcolor="#CCCCCC">&nbsp;</td>--%>
      <td class="tdwht" colspan="4"><span class="heading2"> <strong>
        ...
        <html:link action="/ReportListUnit" styleClass="link5">
...
<%--      <td bgcolor="#eeeeee"><img src="images/spacer.gif" height="500" width="1"></td>--%>
      ...
      <td><div style="OVERFLOW:auto; width:1350px; height:650px; position:relative;">
          ...
          <jsp:include page="/pages/report/ReportListUnitSearch.jsp" flush="true" />
          <jsp:include page="/pages/report/ReportListUnitResults.jsp" flush="true" />
