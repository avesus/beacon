...
public abstract class BaseJobmov  implements Serializable {

	public static String REF = "Jobmov";
	...
	public static String PROP_VSBKCONTACT = "Vsbkcontact";
	...
	public static String PROP_VSBKREF = "Vsbkref";
	...
	public static String PROP_FROMTIMEINMILLIS = "Fromtimeinmillis";
	...
	public static String PROP_BILLOFLADING = "Billoflading";
	public static String PROP_DMRGFREDAYLEFT = "Dmrgfredayleft";
	...
	public static String PROP_EXECSTATUS = "Execstatus";
	public static String PROP_STD_COSTS_GENERATED = "StdCostsGenerated";
	public static String PROP_TRTYPE = "Trtype";
	public static String PROP_DMRGFINISHFLAG = "Dmrgfinishflag";
	...
	public static String PROP_LASTDMRGTODATE = "Lastdmrgtodate";
	public static String PROP_COMPANYKEY = "Companykey";
	public static String PROP_BOOKKEY = "Bookkey";
	public static String PROP_SYSTEMLOGTIME = "Systemlogtime";
	public static String PROP_LASTDMRGDAYS = "Lastdmrgdays";
	public static String PROP_LLOYDSNUMBER = "Lloydsnumber";
	public static String PROP_MILEAGE = "Mileage";
	public static String PROP_LASTDMRGFRDATE = "Lastdmrgfrdate";
	...
	public static String PROP_TOTIMEINMILLIS = "Totimeinmillis";
	 ...
	 */
	public BaseJobmov (java.lang.Integer jobmovId) {
