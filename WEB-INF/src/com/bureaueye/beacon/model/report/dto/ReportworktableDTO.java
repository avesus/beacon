 ...
 * 
 */
public class ReportworktableDTO implements Serializable {
	...
	// constructors
	public ReportworktableDTO() {
	}

	public ReportworktableDTO(String _field1, String _field2, String _field3,
			String _field4, String _field5, String _field6, String _field7,
			String _field41, String _field31) {		
		this.field1 = _field1;
		this.field2 = _field2;
		this.field3 = _field3;
		this.field4 = _field4;
		...
		this.field6 = _field6;
		this.field7 = _field7;
		this.field41 = new Integer(_field41);
		this.field31 = new BigDecimal(_field31);
	}
	
	public ReportworktableDTO(String _field1, String _field2, String _field3,
			String _field4, String _field5, String _field6, String _field7,
			Integer _field41, BigDecimal _field31) {		
		this.field1 = _field1;
		this.field2 = _field2;
		this.field3 = _field3;
		this.field4 = _field4;
		...
		this.field6 = _field6;
		this.field7 = _field7;
		this.field41 = _field41;
		this.field31 = _field31;
	}
	 ...
	 * 
	 * @hibernate.id generator-class="native" column="REPORTWORKTABLE_ID"
	 */
	 ...
	 * 
	 * @param systemloguserid
	 *            the systemloguserid value
	 */
	 ...
	 * 
	 * @param systemlogprogram
	 *            the systemlogprogram value
	 */
	 ...
	 * 
	 * @param systemlogaction
	 *            the systemlogaction value
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.bureaueye.beacon.model.report.Reportworktable))
			return false;
		else {
			com.bureaueye.beacon.model.report.Reportworktable reportworktable = (com.bureaueye.beacon.model.report.Reportworktable) obj;
			if (null == this.getReportworktableId()
					|| null == reportworktable.getReportworktableId())
				return false;
			else
				return (this.getReportworktableId().equals(reportworktable
						.getReportworktableId()));
		}
	}
		...
		if (Integer.MIN_VALUE == this.hashCode) {
			if (null == this.getReportworktableId())
				...
				String hashStr = this.getClass().getName() + ":"
						+ this.getReportworktableId().hashCode();
