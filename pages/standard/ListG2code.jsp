...
<html:hidden property="gotoPage" />
				...
				<tr><td colspan="2">
					<div class="btnPane">	        
						...
						<button id="addButton" class="btn btnFF" type="button" onClick="document.location.href='EditG2code.do?action=Create'">
 						...
 						<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
							<tr>
		  						<td class="column-header1" width="15%">              
                    				<button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListG2code.do?orderBy=G1codekey&gotoPage=0'">
										<span><bean:message key="heading.g1code"/></span>                        
										<logic:notEqual name="ListG2codeForm" property="orderBy" scope="session" value="G1codekey">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListG2codeForm" property="orderBy" scope="session" value="G1codekey">              
		  						...
		  						<td class="column-header2" width="15%">              
                    				<button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListG2code.do?orderBy=G2codekey&gotoPage=0'">
										<span><bean:message key="heading.g2code"/></span>                        
										<logic:notEqual name="ListG2codeForm" property="orderBy" scope="session" value="G2codekey">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListG2codeForm" property="orderBy" scope="session" value="G2codekey">              
									         <img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>
							        </button>
								</td>
		  						...
		  						<td class="column-header2" width="45%">
							         <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListG2code.do?orderBy=Ldesc&gotoPage=0'">
										<span><bean:message key="heading.description"/></span>          
										<logic:notEqual name="ListG2codeForm" property="orderBy" scope="session" value="Ldesc">              
											<img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListG2codeForm" property="orderBy" scope="session" value="Ldesc">              
											<img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>  
							        </button>                                                             
								</td>
...
<%String _class = "column-cell1";if ((row % 2) == 0) _class = "column-cell2";row++;%>	
  								...
  								<tr>
									...
									<td class="<%= _class %>"><bean:write name="lineItem" property="g2codekey" filter="true"/></td>                                     
