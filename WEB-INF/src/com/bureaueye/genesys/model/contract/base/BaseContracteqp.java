...
/**
 * This is an object that contains data related to the contracteqp table.
...
public abstract class BaseContracteqp  implements Serializable {

	public static String REF = "Contracteqp";
	...
	public static String PROP_FIXDLYRAT = "Fixdlyrat";
	public static String PROP_RATE5 = "Rate5";
	public static String PROP_FREEDAYS = "Freedays";
	public static String PROP_EROADD = "Eroadd";
	public static String PROP_SYSTEMLOGACTION = "Systemlogaction";
	public static String PROP_ERODATE = "Erodate";
	public static String PROP_EROINCREASE = "Eroincrease";
	...
	public static String PROP_ERODAYS = "Erodays";
	...
	public static String PROP_ERORATE = "Erorate";
	...
	public static String PROP_EROPERIOD = "Eroperiod";
	public static String PROP_TODAY2 = "Today2";
	public static String PROP_TODAY1 = "Today1";
	public static String PROP_EROWITHIN = "Erowithin";
	 ...
	 */
	public BaseContracteqp (java.lang.Integer contracteqpId) {
		this.setContracteqpId(contracteqpId);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.bureaueye.genesys.model.contract.Contracteqp)) return false;
		else {
			com.bureaueye.genesys.model.contract.Contracteqp contracteqp = (com.bureaueye.genesys.model.contract.Contracteqp) obj;
			if (null == this.getContracteqpId() || null == contracteqp.getContracteqpId()) return false;
			else return (this.getContracteqpId().equals(contracteqp.getContracteqpId()));
		}
	}

	public int hashCode () {
		if (Integer.MIN_VALUE == this.hashCode) {
			if (null == this.getContracteqpId()) return super.hashCode();
			else {
				String hashStr = this.getClass().getName() + ":" + this.getContracteqpId().hashCode();
