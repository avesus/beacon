...
<logic:equal name="OnhireeqpotcForm" property="action"
...
<html:link action="/ListOnhireeqpotc"><span class="header4"><bean:message key="onhireeqpotc.title.list"/></span></html:link>                
<span class="header2">&gt;</span>                         
...
<html:form action="/SaveOnhireeqpotc" focus="locationkey.locationkey">
	
<html:hidden property="onhireeqpId"/>
<html:hidden property="onhireeqpotcId"/>
...
<logic:notEqual name="OnhireeqpotcForm" property="action"
                     scope="request" value="Delete">   
...
<tr>
			        <td colspan="2">
				        ...
				        <div class="btnPane"> 
				            <logic:equal name="OnhireeqpotcForm" property="action"   scope="request" value="Create">  
				                <button id="buttonStore" class="btn btnFF" type="submit">
                				    <img class=" IM tick-IM" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />
				                    <span><bean:message key="button.add"/></span>
                				</button>      
				            </logic:equal>
          					<logic:equal name="OnhireeqpotcForm" property="action"   scope="request" value="Delete">
							...
							<logic:equal name="OnhireeqpotcForm" property="action"   scope="request" value="Edit">
							...
							<logic:notEqual name="OnhireeqpotcForm" property="action"   scope="request" value="View">                            
							...
							<logic:equal name="OnhireeqpotcForm" property="action"   scope="request" value="View">                            
								<button id="exitButton" class="btn btnFF" type="button"  onclick="document.location.href='ListOnhireeqpotc.do'">
			                    	<img class=" IM cross-IM" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />
