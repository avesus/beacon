...
public class ReportEdifactIftmbfEndPage extends PdfPageEventHelper {
	...
	public ReportEdifactIftmbfEndPage() {
	...
	public void onEndPage(PdfWriter writer, Document document) {
		try {
			...
			head.addCell(new Phrase("FIRM BOOKING MESSAGE REPORT",fontBold));
			head.addCell(new Phrase("Run at "+Util.dateTextFormat2(new Date()),fontBold));
