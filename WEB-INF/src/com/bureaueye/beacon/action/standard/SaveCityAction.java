...
public final class SaveCityAction extends BaseAction {
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		CityBD citybd = new CityBD(this.getSessionFactoryClusterMap());

		if (action.equals("Delete")) {
			citybd.delete(new City(cityForm.getCity()), user);
		} else {
			City city = citybd.read(cityForm.getCity());
			...
			citybd.createOrUpdate(city, user);
			...
			//listform.setSearchString1(city.getCity());
		}
