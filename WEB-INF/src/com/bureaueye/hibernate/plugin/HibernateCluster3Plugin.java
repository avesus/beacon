...
public class HibernateCluster3Plugin implements PlugIn {
	...
	private static Class clazz = HibernateCluster3Plugin.class;
	...
	throws ServletException {
		...
		try {
			URL url = HibernateCluster3Plugin.class.getResource(path);
