...
<span class="header2"><bean:message key="quocharge.title.list"/></span>
...
<img class="NavigationSprite Expand" title="Show More Information" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;"/>
    ...
    <tr>
      <td class="label10"><bean:write name="ListQuochargeForm" property="headerInfo1" scope="session"/></td>
      <td class="label10"><bean:write name="ListQuochargeForm" property="headerInfo2" scope="session"/></td>
      <td class="label10"></td>              
    </tr>
...
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>        
    	...
    	<tr>
		    <td class="label10" colspan="3"><bean:write name="ListQuochargeForm" property="headerInfo4" scope="session"/></td>               
		</tr>           
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>  
    	<tr>
    	...
    	<tr>
		    <td class="label10"><bean:write name="ListQuochargeForm" property="headerInfo3" scope="session"/></td>
		    <td class="label10"><bean:write name="ListQuochargeForm" property="headerInfo5" scope="session"/></td>
		    <td class="label10"></td>                 
		</tr>
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>  
    	<tr>
    	...
    	<tr>
		    <td class="label10"><bean:write name="ListQuochargeForm" property="headerInfo6" scope="session"/></td>
		    <td class="label10"><bean:write name="ListQuochargeForm" property="headerInfo7" scope="session"/></td>
		    <td class="label10"></td>                 
		</tr>
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>  
    	<tr>
    	...
    	<tr>
		    <td class="label10"><bean:write name="ListQuochargeForm" property="headerInfo8" scope="session"/></td>
		    <td class="label10"></td>
		    <td class="label10"></td>                 
		</tr>
...
<html:hidden property="gotoPage" />
	<html:hidden name="ListQuochargeForm" property="headerInfo1"/>        
	<html:hidden name="ListQuochargeForm" property="id"/>            
...
document.location.href='EditQuocharge.do?'+
'&amp;quohdrId='+
 						...
 						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
		  						<td class="column-header1" width="30%">              
                    				<button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListQuocharge.do?orderBy=Customeraddrkey&gotoPage=0'">
										<span><bean:message key="heading.billingaccount"/></span>                        
										<logic:notEqual name="ListQuochargeForm" property="orderBy" scope="session" value="Customeraddrkey">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListQuochargeForm" property="orderBy" scope="session" value="Customeraddrkey">              
		  						...
		  						<td class="column-header2" width="10%">
							         <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListQuocharge.do?orderBy=Chargekey&gotoPage=0'">
										<span><bean:message key="heading.charge"/></span>          
										<logic:notEqual name="ListQuochargeForm" property="orderBy" scope="session" value="Chargekey">              
											<img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListQuochargeForm" property="orderBy" scope="session" value="Chargekey">              
											<img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>  
							        </button>                                                             
								</td> 
					  			...
					  			<td class="column-header2" width="10%">
 							        <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListQuocharge.do?orderBy=Chargetype&gotoPage=0'">
										<span><bean:message key="heading.type"/></span>        
										<logic:notEqual name="ListQuochargeForm" property="orderBy" scope="session" value="Chargetype">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListQuochargeForm" property="orderBy" scope="session" value="Chargetype">              
									         <img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>   
							        </button>                        	
								</td>                                  
					  			...
					  			<td class="column-header2" width="10%">
 							        <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListQuocharge.do?orderBy=Ccykey&gotoPage=0'">
										<span><bean:message key="heading.ccy"/></span>        
										<logic:notEqual name="ListQuochargeForm" property="orderBy" scope="session" value="Ccykey">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListQuochargeForm" property="orderBy" scope="session" value="Ccykey">              
									         <img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>   
							        </button>                        	
								</td>  
					  			...
					  			<td class="column-header2" width="10%">
 							        <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListQuocharge.do?orderBy=Chgamt&gotoPage=0'">
										<span><bean:message key="heading.amount"/></span>        
										<logic:notEqual name="ListQuochargeForm" property="orderBy" scope="session" value="Chgamt">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListQuochargeForm" property="orderBy" scope="session" value="Chgamt">              
									         <img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>   
							        </button>                        	
								</td>  
                                                                                                                                                     					  			<td class="column-header2" width="10%">
 							        <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListQuocharge.do?orderBy=CusttarfhdrId&gotoPage=0'">
										<span><bean:message key="heading.tariffid"/></span>        
										<logic:notEqual name="ListQuochargeForm" property="orderBy" scope="session" value="CusttarfhdrId">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListQuochargeForm" property="orderBy" scope="session" value="CusttarfhdrId">              
									         <img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>   
							        </button>                        	
								</td>
...
<%int row=0;%>			
	<logic:iterate id="quochargeLineItem" name="ListQuochargeForm" property="lineItems">
...
<!-- row1 -->            
		<tr>
									<td class="<%= _class2 %>">
						<bean:write name="quochargeLineItem" property="customeraddrkey.name" filter="true"/>
                                    </td> 
									<td class="<%= _class2 %>">
						<bean:write name="quochargeLineItem" property="chargekey.chargekey" filter="true"/>								
                        			</td> 
									<td class="<%= _class2 %>">
						<bean:write name="quochargeLineItem" property="chargetype" filter="true"/>
                        			</td>									
                                    <td class="<%= _class2 %>">
						<bean:write name="quochargeLineItem" property="ccykey" filter="true"/>
                        			</td>                                    
                                    <td class="<%= _class2 %>" align="right">
						<bean:write name="quochargeLineItem" property="chgamt" filter="true"/>
                        			</td>
									<td class="<%= _class2 %>">
						<bean:write name="quochargeLineItem" property="custtarfhdrId" filter="true"/>&nbsp;                            				
									</td>  
									<td>
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>				
...
<!-- row2 -->            
		<tr>
			<td class="<%= _class %>" colspan="7">	
            	<bean:message key="prompt.notes"/>:&nbsp;<c:out value="${quochargeLineItem.txt1}"/>						
            </td>
		</tr>
