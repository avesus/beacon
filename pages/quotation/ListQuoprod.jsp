...
<span class="header2"><bean:message key="quoprod.title.list"/></span>
...
<img class="NavigationSprite Expand" title="Show More Information" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;"/>
    ...
    <tr>
      <td class="label10"><bean:write name="ListQuoprodForm" property="headerInfo1" scope="session"/></td>
      <td class="label10"><bean:write name="ListQuoprodForm" property="headerInfo2" scope="session"/></td>
      <td class="label10"></td>              
    </tr>
...
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>        
    	...
    	<tr>
		    <td class="label10" colspan="3"><bean:write name="ListQuoprodForm" property="headerInfo4" scope="session"/></td>               
		</tr>           
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>  
    	<tr>
    	...
    	<tr>
		    <td class="label10"><bean:write name="ListQuoprodForm" property="headerInfo3" scope="session"/></td>
		    <td class="label10"><bean:write name="ListQuoprodForm" property="headerInfo5" scope="session"/></td>
		    <td class="label10"></td>                 
		</tr>
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>  
    	<tr>
    	...
    	<tr>
		    <td class="label10"><bean:write name="ListQuoprodForm" property="headerInfo6" scope="session"/></td>
		    <td class="label10"><bean:write name="ListQuoprodForm" property="headerInfo7" scope="session"/></td>
		    <td class="label10"></td>                 
		</tr>
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>  
    	<tr>
    	...
    	<tr>
		    <td class="label10"><bean:write name="ListQuoprodForm" property="headerInfo8" scope="session"/></td>
		    <td class="label10"></td>
		    <td class="label10"></td>                 
		</tr>
...
<html:form action="/ListQuoprod">
	...
	<html:hidden name="ListQuoprodForm" property="headerInfo1"/>        
	<html:hidden name="ListQuoprodForm" property="id"/>            
...
document.location.href='EditQuoprod.do?'+
'&amp;quohdrId='+
 						...
 						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
		  						<td class="column-header1" width="15%">              
                    				<button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListQuoprod.do?orderBy=Productkey&gotoPage=0'">
										<span><bean:message key="heading.product"/></span>                        
										<logic:notEqual name="ListQuoprodForm" property="orderBy" scope="session" value="Productkey">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListQuoprodForm" property="orderBy" scope="session" value="Productkey">              
		  						...
		  						<td class="column-header2" width="20%">
							         <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListQuoprod.do?orderBy=Volume&gotoPage=0'">
										<span><bean:message key="heading.volume"/></span>          
										<logic:notEqual name="ListQuoprodForm" property="orderBy" scope="session" value="Volume">              
											<img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListQuoprodForm" property="orderBy" scope="session" value="Volume">              
											<img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>  
							        </button>                                                             
								</td>
					  			...
					  			<td class="column-header2" width="15%">
 							        <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListQuoprod.do?orderBy=Weight&gotoPage=0'">
										<span><bean:message key="heading.weight"/></span>        
										<logic:notEqual name="ListQuoprodForm" property="orderBy" scope="session" value="Weight">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListQuoprodForm" property="orderBy" scope="session" value="Weight">              
									         <img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>   
							        </button>                        	
								</td>  
					  			...
					  			<td class="column-header2" width="15%">
 							        <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListQuoprod.do?orderBy=Comprt&gotoPage=0'">
										<span><bean:message key="heading.compartment"/></span>        
										<logic:notEqual name="ListQuoprodForm" property="orderBy" scope="session" value="Comprt">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListQuoprodForm" property="orderBy" scope="session" value="Comprt">              
									         <img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>   
							        </button>                        	
								</td>                                  
...
<%String _class = "column-cell1";if ((row % 2) == 0) _class = "column-cell2";row++;%>	
  								...
  								<tr>
									<td class="<%= _class %>">
						<bean:write name="quoprodLineItem" property="productkey.productkey" filter="true"/>
                                    </td> 
									<td class="<%= _class %>">
