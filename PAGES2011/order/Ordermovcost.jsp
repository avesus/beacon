...
<logic:equal name="OrdermovcostForm" property="action"
   ...
   <title><bean:message key="ordermovcost.title.create"/></title>
</logic:equal>
<logic:equal name="OrdermovcostForm" property="action"
            scope="session" value="Delete">
   <title><bean:message key="ordermovcost.title.delete"/></title>
</logic:equal>
<logic:equal name="OrdermovcostForm" property="action"
            scope="session" value="Edit">
  <title><bean:message key="ordermovcost.title.edit"/></title>
</logic:equal>
<logic:equal name="OrdermovcostForm" property="action"
            scope="session" value="View">
 <title><bean:message key="ordermovcost.title.view"/></title>
</logic:equal>	
 ...
 <bean:message key="ordermovcost.title.view"/>
  ...
  <tr>
	...
	<table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#999999"> 
      ...
      <logic:notEqual name="OrdermovcostForm" property="action"
                     scope="session" value="Delete">  
