/*
 * $Id: QuosummaryChargeLineItem.java 12/09/2005 ntankard
 */
...
public final class QuosummaryChargeDTO extends BaseDTO implements Serializable {
	private static final long serialVersionUID = 1L;


	// constructors
	public QuosummaryChargeDTO(Quocharge dao) throws ApplicationException {
		initialize(dao);		
	}
	public QuosummaryChargeDTO(Quocharge dao, Map<String, SessionFactory> sfcm) throws ApplicationException {
		super(sfcm);
		initialize(dao);
	}
	...
	protected void initialize (Quocharge dao) throws ApplicationException {
		...
		this._quochargeId = dao.getQuochargeId();
		this._quohdrId = dao.getQuohdrId();	
	...
	private java.lang.Integer _quochargeId;
	 ...
	 */
	public void setQuochargeId (java.lang.Integer _quochargeId) {
