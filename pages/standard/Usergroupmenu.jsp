...
<!-- BREADCRUMBS -----------------> 
	...
	<bean:message key="prompt.usergroupid"/>&nbsp;-&nbsp;<bean:write name="ListUsergroupmenuForm" property="headerInfo1" scope="session"/>&nbsp;
		    ...
		    <span class="header2">
    			<logic:equal name="UsergroupmenuForm" property="action" scope="request" value="Create">
		    		<bean:message key="usergroupmenu.title.create"/>
    			</logic:equal>
		    	<logic:equal name="UsergroupmenuForm" property="action" scope="request" value="Delete">
		      		<bean:message key="usergroupmenu.title.delete"/>
      			</logic:equal>
		    	<logic:equal name="UsergroupmenuForm" property="action" scope="request" value="Edit">
		        	<bean:message key="usergroupmenu.title.edit"/>
     			</logic:equal>		  
          		&gt;
            </span>
			             
<html:link action="/ListUsermenu"><span class="header3"><bean:message key="usergroupmenu.title.list"/></span></html:link>
...
<html:hidden property="usergroupmenuId"/>
								...
								<td><html:img src="images/spacer.gif" border="0" width="1" height="1"/></td>
       							...
       							<td width="100%">      
				      				<table border="0" cellpadding="5" cellspacing="5" width="100%" bgcolor="#ffffff">
							    		...
							    		<tr><td class="label2"><html:text property="usergroupid" size="20" maxlength="50" disabled="true" styleClass="forminput1"/></td></tr>
				        	...
				        	<logic:notEqual name="UsergroupmenuForm" property="action"  scope="request" value="Delete"> 
								...
								<table border="0" cellpadding="5" cellspacing="5" width="100%" bgcolor="#ffffff">                                    
							    	<tr><td class="label2"><bean:message key="prompt.usergroupid"/>:</td></tr>
							    	<tr><td class="label2">
                                    <html:text property="usergroupid" size="20" maxlength="50" disabled="true" styleClass="forminput1"/>
