...
<html:html>
  <head>
  <title>
  <bean:message key="mandrhdr.title"/>
  </title>
...
<%--      <td height="20" bgcolor="#CCCCCC">&nbsp;</td>--%>
      <td class="tdwht" colspan="4"><span class="heading2"> <strong>
        ...
        <html:link action="/ListMandrhdrMain" styleClass="link5">
...
<html:form action="/ListMandrhdr" focus="searchString1">
	<html:hidden property="gotoPage" />
	<html:hidden property="maxResults" />
            
          <jsp:include page="/pages/mandr/ListMandrhdrSearch.jsp" flush="true" />
          <jsp:include page="/pages/mandr/ListMandrhdrResults.jsp" flush="true" />
</html:form>	
