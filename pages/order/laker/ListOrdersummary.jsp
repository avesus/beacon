...
//<![CDATA[
	function onLoad() {
        ...
        var displayAccountsreceivableContent = MM_findObj('displayContent4').value;	<!--WSI-201405-0001-->
        var displayAccountspayableContent = MM_findObj('displayContent5').value;	<!--WSI-201405-0001-->
...
<html:form action="/SaveOrdersummaryLaker">
<html:hidden property="gotoPage" />
	<html:hidden name="ListOrdersummaryForm" property="headerInfo[1]"/>   
    <html:hidden name="ListOrdersummaryForm" property="displayContent1" value="display"/> 
    <html:hidden name="ListOrdersummaryForm" property="displayContent2" value="display"/> 
    <html:hidden name="ListOrdersummaryForm" property="displayContent3" value=""/>  
    <html:hidden name="ListOrdersummaryForm" property="displayContent4" value="display"/> <!--WSI-201405-0001--> 
    <html:hidden name="ListOrdersummaryForm" property="displayContent5" value="display"/> <!--WSI-201405-0001-->                        
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">              
    			<tr><td colspan="2"><img src="images/spacer.gif" height="5"/></td></tr>                  
 				<tr><td colspan="2" style="background:#F1F1F1; border: solid #CECFD6 1px; line-height: 100%; padding:5px 5px 5px 5px; ">
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
				    	<tr>                
        	    		    <td><span class="label13"><bean:message key="title.accountsreceivable"/></span></td>
                    		<td align="right">
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">              
    			<tr><td colspan="2"><img src="images/spacer.gif" height="5"/></td></tr>                  
 				<tr><td colspan="2" style="background:#F1F1F1; border: solid #CECFD6 1px; line-height: 100%; padding:5px 5px 5px 5px; ">
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
				    	<tr>                
        	    		    <td><span class="label13"><bean:message key="title.accountspayable"/></span></td>
                    		<td align="right">
