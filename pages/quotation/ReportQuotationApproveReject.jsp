...
<html:html>
<head>
<title>Quotation Approve/Reject Report</title>
...
<%--      <td height="20" bgcolor="#CCCCCC">&nbsp;</td>--%>  
	<td class="tdwht"><span class="heading2">     
		<strong>Quotation Approve/Reject Report</strong> 
		</span>					
	</td> 
</tr>  
...
<html:form action="/ReportQuotationApproveReject" focus="searchDate1dd">
...
<table width="95%">
  	...
  	<tr>
  	  <td align="left" class="text7">Approve/Reject:</td>
	  </tr>
  	<tr>
		<td align="left" width="40%" valign="top">
		<span class="ftformradiosmall">
<html:radio property="searchString2" value="APPROVED"/>APPROVED
<html:radio property="searchString2" value="REJECTED"/>REJECTED</span>		</td>			
	</tr>	  
  	<tr>
...
<html:radio property="orderByDesc" value="Desc"/>Desc		</span>		</td>			
	</tr>			
