...
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>  
    	...
    	<tr>
		    ...
		    <td class="label10"><bean:write name="ListOrdercostForm" property="headerInfo7" scope="session"/></td>
		    <td class="label10"></td>                 
		</tr>
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>  
    	<tr>
...
document.location.href='EditOrdercost.do?'+
'&amp;orderhdrId='+
 						...
 						<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
							<tr>
		  						<td class="column-header1" width="35%">              
                    				<button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListOrdercost.do?orderBy=Vendoraddrkey&gotoPage=0'">
										<span><bean:message key="heading.vendoraccount"/></span>                        
										<logic:notEqual name="ListOrdercostForm" property="orderBy" scope="session" value="Vendoraddrkey">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListOrdercostForm" property="orderBy" scope="session" value="Vendoraddrkey">              
		  						...
		  						<td class="column-header2" width="10%">
							         <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListOrdercost.do?orderBy=Costkey&gotoPage=0'">
					  			...
					  			<td class="column-header2" width="10%">
 							        <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListOrdercost.do?orderBy=Costtype&gotoPage=0'">
										<span><bean:message key="heading.type"/></span>        
										<logic:notEqual name="ListOrdercostForm" property="orderBy" scope="session" value="Costtype">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListOrdercostForm" property="orderBy" scope="session" value="Costtype">              
									         <img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>   
							        </button>                        	
								</td>  
					  			...
					  			<td class="column-header2" width="10%">
 							        <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListOrdercost.do?orderBy=Ccykey&gotoPage=0'">
					  			...
					  			<td class="column-header2" width="10%">
 							        <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListOrdercost.do?orderBy=Cstamt&gotoPage=0'">
...
<!-- row1 -->            
		<tr>
						...
						<bean:write name="ordercostLineItem" property="costkey.costkey" filter="true"/></td> 
									<td class="<%= _class2 %>">
						<bean:write name="ordercostLineItem" property="costtype" filter="true"/>
                        			</td>									
                                    <td class="<%= _class2 %>">
						...
						<bean:write name="ordercostLineItem" property="cstamt" filter="true"/>
	  					...
	  					<orderapp:linkOrdercostLineItem page="/EditOrdercost.do?action=Edit"><bean:message key="prompt.edit"/></orderapp:linkOrdercostLineItem><span class="label5">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
	  					<orderapp:linkOrdercostLineItem page="/EditOrdercost.do?action=Copy"><bean:message key="prompt.copy"/></orderapp:linkOrdercostLineItem><span class="label5">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
