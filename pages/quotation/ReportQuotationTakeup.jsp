...
<html:html>
<head>
<title>Quotation TakeUp Report</title>
...
<%--      <td height="20" bgcolor="#CCCCCC">&nbsp;</td>--%>  
	<td class="tdwht"><span class="heading2">     
		<strong>Quotation TakeUp Report</strong> 
		</span>					
	</td> 
</tr>  
...
<html:form action="/ReportQuotationTakeup" focus="searchString1">
...
<tr><td><table border="0" cellpadding="0" cellspacing="1" width="100%" bgcolor="#EEEEEE">
  <tr>
...
onMouseOver="MM_swapImage('reportButton','','/beacon/images/buttons/btn_report.png','reportButton','','/beacon/images/buttons/btn_report_over.png',1);"/>
  ...
  <tr>
    <td align="left" width="40%" class="text7"> Quote Number: </td>
    <td align="left" width="60%" class="text7"> Quote Date: </td>
  </tr>
  <tr>
    <td align="left" width="40%"><html:text property="searchString1" size="40" maxlength="40" styleClass="ftforminputsmall"/>    </td>
    <td width="60%"><table width="95%">
      <tr>
        <td width="10%" class="text7"><div align="left"> &nbsp;From: </div></td>
        ...
        <td width="5%" class="text7"><div align="right"> To: </div></td>
  ...
  <tr>
    <td align="left" width="40%" class="text7"> Customer: </td>
    <td align="left" width="60%" class="text7">&nbsp;</td>
  </tr>
  <tr>
    <td align="left" width="40%"><html:select property="searchString2" styleClass="ftforminputsmall">
      <html:option value="%">
  ...
  <tr>
    <td colspan="2" align="left" valign="top"><span class="ftformradiosmall">
