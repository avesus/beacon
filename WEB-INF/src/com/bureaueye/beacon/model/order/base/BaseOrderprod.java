...
/**
 * This is an object that contains data related to the orderprod table.
...
public abstract class BaseOrderprod  implements Serializable {

	public static String REF = "Orderprod";
	...
	public static String PROP_ORDERPROD_ID = "OrderprodId";
	 ...
	 */
	public BaseOrderprod (java.lang.Integer orderprodId) {
		this.setOrderprodId(orderprodId);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.bureaueye.beacon.model.order.Orderprod)) return false;
		else {
			com.bureaueye.beacon.model.order.Orderprod orderprod = (com.bureaueye.beacon.model.order.Orderprod) obj;
			if (null == this.getOrderprodId() || null == orderprod.getOrderprodId()) return false;
			else return (this.getOrderprodId().equals(orderprod.getOrderprodId()));
		}
	}

	public int hashCode () {
		if (Integer.MIN_VALUE == this.hashCode) {
			if (null == this.getOrderprodId()) return super.hashCode();
			else {
				String hashStr = this.getClass().getName() + ":" + this.getOrderprodId().hashCode();
