...
<tr>
	<td class="tdwht"><span class="heading2">     
		...
		<span class="heading2">
			<html:link action="/ListG2code" styleClass="link4">
...
<logic:equal name="G2codeForm" property="action"
  ...
  <tr>
	...
	<table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#999999">  				
        ...
        <logic:notEqual name="G2codeForm" property="action"
                     scope="request" value="Delete"> 
  <tr>
    <td><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#999999">
        <tr>
        ...
        <html:select property="g1codekey" styleClass="ftforminputsmall">
        ...
        <tr>
          ...
          <td width="78%" class="td2">
		  <c:if test="${G2codeForm.action == 'Create'}">
        	<html:text property="g2codekey" size="30" maxlength="20" styleClass="ftforminputsmall"/>
		  </c:if>
		  <c:if test="${G2codeForm.action != 'Create'}">
