...
public final class SaveOffhireeqpotcAction extends BaseAction {
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		OffhireeqpotcForm saveForm = (OffhireeqpotcForm) form;
		...
		OffhireeqpotcBD bd = new OffhireeqpotcBD(this.getSessionFactoryClusterMap());

		// set primary key
		Integer pk = null;		
		try {
			pk = new Integer(saveForm.getOffhireeqpotcId());			
		} catch (Exception e) {}
		// find data-access-object using primary key
		Offhireeqpotc dto = bd.read(pk);
		// not found create empty object
		if (dto == null) {
			dto = new Offhireeqpotc();
		}
		...
		if (action.equals("Delete")) {		
			bd.delete(new Offhireeqpotc(pk), user);		
		} else {
