...
<tr>
	<td class="tdwht"><span class="heading2">     
		...
		<span class="heading2">
			<html:link action="/ListG1code" styleClass="link5">
...
<logic:notEqual name="ListG1codeForm" property="orderBy"
			scope="session" value="G1codekey">
	<html:link action="/ListG1code?orderBy=G1codekey&gotoPage=0" styleClass="link6"><bean:message key="prompt.g1code"/></html:link>	
</logic:notEqual>
<logic:equal name="ListG1codeForm" property="orderBy"
			scope="session" value="G1codekey">
...
<logic:notEqual name="ListG1codeForm" property="orderBy"
	...
	<html:link action="/ListG1code?orderBy=Ldesc&gotoPage=0" styleClass="link6"><bean:message key="prompt.description"/></html:link>	
</logic:notEqual>
<logic:equal name="ListG1codeForm" property="orderBy"
			scope="session" value="Ldesc">
...
<html:link action="/EditG1code?action=Create"><bean:message key="prompt.addagcode"/></html:link>								
						</td>
					</tr>
					</table>									
					</td>
