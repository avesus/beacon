...
function loadXMLDocRefreshCcyex(value) {
	var url = '';
		...
		if (value == 'xrateinv') {
			url = "RefreshOrderCcyex?fromccykey="+
				ccykey.options[ccykey.selectedIndex].value+
				"&toccykey="+
				invoiceccykey.options[invoiceccykey.selectedIndex].value+
				"&xfield="+value+
				"&id1="+document.forms[0].orderhdrId.value+
				"&id2="+document.forms[0].ordermovId.value;		
		} else {
			url = "RefreshOrderCcyex?fromccykey="+
				ccykey.options[ccykey.selectedIndex].value+
				"&toccykey="+
				document.forms[0].baseccykey.value+
				"&xfield="+value+
				"&id1="+document.forms[0].orderhdrId.value+
				"&id2="+document.forms[0].ordermovId.value;				
		}
