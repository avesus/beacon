...
<head>
<title><bean:message key="ordernotecust.title.list"/></title>
...
<span class="header2"><bean:message key="ordernotecust.title.list"/></span>
...
<img class="NavigationSprite Expand" title="Show More Information" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" onClick="showHideSearch('header','header2');"/>
    ...
    <tr>
      <td class="label10"><bean:write name="ListOrdernotecustForm" property="headerInfo1" scope="session"/></td>
      <td class="label10"><bean:write name="ListOrdernotecustForm" property="headerInfo2" scope="session"/></td>
      <td class="label10"></td>              
    </tr>
...
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>        
    	...
    	<tr>
		    <td class="label10" colspan="3"><bean:write name="ListOrdernotecustForm" property="headerInfo4" scope="session"/></td>               
		</tr>           
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>  
    	<tr>
    	...
    	<tr>
		    <td class="label10"><bean:write name="ListOrdernotecustForm" property="headerInfo3" scope="session"/></td>
		    <td class="label10"><bean:write name="ListOrdernotecustForm" property="headerInfo5" scope="session"/></td>
		    <td class="label10"></td>                 
		</tr>
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>  
    	<tr>
    	...
    	<tr>
		    <td class="label10"><bean:write name="ListOrdernotecustForm" property="headerInfo6" scope="session"/></td>
		    <td class="label10"><bean:write name="ListOrdernotecustForm" property="headerInfo7" scope="session"/></td>
		    <td class="label10"></td>                 
		</tr>
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>  
    	<tr>
    	...
    	<tr>
		    <td class="label10"><bean:write name="ListOrdernotecustForm" property="headerInfo8" scope="session"/></td>
		    <td class="label10"></td>
		    <td class="label10"></td>                 
		</tr>
...
<html:form action="/ListOrdernotecust">
<html:hidden property="gotoPage" />
	<html:hidden name="ListOrdernotecustForm" property="headerInfo1"/>        
	<html:hidden name="ListOrdernotecustForm" property="id"/>            
...
document.location.href='EditOrdernotecust.do?'+
'&amp;orderhdrId='+
 						...
 						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
		  						<td class="column-header1" width="10%">              
                    				<button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListOrdernotecust.do?orderBy=Createdate&gotoPage=0'">
										<span><bean:message key="heading.date"/></span>                        
										<logic:notEqual name="ListOrdernotecustForm" property="orderBy" scope="session" value="Createdate">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListOrdernotecustForm" property="orderBy" scope="session" value="Createdate">              
		  						...
		  						<td class="column-header2" width="8%">
							         <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListOrdernotecust.do?orderBy=Createtime&gotoPage=0'">
										<span><bean:message key="heading.time"/></span>          
										<logic:notEqual name="ListOrdernotecustForm" property="orderBy" scope="session" value="Createtime">              
											<img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListOrdernotecustForm" property="orderBy" scope="session" value="Createtime">              
											<img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>  
							        </button>                                                             
								</td>
					  			...
					  			<td class="column-header2" width="8%">
 							        <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListOrdernotecust.do?orderBy=Createuserid&gotoPage=0'">
										<span><bean:message key="heading.userid"/></span>        
										<logic:notEqual name="ListOrdernotecustForm" property="orderBy" scope="session" value="Createuserid">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListOrdernotecustForm" property="orderBy" scope="session" value="Createuserid">              
									         <img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>   
							        </button>                        	
								</td>  
					  			...
					  			<td class="column-header2" width="10%">
 							        <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListOrdernotecust.do?orderBy=Category&gotoPage=0'">
										<span><bean:message key="heading.category"/></span>        
										<logic:notEqual name="ListOrdernotecustForm" property="orderBy" scope="session" value="Category">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListOrdernotecustForm" property="orderBy" scope="session" value="Category">              
									         <img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>   
							        </button>                        	
								</td>                                 
					  			...
					  			<td class="column-header2" width="45%">
 							        <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListOrdernotecust.do?orderBy=Note1&gotoPage=0'">
										<span><bean:message key="heading.notes"/></span>        
										<logic:notEqual name="ListOrdernotecustForm" property="orderBy" scope="session" value="Note1">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListOrdernotecustForm" property="orderBy" scope="session" value="Note1">              
									         <img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>   
							        </button>                        	
								</td> 
