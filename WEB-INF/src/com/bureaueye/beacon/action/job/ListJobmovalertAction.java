...
public final class ListJobmovalertAction extends ListAction {
	...
	public ActionMessages setLineItems(ListForm listForm) throws ApplicationException {
		...
		listForm.setHeaderInfo8(
				new ProductBD(this.getSessionFactoryClusterMap()).read(jobhdr.getProductkey()).getLdesc()
		);

		// set line items
		listForm.setLineItems(
				new AlertBD(this.getSessionFactoryClusterMap()).findAlertsByAlertmoduleRecord1Id(listForm)
		);
