...
public final class SaveUsergroupmenuAction extends BaseAction {
	...
	throws Exception {
		...
		UsergroupmenuForm saveForm = (UsergroupmenuForm) form;
		...
		UsergroupmenuBD bd = new UsergroupmenuBD(this.getSessionFactoryClusterMap());
		
		// set primary key
		Integer pk = null;		
		try {
			pk = new Integer(saveForm.getUsergroupmenuId());			
		} catch (Exception e) {}
		// find data-access-object using primary key
		Usergroupmenu dto = bd.read(pk);
		...
		if (action.equals("Delete")) {		
			bd.delete(new Usergroupmenu(pk),user);		
		} else {
