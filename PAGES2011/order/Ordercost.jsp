...
<logic:equal name="OrdercostForm" property="action"
  ...
  <title>Create Order Cost</title>
</logic:equal>
<logic:equal name="OrdercostForm" property="action"
            scope="request" value="Delete">
  <title>Delete Order Cost</title>
</logic:equal>
<logic:equal name="OrdercostForm" property="action"
            scope="request" value="Edit">
  <title>Edit Order Cost</title>
</logic:equal>	
<logic:equal name="OrdercostForm" property="action"
            scope="request" value="View">
  <title>View Order Cost</title>
</logic:equal>	
...
<logic:equal name="OrdercostForm" property="action"
  ...
  <tr>
	...
	<table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#999999"> 
      ...
      <logic:notEqual name="OrdercostForm" property="action"
                     scope="request" value="Delete">  
