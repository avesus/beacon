...
<%--      <td height="20" bgcolor="#CCCCCC">&nbsp;</td>--%>  
	<td class="tdwht"><span class="heading2">     
		...
		<span class="heading2">
			<html:link action="/ListUseraccess" styleClass="link5">
...
<table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
  <tr>
    <td class="td4"><span class="heading6"><bean:message key="prompt.userid"/></span></td>
  </tr>  
  <tr class="text2"> 
    <td class="td6">
	&nbsp;<bean:write name="ListUseraccessForm" property="headerInfo1" scope="session"/>
	</td>							
   </tr> 
...
<table border="0" cellpadding="2" cellspacing="2" width="100%" bgcolor="#ffffff">
  <tr>
	<td align="right">
<logic:equal name="ListUseraccessForm" property="firstPage"
			scope="session" value="false">			
<INPUT type="image" id="startButton" name="startButton" src="images/arrow_start.gif"/>
 </logic:equal>	
<logic:notEqual name="ListUseraccessForm" property="firstPage"
			scope="session" value="false">
...
<logic:equal name="ListUseraccessForm" property="lastPage"
			scope="session" value="false">
<INPUT type="image" id="nextButton" name="nextButton" src="images/arrow_next.gif"/>				
</logic:equal>
<logic:notEqual name="ListUseraccessForm" property="lastPage"
			scope="session" value="false">
			...
			<table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
				<tr>		
		  			<td class="tddkgry" width="30%"><span class="heading4">
						<bean:message key="heading.accessid"/></span>
					</td>
		  			<td class="tddkgry" width="30%"><span class="heading4">
						<bean:message key="heading.grantactions"/> </span>
					</td>															
...
<html:link action="/EditUseraccess?action=Create" paramId="userid" paramName="ListUseraccessForm" paramProperty="headerInfo1"><bean:message key="prompt.add"/></html:link>											
						</td>
					</tr>
					</table>									
					</td>
				</tr>		
			<c:forEach var="lineItem" items="${ListUseraccessForm.lineItems}" varStatus="loop">
				...
				<span class="text2">			
					<td class='<c:out value="${_class}"/>'>
						<c:out value="${lineItem.accessid}"/>
					</td> 
					<td class='<c:out value="${_class}"/>'>
						<c:out value="${lineItem.grantactionlist}"/>					
					</td> 															 						
