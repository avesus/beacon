...
/**
 * This is an object that contains data related to the quonotecust table.
...
public abstract class BaseQuonotecust  implements Serializable {

	public static String REF = "Quonotecust";
	public static String PROP_NOTE1 = "Note1";
	public static String PROP_DELETED = "Deleted";
	public static String PROP_QUONOTECUST_ID = "QuonotecustId";
	 ...
	 */
	public BaseQuonotecust (java.lang.Integer quonotecustId) {
		this.setQuonotecustId(quonotecustId);
		initialize();
	}
	...
	// primary key
	private java.lang.Integer quonotecustId;
     ...
     *  column="QUONOTECUST_ID"
     */
	public java.lang.Integer getQuonotecustId () {
		return quonotecustId;
	}

	/**
	 * Set the unique identifier of this class
	 * @param quonotecustId the new ID
	 */
	public void setQuonotecustId (java.lang.Integer quonotecustId) {
		this.quonotecustId = quonotecustId;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.bureaueye.beacon.model.quotation.Quonotecust)) return false;
		else {
			com.bureaueye.beacon.model.quotation.Quonotecust quonotecust = (com.bureaueye.beacon.model.quotation.Quonotecust) obj;
			if (null == this.getQuonotecustId() || null == quonotecust.getQuonotecustId()) return false;
			else return (this.getQuonotecustId().equals(quonotecust.getQuonotecustId()));
		}
	}

	public int hashCode () {
		if (Integer.MIN_VALUE == this.hashCode) {
			if (null == this.getQuonotecustId()) return super.hashCode();
			else {
				String hashStr = this.getClass().getName() + ":" + this.getQuonotecustId().hashCode();
