...
/**
 */
public class SaveJobmovBookingnotificationAction extends BaseAction {
	...
	public SaveJobmovBookingnotificationAction() {
		try {
	...
	public void toPrint(PrinthdrForm saveForm, User user) throws ServletException, IOException
	{
		...
		_Table1_1.addCell(new Phrase("Booking Notification",headingFont));
		...
		try {
			_Table1_9.addCell(new Phrase("Vendor:",fontBold));
			_Table1_9.addCell(new Phrase(saveForm.getShipper(),font));
			_Table1_9.addCell(new Phrase("Vendor Ref:",fontBold));
		...
		try {
			...
			_Table1_6.addCell(new Phrase("From Location:",fontBold));
			_Table1_6.addCell(new Phrase(saveForm.getPol(),font));
			_Table1_6.addCell(new Phrase("Estimate From Date:",fontBold));
			_Table1_6.addCell(new Phrase(Util.dateTextFormat2(saveForm.getPoldateest()),font));

			_Table1_6.addCell(new Phrase("To Location:",fontBold));
			_Table1_6.addCell(new Phrase(saveForm.getPod(),font));
			_Table1_6.addCell(new Phrase("Estimate To Date:",fontBold));
