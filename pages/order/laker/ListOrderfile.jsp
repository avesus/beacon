...
<span class="header2"><bean:message key="orderfile.title.list"/></span>
...
<img class="NavigationSprite Expand" title="Show More Information" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" onClick="showHideSearch('header','header2');"/>
    ...
    <tr>
      <td class="label10"><bean:write name="ListOrderfileForm" property="headerInfo1" scope="session"/></td>
      <td class="label10"><bean:write name="ListOrderfileForm" property="headerInfo2" scope="session"/></td>
      <td class="label10"></td>              
    </tr>
...
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>        
    	...
    	<tr>
		    <td class="label10" colspan="3"><bean:write name="ListOrderfileForm" property="headerInfo4" scope="session"/></td>               
		</tr>           
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>  
    	<tr>
    	...
    	<tr>
		    <td class="label10"><bean:write name="ListOrderfileForm" property="headerInfo3" scope="session"/></td>
		    <td class="label10"><bean:write name="ListOrderfileForm" property="headerInfo5" scope="session"/></td>
		    <td class="label10"></td>                 
		</tr>
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>  
    	<tr>
    	...
    	<tr>
		    <td class="label10"><bean:write name="ListOrderfileForm" property="headerInfo6" scope="session"/></td>
		    <td class="label10"><bean:write name="ListOrderfileForm" property="headerInfo7" scope="session"/></td>
		    <td class="label10"></td>                 
		</tr>
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>  
    	<tr>
    	...
    	<tr>
		    <td class="label10"><bean:write name="ListOrderfileForm" property="headerInfo8" scope="session"/></td>
		    <td class="label10"></td>
		    <td class="label10"></td>                 
		</tr>
...
<html:form action="/ListOrderfileLaker">
<html:hidden property="gotoPage" />
	<html:hidden name="ListOrderfileForm" property="headerInfo1"/>        
	<html:hidden name="ListOrderfileForm" property="id"/>            
...
document.location.href='EditOrderfileLaker.do?'+
'&amp;orderhdrId='+
 						...
 						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
		  						<td class="column-header1" width="10%">              
                    				<button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListOrderfileLaker.do?orderBy=Createdate&gotoPage=0'">
										<span><bean:message key="heading.date"/></span>                        
										<logic:notEqual name="ListOrderfileForm" property="orderBy" scope="session" value="Createdate">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListOrderfileForm" property="orderBy" scope="session" value="Createdate">              
		  						...
		  						<td class="column-header2" width="10%">
							         <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListOrderfileLaker.do?orderBy=Createtime&gotoPage=0'">
										<span><bean:message key="heading.time"/></span>          
										<logic:notEqual name="ListOrderfileForm" property="orderBy" scope="session" value="Createtime">              
											<img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListOrderfileForm" property="orderBy" scope="session" value="Createtime">              
											<img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>  
							        </button>                                                             
								</td>
					  			...
					  			<td class="column-header2" width="10%">
 							        <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListOrderfileLaker.do?orderBy=Createuserid&gotoPage=0'">
										<span><bean:message key="heading.userid"/></span>        
										<logic:notEqual name="ListOrderfileForm" property="orderBy" scope="session" value="Createuserid">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListOrderfileForm" property="orderBy" scope="session" value="Createuserid">              
									         <img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>   
							        </button>                        	
								</td>  
					  			...
					  			<td class="column-header2" width="50%">
 							        <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListOrderfileLaker.do?orderBy=Description&gotoPage=0'">
										<span><bean:message key="heading.documentdescription"/></span>        
										<logic:notEqual name="ListOrderfileForm" property="orderBy" scope="session" value="Description">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListOrderfileForm" property="orderBy" scope="session" value="Description">              
									         <img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>   
							        </button>                        	
								</td>                                 
...
<orderapp:linkOrderfileLineItem page="/EditOrderfileLaker.do?action=View"><bean:message key="prompt.view"/></orderapp:linkOrderfileLineItem><span class="label5">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
<orderapp:linkOrderfileLineItem page="/EditOrderfileLaker.do?action=Delete"><bean:message key="prompt.delete"/></orderapp:linkOrderfileLineItem>					  
