...
public class ListCustomertariffhdrForm extends ActionForm {
	...
	private List<CustomertariffhdrDTO> list;
	...
	public List<CustomertariffhdrDTO> getList() {
		return list;
	}

	public void setList(List<CustomertariffhdrDTO> list) {
		this.list = list;
	}
	...
	public CustomertariffhdrDTO getCustomertariffhdrDTO(int i) {
		if (getList() == null) {
			setList(new ArrayList<CustomertariffhdrDTO>());
		}

		while (getList().size() <= i) {
			getList().add(new CustomertariffhdrDTO());
		}

		return (CustomertariffhdrDTO) getList().get(i);
	}
