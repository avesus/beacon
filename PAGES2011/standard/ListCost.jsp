...
<%--      <td height="20" bgcolor="#CCCCCC">&nbsp;</td>--%>  
	<td class="tdwht"><span class="heading2">     
		...
		<span class="heading2">
			<html:link action="/ListCost" styleClass="link5">
...
<html:form action="/ListCost" focus="searchString1">
...
&nbsp;<bean:message key="prompt.cost.search"/>
</h1>
</td></tr>
...
<logic:equal name="ListCostForm" property="orderBy"
			scope="session" value="Costkey">		
	<strong><bean:message key="prompt.cost"/></strong>
</logic:equal>
<logic:equal name="ListCostForm" property="orderBy"
			scope="session" value="Descr">
			<span class="link4">
	<html:link action="/ListCost?orderBy=Costkey" styleClass="link4"><bean:message key="prompt.cost"/></html:link>	
			</span>
</logic:equal>	
	<strong>&nbsp;|&nbsp;</strong>
<logic:equal name="ListCostForm" property="orderBy"
			scope="session" value="Costkey">		
	<html:link action="/ListCost?orderBy=Descr" styleClass="link4"><bean:message key="prompt.description"/></html:link>	
</logic:equal>
<logic:equal name="ListCostForm" property="orderBy"
			scope="session" value="Descr">		
...
<logic:equal name="ListCostForm" property="lastPage"
			scope="session" value="false">
<INPUT type="image" id="nextButton" name="nextButton" src="images/arrow_next.gif"/>				
</logic:equal>
<logic:notEqual name="ListCostForm" property="lastPage"
			scope="session" value="false">
...
<html:link action="/EditCost?action=Create"><bean:message key="prompt.cost.add"/></html:link>								
						</td>
					</tr>
					</table>									
					</td>
...
int row=0;
%>		
			<logic:iterate id="costLineItem" name="ListCostForm" property="lineItems">
<%
...
%>			
				...
				<span class="text2">
					<td class="<%= _class %>" width="15%">
						<bean:write name="costLineItem" property="costkey" filter="true"/>
					</td> 
					<td class="<%= _class %>" width="60%">
						<bean:write name="costLineItem" property="descr" filter="true"/>
					</td> 					 
					<td class="<%= _class %>" width="25%">
	  					<app:linkCostLineItem page="/EditCost.do?action=Delete"><bean:message key="prompt.delete"/></app:linkCostLineItem>&nbsp;|&nbsp;						
	  					<app:linkCostLineItem page="/EditCost.do?action=Edit"><bean:message key="prompt.edit"/></app:linkCostLineItem>&nbsp;|&nbsp;
	  					<app:linkCostLineItem page="/EditCost.do?action=Copy"><bean:message key="prompt.copy"/></app:linkCostLineItem>							  
					</td>
				</span>
  				</tr>
			</logic:iterate>
