...
<html:html>
<head>
<title>Address Lookup Search</title>
...
<tr bgcolor="#F1F1F1"><td><span class="header2">Address Lookup Search</span></td></tr> 
...
<html:form action="/ListAddressSearch" focus="searchString1">				
<html:hidden property="maxResults" />
	...
	<tr>                                  
                                  <tr>
                                    <td width="22%" class="label2"><div align="right"> <bean:message key="prompt.shortname"/>: </div></td>
                                    <td width="78%" class="label2"><html:text property="searchString2" size="50" styleClass="forminput1"/> </td>
                                  </tr>
                                </table></td>
                            </tr>
                            ...
                            <tr>
                              <td><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#ffffff">
                                  ...
                                  <tr>
                                    <td width="22%" class="label2">&nbsp;</td>
                                    <td width="78%" class="label2"><html:text property="searchString6" size="50" styleClass="forminput1"/> </td>
                                  </tr>
                                  <tr>
