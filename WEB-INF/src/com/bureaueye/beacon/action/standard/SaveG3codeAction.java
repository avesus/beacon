 ...
 * 												
 */
public final class SaveG3codeAction extends BaseAction {
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		G3codeForm saveForm = (G3codeForm) form;
		...
		Integer pk = null;		
		try {
			pk = new Integer(saveForm.getG3codeId());			
		} catch (Exception e) {}
		// find data-access-object using primary key
		G3code dao = bd.read(pk);
		...
		if (action.equals("Create")) {
			...
			G3code duplicate = null;
			try{duplicate=bd.findG3codeByG1codekeyG2codekeyG3codekey(saveForm.getG1codekey(), saveForm.getG2codekey(), saveForm.getG3codekey());}catch(ApplicationException ae){}
			if (duplicate != null) {
