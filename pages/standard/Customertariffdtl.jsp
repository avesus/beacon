...
<head>
<logic:equal name="CustomertariffdtlForm" property="action"
...
<!-- BREADCRUMBS -----------------> 
		<tr bgcolor="#F1F1F1"><td><span class="header2">
    			<logic:equal name="CustomertariffdtlForm" property="action" scope="request" value="Create">
		    		<bean:message key="customertariffdtl.title.create"/>
    			</logic:equal>
		    	<logic:equal name="CustomertariffdtlForm" property="action" scope="request" value="Delete">
		      		<bean:message key="customertariffdtl.title.delete"/>
      			</logic:equal>
		    	<logic:equal name="CustomertariffdtlForm" property="action" scope="request" value="Edit">
		        	<bean:message key="customertariffdtl.title.edit"/>
     			</logic:equal>		  
            </span>
<span class="header2">&gt;</span>                         
<html:link action="/ListCustomertariffdtl"><span class="header4"><bean:message key="customertariffdtl.title.list"/></span></html:link>            
<span class="header2">&gt;</span>                         
...
<html:form action="/SaveCustomertariffdtl" focus="fromvalue">
<html:hidden property="action"/>
<html:hidden property="custtarfhdrId"/>
                        
<logic:notEqual name="CustomertariffdtlForm" property="action"
            scope="request" value="Create">
<html:hidden property="custtarfdtlId"/>
</logic:notEqual>
...
<logic:equal name="CustomertariffdtlForm" property="action"
                     scope="request" value="Delete">
<strong>
                     <bean:write name="CustomertariffdtlForm" property="fromvalue"/></strong>
</logic:equal>	                                    
                                    </td></tr>
...
<logic:equal name="CustomertariffdtlForm" property="action"
                     scope="request" value="Delete">
<strong>
                     <bean:write name="CustomertariffdtlForm" property="tovalue"/></strong>
</logic:equal>	
                                    </td></tr>
...
<logic:equal name="CustomertariffdtlForm" property="action"
                     scope="request" value="Delete">
<strong>
                     <bean:write name="CustomertariffdtlForm" property="unitrate"/></strong>
</logic:equal>
                                    </td></tr>
...
<logic:equal name="CustomertariffdtlForm" property="action"
                     scope="request" value="Delete">
<strong>
                     <bean:write name="CustomertariffdtlForm" property="lumpsum"/></strong>
</logic:equal>
                                    </td></tr>
