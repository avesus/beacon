...
<html:form action="/ListOrderchargeLaker">
<html:hidden property="gotoPage" />
	<html:hidden name="ListOrderchargeForm" property="headerInfo1"/>  
	<html:hidden name="ListOrderchargeForm" property="headerInfo9"/>           
...
<c:if test="${ListOrderchargeForm.headerInfo9 == 'false'}">	                    	              
						<button id="addButton" class="btn btnFF" type="button" onClick="
document.location.href='EditOrderchargeLaker.do?'+
'&amp;orderhdrId='+
 						...
 						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
		  						...
		  						<td class="column-header2" width="10%">
							         <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListOrderchargeLaker.do?orderBy=Chargekey&gotoPage=0'">
					  			...
					  			<td class="column-header2" width="10%">
 							        <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListOrderchargeLaker.do?orderBy=Invoicestatus&gotoPage=0'">
					  			...
					  			<td class="column-header2" width="10%">
 							        <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListOrderchargeLaker.do?orderBy=Ccykey&gotoPage=0'">
					  			...
					  			<td class="column-header2" width="10%" align="right">
 							        <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListOrderchargeLaker.do?orderBy=Chgamt&gotoPage=0'">
...
<c:if test="${orderchargeLineItem.invoicestatus == ''}">											
	<orderapp:linkOrderchargeLineItem page="/EditOrderchargeLaker.do?action=Edit"><bean:message key="prompt.edit"/></orderapp:linkOrderchargeLineItem><span class="label5">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
</c:if>
<c:if test="${orderchargeLineItem.invoicestatus != ''}">	
	<orderapp:linkOrderchargeLineItem page="/EditOrderchargeLaker.do?action=View"><bean:message key="prompt.view"/></orderapp:linkOrderchargeLineItem><span class="label5">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
</c:if>													

	<orderapp:linkOrderchargeLineItem page="/EditOrderchargeLaker.do?action=Copy"><bean:message key="prompt.copy"/></orderapp:linkOrderchargeLineItem>
    
<c:if test="${orderchargeLineItem.invoicestatus == ''}">											
<span class="label5">&nbsp;&nbsp;|&nbsp;&nbsp;</span><orderapp:linkOrderchargeLineItem page="/EditOrderchargeLaker.do?action=Delete"><bean:message key="prompt.delete"/></orderapp:linkOrderchargeLineItem>
</c:if>    					
						</td>
							</tr>
						</table>		                                    
