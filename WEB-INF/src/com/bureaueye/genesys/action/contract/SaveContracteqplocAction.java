...
public final class SaveContracteqplocAction extends BaseAction {
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		ContracteqplocForm saveForm = (ContracteqplocForm) form;
		...
		ContracteqplocBD bd = new ContracteqplocBD(this.getSessionFactoryClusterMap());

		// set primary key
		Integer pk = null;		
		try {
			pk = new Integer(saveForm.getContracteqplocId());			
		} catch (Exception e) {}
		// find data-access-object using primary key
		Contracteqploc dto = bd.read(pk);
		// not found create empty object
		if (dto == null) {
			dto = new Contracteqploc();
		}
		...
		if (action.equals("Delete")) {		
			bd.delete(new Contracteqploc(pk), user);		
		} else {
