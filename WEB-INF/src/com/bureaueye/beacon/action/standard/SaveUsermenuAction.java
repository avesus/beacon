...
public final class SaveUsermenuAction extends BaseAction {
	...
	throws Exception {
		...
		UsermenuForm saveForm = (UsermenuForm) form;
		...
		UsermenuBD bd = new UsermenuBD(this.getSessionFactoryClusterMap());
		
		// set primary key
		Integer pk = null;		
		try {
			pk = new Integer(saveForm.getUsermenuId());			
		} catch (Exception e) {}
		// find data-access-object using primary key
		Usermenu dto = bd.read(pk);
		...
		if (action.equals("Delete")) {		
			bd.delete(new Usermenu(pk),user);		
		} else {
