...
//------------------------------------------------------------------------------------------------------------------
// Returns statemenet to MYSQLDB database. This database provider is used for examples
java.sql.Statement getMysqlStatement(HttpServletRequest request, JspWriter out, String dbPath, String user, String pass) throws Exception{ return getMysqlStatement(request,out,dbPath,user,pass,false); }
java.sql.Statement getMysqlStatement(HttpServletRequest request, JspWriter out, String dbPath, String user, String pass, boolean fromHTML) throws Exception {
String Path = request.getServletPath().replaceAll("[^\\/\\\\]*$",""); // Relative path to script directory ending with "/"
java.sql.Connection Conn = null;
java.sql.Statement Cmd = null;
try {
	Class.forName("org.gjt.mm.mysql.Driver").newInstance();
	Conn = java.sql.DriverManager.getConnection("jdbc:mysql://"+dbPath, user, pass);
	return Conn.createStatement();
   } catch (Exception e) {
      String Err = "! Failed to connect to MYSQLDB.";
      try{
         out.print(fromHTML?"<font color=red>"+Err+"</font>" : "<Grid><IO Result='-1' Message='"+Err+"'/></Grid>");
         out.close();
      } catch(Exception e2) { }
...
//------------------------------------------------------------------------------------------------------------------
// Returns statemenet to PROGRESS database.
java.sql.Statement getProgressStatement(HttpServletRequest request, JspWriter out, String dbPath, String user, String pass) throws Exception{ return getProgressStatement(request,out,dbPath,user,pass,false); }
java.sql.Statement getProgressStatement(HttpServletRequest request, JspWriter out, String dbPath, String user, String pass, boolean fromHTML) throws Exception {
java.sql.Connection Conn = null;
java.sql.Statement Cmd = null;
try {
	Class.forName("com.progress.sql.jdbc.JdbcProgressDriver").newInstance();
	Conn = java.sql.DriverManager.getConnection("jdbc:jdbcprogress:T:"+dbPath, user, pass);
	return Conn.createStatement();
   } catch (Exception e) {
      String Err = "! Failed to connect to Progress.";
      try{
         out.print(fromHTML?"<font color=red>"+Err+"</font>" : "<Grid><IO Result='-1' Message='"+Err+"'/></Grid>");
         out.close();
      } catch(Exception e2) { }
