...
<head><title><bean:message key="onhireeqpotc.title"/></title></head>
...
<span class="header2"><bean:message key="onhireeqpotc.title"/></span>
...
<html:hidden name="ListOnhireeqpotcForm" property="id"/>
...
document.location.href='EditOnhireeqpotc.do?'+
'&amp;onhireeqpId='+
