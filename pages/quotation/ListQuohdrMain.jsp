...
<head>
<title><bean:message key="quohdr.title.list"/></title>
</head>
...
<!-- BREADCRUMBS -----------------> 
<tr bgcolor="#F1F1F1"><td width="70%"><span class="header2"><bean:message key="quohdr.title.list"/></span></td><td width="30%"><jsp:include page="/pages/operations/menubar.jsp" flush="true" /></td></tr>  
