...
<html:form action="/ListG3code" focus="searchString1">
<html:hidden property="gotoPage" />
				...
				<tr><td colspan="2">
					<div class="btnPane">	        
						...
						<button id="addButton" class="btn btnFF" type="button" onClick="document.location.href='EditG3code.do?action=Create'">
 						...
 						<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
							<tr>
		  						<td class="column-header1" width="10%">              
                    				<button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListG3code.do?orderBy=G1codekey&gotoPage=0'">
										<span><bean:message key="heading.g1code"/></span>                        
										<logic:notEqual name="ListG3codeForm" property="orderBy" scope="session" value="G1codekey">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListG3codeForm" property="orderBy" scope="session" value="G1codekey">              
		  						...
		  						<td class="column-header2" width="10%">              
                    				<button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListG3code.do?orderBy=G2codekey&gotoPage=0'">
										<span><bean:message key="heading.g2code"/></span>                        
										<logic:notEqual name="ListG3codeForm" property="orderBy" scope="session" value="G2codekey">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListG3codeForm" property="orderBy" scope="session" value="G2codekey">              
									         <img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>
							        </button>
								</td>
		  						...
		  						<td class="column-header2" width="10%">              
                    				<button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListG3code.do?orderBy=G3codekey&gotoPage=0'">
										<span><bean:message key="heading.g3code"/></span>                        
										<logic:notEqual name="ListG3codeForm" property="orderBy" scope="session" value="G3codekey">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListG3codeForm" property="orderBy" scope="session" value="G3codekey">              
									         <img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>
							        </button>
								</td>
		  						...
		  						<td class="column-header2" width="45%">
							         <button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListG3code.do?orderBy=Ldesc&gotoPage=0'">
										<span><bean:message key="heading.description"/></span>          
										<logic:notEqual name="ListG3codeForm" property="orderBy" scope="session" value="Ldesc">              
											<img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListG3codeForm" property="orderBy" scope="session" value="Ldesc">              
											<img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>  
							        </button>                                                             
								</td>
...
<%int row=0;%>			
							<logic:iterate id="lineItem" name="ListG3codeForm" property="lineItems">
...
<html:link action="/EditG3code.do?action=Edit" paramId="g3codeId" paramName="lineItem" paramProperty="g3codeId"><bean:message key="prompt.edit"/></html:link>
&nbsp;&nbsp;|&nbsp;&nbsp;
<html:link action="/EditG3code.do?action=Copy" paramId="g3codeId" paramName="lineItem" paramProperty="g3codeId"><bean:message key="prompt.copy"/></html:link>
&nbsp;&nbsp;|&nbsp;&nbsp;
<html:link action="/EditG3code.do?action=Delete" paramId="g3codeId" paramName="lineItem" paramProperty="g3codeId">
