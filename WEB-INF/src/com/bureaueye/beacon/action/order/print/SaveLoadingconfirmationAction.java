 ...
 * search argument
 */
public class SaveLoadingconfirmationAction extends BaseAction {
	...
	public void toPrint(PrinthdrForm saveForm, User user) throws ServletException, IOException
	{
		...
		try {
			...
			_Table1_1.addCell(new Phrase("Loading Confirmation",headingFont));
			...
			// details header
			float[] widths1_2 = {0.20f, 0.3f, 0.3f, 0.2f};
			...
			_Table1_2.addCell(new Phrase("Product",fontSmallBold));
			_Table1_2.addCell(new Phrase("Release Reference",fontSmallBold));
			_Table1_2.addCell(new Phrase("Loaded at Plant on",fontSmallBold));

			_PdfPCell = new PdfPCell(_Table1_2);  
			_PdfPCell.setBorder(Rectangle.TOP);
			_PdfPCell.setBorderWidthTop(0.1f);
			_PdfPCell.setBorderColorTop(BaseColor.BLACK);
			_Table1.addCell(_PdfPCell);


			float[] widths1_3 = {0.05f, 0.25f, 0.25f, 0.25f};
			...
			_Table1_3.addCell(new Phrase("Master Carrier",fontSmallBold));
			_Table1_3.addCell(new Phrase("Vessel Name",fontSmallBold));
			_Table1_3.addCell(new Phrase("Voyage Reference",fontSmallBold));
			...
			for (Iterator it = saveForm.getPrintdtls().iterator(); it.hasNext();) {
				...
				try {
					// details header
					float[] widths1_4 = {0.20f, 0.3f, 0.3f, 0.2f};
					...
					_Table1_4.addCell(new Phrase(printdtlForm.getPickupPlantRef(),fontSmall));
					try {
					...
					float[] widths1_5 = {0.05f, 0.25f, 0.25f, 0.25f};
					PdfPTable _Table1_5 = new PdfPTable(widths1_5);  		
					_Table1_5.getDefaultCell().setBorder(CELL_BORDER);

					_Table1_5.addCell(new Phrase("",fontSmall));
					try{ 
						_Table1_5.addCell(new Phrase(printdtlForm.getVendor(),fontSmall)); 
					} catch (Exception e) {
						_Table1_5.addCell(new Phrase("",fontSmall)); 	
					}
					try{ 
						_Table1_5.addCell(new Phrase(printdtlForm.getVessel(),fontSmall));
					} catch (Exception e) {
						_Table1_5.addCell(new Phrase("",fontSmall)); 	
					}			
					try{ 
						_Table1_5.addCell(new Phrase(printdtlForm.getMovref(),fontSmall));
					} catch (Exception e) {
						_Table1_5.addCell(new Phrase("",fontSmall)); 	
					}			
			...
			try {
				...
				_Table1_6.addCell(new Phrase("Reference:",fontBold));
			...
			try {
				...
				_Table1_6.addCell(new Phrase("Loading At:",fontBold));
				_Table1_6.addCell(new Phrase(saveForm.getMemo1(),font));
				...
				_Table1_6.addCell(new Phrase("Destination Plant:",fontBold));
				_Table1_6.addCell(new Phrase(saveForm.getMemo3(),font));
			...
			try {
				...
				_Table1_6.addCell(new Phrase("Shipper:",fontBold));
				_Table1_6.addCell(new Phrase(saveForm.getShipper(),font));
				_Table1_6.addCell(new Phrase("Consignee:",fontBold));
				_Table1_6.addCell(new Phrase(saveForm.getConsignee(),font));
				_Table1_6.addCell(new Phrase("Customer:",fontBold));
				_Table1_6.addCell(new Phrase(saveForm.getCustomer(),font));
				_Table1_6.addCell(new Phrase("Customer Ref:",fontBold));
				_Table1_6.addCell(new Phrase(saveForm.getCustomerRef(),font));
				_Table1_6.addCell(new Phrase("Ship Method:",fontBold));
				_Table1_6.addCell(new Phrase(saveForm.getShipMethod(),font));	   		
			...
			try {
				...
				_Table1_6.addCell(new Phrase("Quote:",fontBold));
				_Table1_6.addCell(new Phrase(saveForm.getMemo11(),font));	
				_Table1_6.addCell(new Phrase("Comments:",fontBold));
				_Table1_6.addCell(new Phrase(saveForm.getMemo7(),font));	
