...
public final class OrderhdrDTO extends BaseDTO implements Serializable {
	...
	public OrderhdrDTO(Orderhdr dao, Map<String, SessionFactory> sfcm)
	...
	protected void initialize(Orderhdr dao) throws ApplicationException {
		...
		this.setCustomeraddrkey(new AddressBD(this
				.getSessionFactoryClusterMap()).read(dao.getCustomeraddrkey()));
		...
		location = new LocationBD(this.getSessionFactoryClusterMap()).read(dao
				.getLdglocationkey1());
		if (location == null)
		...
		product = new ProductBD(this.getSessionFactoryClusterMap()).read(dao
				.getProductkey());
		if (product == null)
			product = new Product();
		...
		address = new AddressBD(this.getSessionFactoryClusterMap()).read(dao
				.getShipvendoraddrkey());
		...
		this.setJobhdrsfound("false");
		try {
			if (new OrderhdrBD(this.getSessionFactoryClusterMap()).getJobhdrs(
					dao.getId()).size() > 0)
				this.setJobhdrsfound("true");
		} catch (ApplicationException ae) {
		}

		this.setNotesfound("0");
		try {
			this.setNotesfound(new OrdernoteBD(this
					.getSessionFactoryClusterMap())
					.findOrdernotesTotalResults(dao.getId().toString())
					+ "");
		} catch (ApplicationException ae) {
		}
		...
		try {
			this.setNotecustsfound(new OrdernotecustBD(this
					.getSessionFactoryClusterMap())
					.findOrdernotecustsTotalResults(dao.getId().toString())
					+ "");
		} catch (ApplicationException ae) {
		}
		...
		try {
			this.setDocumentsfound(new OrderfileBD(this
					.getSessionFactoryClusterMap())
					.findOrderfilesTotalResults(dao.getId().toString())
					+ "");
		} catch (ApplicationException ae) {
		}
	...
	public String getJobhdrsfound() {
		return jobhdrsfound;
	}

	public void setJobhdrsfound(String jobhdrsfound) {
		this.jobhdrsfound = jobhdrsfound;
	}

	public String getNotesfound() {
		return notesfound;
	}

	public void setNotesfound(String notesfound) {
		this.notesfound = notesfound;
	}

	public String getNotecustsfound() {
		return notecustsfound;
	}

	public void setNotecustsfound(String notecustsfound) {
		this.notecustsfound = notecustsfound;
	}

	public String getDocumentsfound() {
		return documentsfound;
	}

	public void setDocumentsfound(String documentsfound) {
	 ...
	 * 
	 * @hibernate.id generator-class="native" column="ORDERHDR_ID"
	 */
	 ...
	 * 
	 * @param shipperaddrkey
	 *            the shipperaddrkey value
	 */
	 ...
	 * 
	 * @param mainchargeamount
	 *            the mainchargeamount value
	 */
	 ...
	 * 
	 * @param ldglocationkey1
	 *            the ldglocationkey1 value
	 */
	 ...
	 * 
	 * @param ldglocationkey2
	 *            the ldglocationkey2 value
	 */
	 ...
	 * 
	 * @param dchlocationkey1
	 *            the dchlocationkey1 value
	 */
	 ...
	 * 
	 * @param emptytankrepoflag
	 *            the emptytankrepoflag value
	 */
	 ...
	 * 
	 * @param mainchargeccykey
	 *            the mainchargeccykey value
	 */
	 ...
	 * 
	 * @param dchlocationkey2
	 *            the dchlocationkey2 value
	 */
	 ...
	 * 
	 * @param dmrgfreedaysleft
	 *            the dmrgfreedaysleft value
	 */
	 ...
	 * 
	 * @param dmrglocationkey
	 *            the dmrglocationkey value
	 */
	 ...
	 * 
	 * @param dchtotimeinmillis
	 *            the dchtotimeinmillis value
	 */
	 ...
	 * 
	 * @param dchfromtimeinmillis
	 *            the dchfromtimeinmillis value
	 */
	 ...
	 * 
	 * @param customercontactkey
	 *            the customercontactkey value
	 */
	 ...
	 * 
	 * @param minProfAcceptFlag
	 *            the MIN_PROF_ACCEPT_FLAG value
	 */
	 ...
	 * 
	 * @param ldgfromtimeinmillis
	 *            the ldgfromtimeinmillis value
	 */
	 ...
	 * 
	 * @param consigneeaddrkey
	 *            the consigneeaddrkey value
	 */
	 ...
	 * 
	 * @param ldgtotimeinmillis
	 *            the ldgtotimeinmillis value
	 */
	 ...
	 * 
	 * @param fwdagentaddrkey
	 *            the fwdagentaddrkey value
	 */
