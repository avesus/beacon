...
<html:form action="/SaveQuohdr" focus="customeraddrkey">
...
<div style="position:relative;">
		...
		<html:select property="customeraddrkey" 
			...
			onchange="loadDoc(event); processLookupAddress('customeraddrkey');">
        ...
        <html:text property="customerref" size="30"  maxlength="20" styleClass="forminput1"/>	
								...
								<tr><td class="label1" colspan="3"><bean:message key="prompt.proposedcustomerdetails"/></td></tr>
								...
								<table border="0" cellpadding="5" cellspacing="5" width="100%" bgcolor="#ffffff">                                 
             						...
             						<tr><td class="label2"><bean:message key="prompt.name"/>:</td></tr>
              						<tr><td class="label2">
<html:text property="customername" size="70"  maxlength="50" styleClass="forminput1"/>
...
<app:linkQuohdr page="/EditAddressCreate.do?"><html:img src="images/buttons/btn_add_address.png" alt="Add Customer Address" border="0" align="top"/></app:linkQuohdr>
             						...
             						<tr><td class="label2"><bean:message key="prompt.address"/>:</td></tr>
              						<tr><td class="label2">
        <html:text property="customeraddr1" size="70"  maxlength="50" styleClass="forminput1"/>	
                                    </td></tr>                                                                                
              						<tr><td class="label2">
        <html:text property="customeraddr2" size="70"  maxlength="50" styleClass="forminput1"/>	
                                    </td></tr>   
              						<tr><td class="label2">
        <html:text property="customeraddr3" size="70"  maxlength="50" styleClass="forminput1"/>	
                                    </td></tr>  
               						<tr><td class="label2">
        <html:text property="customeraddr4" size="70"  maxlength="50" styleClass="forminput1"/>	
                                    </td></tr>             						
                                    
                                    <tr><td class="label2"><bean:message key="prompt.contact"/>:</td></tr>
              						<tr><td class="label2">
        <html:text property="customercontact" size="50"  maxlength="50" styleClass="forminput1"/>		
                                    </td></tr>
                                    
                                    <tr><td class="label2"><bean:message key="prompt.phone"/>:</td></tr>
              						<tr><td class="label2">
        <html:text property="customertelno" size="50"  maxlength="50" styleClass="forminput1"/>		
                                    </td></tr>
                                    
                                    <tr><td class="label2"><bean:message key="prompt.fax"/>:</td></tr>
              						<tr><td class="label2">
        <html:text property="customerfaxno" size="50"  maxlength="50" styleClass="forminput1"/>		
                                    </td></tr>
                                    
                                    <tr><td class="label2"><bean:message key="prompt.email"/>:</td></tr>
              						<tr><td class="label2">
        <html:text property="customeremail" size="50"  maxlength="50" styleClass="forminput1"/>	
                                    </td></tr>                                                                                                                                                                        
								</table>
    							</td>
