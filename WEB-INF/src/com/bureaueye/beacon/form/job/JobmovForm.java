...
public final class JobmovForm extends BaseForm {
	...
	private java.lang.String _txt3;
	
	private java.lang.String _vessel;

	private java.lang.String _mmulink;
	//private java.lang.String _selectedObjectsAll;
	...
	//checks
	private String orderjobsfound = "false";
	private String orderconsignmentsfound = "false";
	private java.lang.String mmu;
	

	public String getMmu() {return mmu;}
	public void setMmu(String mmu) {this.mmu = mmu;}
	
	public String getOrderjobsfound() {return orderjobsfound;}
	public void setOrderjobsfound(String orderjobsfound) {this.orderjobsfound = orderjobsfound;}
	
	public String getOrderconsignmentsfound() {return orderconsignmentsfound;}
	public void setOrderconsignmentsfound(String orderconsignmentsfound) {this.orderconsignmentsfound = orderconsignmentsfound;}
	...
	/**
     */
	public java.lang.String getMmulink() {		return _mmulink;	}
	/**
	 */
	public void setMmulink(java.lang.String _mmulink) {		this._mmulink = _mmulink;	}
	

	
/*	*//**
     *//*
	public java.lang.String getSelectedObjectsAll() {		return _selectedObjectsAll;	}
	*//**
	 *//*
	public void setSelectedObjectsAll(java.lang.String _selectedObjectsAll) {		this._selectedObjectsAll = _selectedObjectsAll;	}
*/	
...
/**
	 ...
	 * @param _txt3 the _txt3 value
	 */
	public void setTxt3(java.lang.String _txt3) {
		this._txt3 = _txt3;
	}
	...
	public JobhdrmovDTO getJobmovDTO(int i) {
		if (getMmuList() == null) {
			setMmuList(new ArrayList());
		}
		while (getMmuList().size() <= i) {
			getMmuList().add(new JobhdrmovDTO());
		}
		return (JobhdrmovDTO) getMmuList().get(i);
	}
	/**
	 * 
	 * 
