...
<%--    <td height="20" bgcolor="#CCCCCC">&nbsp;</td>--%>
	...
	<bean:message key="vendortariffhdr.title.list"/> </html:link> 
...
<%--    <td bgcolor="#CCCCCC" width="121" valign="top" align="center"><jsp:include page="/pages/sidebarWelcome.jsp" flush="true" />
    ...
    <td><div style="OVERFLOW:auto; width:650px; height:650px; position:relative;">
        <table border="0" cellpadding="5" cellspacing="5" width="100%" bgcolor="#ffffff">
          <tr>
            <td><html:form action="/ListVendortariffdtl">
                        ...
                        <td><table border="0" cellpadding="3" cellspacing="0" width="100%" bgcolor="#ffffff">
                            <tr>
                              <td><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
                                  <tr>
                                    <td width="20%" class="td4"><span class="heading6"><bean:message key="heading.vendor"/></span></td>
                                    <td width="20%" class="td4"><span class="heading6"><bean:message key="heading.cost"/></span></td>
                                  ...
                                  <tr> <span class="text2">
                                    <td class="td6">
									<bean:write name="ListVendortariffdtlForm" property="header.vendoraddrkey.name" filter="true"/> 									
									</td>
                                    <td class="td6">
									<bean:write name="ListVendortariffdtlForm" property="header.costkey.descr" filter="true"/> 
									</td>
                                    <td class="td6"><bean:write name="ListVendortariffdtlForm" property="header.fromlocationkey.locationName" filter="true"/> </td>
                                    <td class="td6"><bean:write name="ListVendortariffdtlForm" property="header.tolocationkey.locationName" filter="true"/> </td>
                                    <td class="td6"><bean:write name="ListVendortariffdtlForm" property="header.unittype" filter="true"/> </td>
                                    </span> </tr>
                                </table></td>
                          </table></td>
                      </tr>
...
%>
                            <tr> <span class="text2">
<td class="<%= _class %>">
<html:text name="vendortariffdtlDTO" indexed="true" property="row" size="3" styleClass="ftforminputsmall" readonly="true"/>
</td>							
                              <td class="<%= _class %>"><html:hidden name="vendortariffdtlDTO" property="vendtarfdtlId" indexed="true" /><logic:equal
					name="vendortariffdtlDTO" property="vendtarfdtlId" value="">*</logic:equal></td>
                              <td class="<%= _class %>">
							  <html:text name="vendortariffdtlDTO" indexed="true" property="fromvalue" maxlength="5" size="19" styleClass="ftforminputsmall"/> </td>
                              <td class="<%= _class %>">
							  <html:text name="vendortariffdtlDTO" indexed="true" property="tovalue" maxlength="5" size="19" styleClass="ftforminputsmall"/> </td>
                              <td class="<%= _class %>">
							  <html:text name="vendortariffdtlDTO" indexed="true" property="unitrate" maxlength="5" size="19" styleClass="ftforminputsmall"/> </td>
                              <td class="<%= _class %>">
							  <html:text name="vendortariffdtlDTO" indexed="true" property="lumpsum" maxlength="5" size="19" styleClass="ftforminputsmall"/> </td>
