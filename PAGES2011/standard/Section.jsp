...
<logic:equal name="SectionForm" property="action"
  ...
  <tr>
    <td><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#ffffff">
      ...
      <logic:equal name="SectionForm" property="action"
                  scope="request" value="Create">
        <html:text property="sectionkey" size="15" maxlength="10" styleClass="ftforminputsmall"/>
      </logic:equal>
  ...
  <tr>
    <td><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#ffffff">  			
        ...
        <tr>
          ...
          <td width="78%" class="td2">      
		<html:select property="movests" styleClass="ftforminputsmall">
			<html:option value=""><bean:message key="prompt.selectastatus"/></html:option>
        ...
        <tr>
          ...
          <td width="78%" class="td2">
		<html:select property="transportmode" styleClass="ftforminputsmall">
			<html:option value=""/>
