...
/**
 * This is an object that contains data related to the vendortariffavg table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="vendortariffavg"
 */

public abstract class BaseVendortariffavg  implements Serializable {

	public static String REF = "Vendortariffavg";
	...
	public static String PROP_TSG3KEY = "Tsg3key";
	...
	public static String PROP_TSG4KEY = "Tsg4key";
	...
	public static String PROP_TSG1KEY = "Tsg1key";
	public static String PROP_XINACTIVE = "Xinactive";
	public static String PROP_P1KEY = "P1key";
	public static String PROP_VALIDFROM = "Validfrom";
	public static String PROP_TSG2KEY = "Tsg2key";
	public static String PROP_VALIDTO = "Validto";
	public static String PROP_VENDORTARIFFAVG_ID = "VendortariffavgId";
	 ...
	 */
	public BaseVendortariffavg (java.lang.Integer vendortariffavgId) {
		this.setVendortariffavgId(vendortariffavgId);
		initialize();
	}
	...
	// primary key
	private java.lang.Integer vendortariffavgId;
	...
	private java.lang.String tsg1key;
	private java.lang.String tsg2key;
	private java.lang.String tsg3key;
	private java.lang.String tsg4key;
     ...
     *  column="VENDORTARIFFAVG_ID"
     */
	public java.lang.Integer getVendortariffavgId () {
		return vendortariffavgId;
	}

	/**
	 * Set the unique identifier of this class
	 * @param vendortariffavgId the new ID
	 */
	public void setVendortariffavgId (java.lang.Integer vendortariffavgId) {
		this.vendortariffavgId = vendortariffavgId;
	...
	/**
	 * Return the value associated with the column: tsg1key
	 */
	public java.lang.String getTsg1key () {
		return tsg1key;
	}

	/**
	 * Set the value related to the column: tsg1key
	 * @param tsg1key the tsg1key value
	 */
	public void setTsg1key (java.lang.String tsg1key) {
		this.tsg1key = tsg1key;
	}



	/**
	 * Return the value associated with the column: tsg2key
	 */
	public java.lang.String getTsg2key () {
		return tsg2key;
	}

	/**
	 * Set the value related to the column: tsg2key
	 * @param tsg2key the tsg2key value
	 */
	public void setTsg2key (java.lang.String tsg2key) {
		this.tsg2key = tsg2key;
	}



	/**
	 * Return the value associated with the column: tsg3key
	 */
	public java.lang.String getTsg3key () {
		return tsg3key;
	}

	/**
	 * Set the value related to the column: tsg3key
	 * @param tsg3key the tsg3key value
	 */
	public void setTsg3key (java.lang.String tsg3key) {
		this.tsg3key = tsg3key;
	}



	/**
	 * Return the value associated with the column: tsg4key
	 */
	public java.lang.String getTsg4key () {
		return tsg4key;
	}

	/**
	 * Set the value related to the column: tsg4key
	 * @param tsg4key the tsg4key value
	 */
	public void setTsg4key (java.lang.String tsg4key) {
		this.tsg4key = tsg4key;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.bureaueye.beacon.model.standard.Vendortariffavg)) return false;
		else {
			com.bureaueye.beacon.model.standard.Vendortariffavg vendortariffavg = (com.bureaueye.beacon.model.standard.Vendortariffavg) obj;
			if (null == this.getVendortariffavgId() || null == vendortariffavg.getVendortariffavgId()) return false;
			else return (this.getVendortariffavgId().equals(vendortariffavg.getVendortariffavgId()));
		}
	}

	public int hashCode () {
		if (Integer.MIN_VALUE == this.hashCode) {
			if (null == this.getVendortariffavgId()) return super.hashCode();
			else {
				String hashStr = this.getClass().getName() + ":" + this.getVendortariffavgId().hashCode();
