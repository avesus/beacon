...
<%--      <td height="20" bgcolor="#CCCCCC">&nbsp;</td>--%>  
	<td class="tdwht"><span class="heading2">     
		...
		<span class="heading2">
			<html:link action="/ListUnittest" styleClass="link5">
...
<table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
  ...
  <tr class="text2"> 
    <td class="td6">
	&nbsp;<bean:write name="ListUnittestForm" property="headerInfo1" scope="session"/>
	</td>
    <td class="td6">
	&nbsp;<bean:write name="ListUnittestForm" property="headerInfo2" scope="session"/>
	</td>
    <td class="td6">
	&nbsp;<bean:write name="ListUnittestForm" property="headerInfo3" scope="session"/>
	</td>								
   </tr>
...
<table border="0" cellpadding="2" cellspacing="2" width="100%" bgcolor="#ffffff">
  <tr>
	<td align="right">
<logic:equal name="ListUnittestForm" property="firstPage"
			scope="session" value="false">			
<INPUT type="image" id="startButton" name="startButton" src="images/arrow_start.gif"/>
 </logic:equal>	
<logic:notEqual name="ListUnittestForm" property="firstPage"
			scope="session" value="false">
...
<logic:equal name="ListUnittestForm" property="lastPage"
			scope="session" value="false">
<INPUT type="image" id="nextButton" name="nextButton" src="images/arrow_next.gif"/>				
</logic:equal>
<logic:notEqual name="ListUnittestForm" property="lastPage"
			scope="session" value="false">
			...
			<table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
				<tr>		
		  			<td class="tddkgry" width="20%"><span class="heading4">
						<bean:message key="heading.type"/></span>
					</td>
		  			<td class="tddkgry" width="20%"><span class="heading4">
						<bean:message key="heading.duedate"/> </span>
					</td>
		  			<td class="tddkgry" width="20%"><span class="heading4">
						<bean:message key="heading.testdate"/> </span>
					</td>
		  			<td class="tddkgry" width="20%"><span class="heading4">
						<bean:message key="heading.testby"/></span>
					</td>															
...
<app:linkUnittestCreate page="/EditUnittest.do?action=Create">
	<bean:message key="prompt.addatest"/>
</app:linkUnittestCreate>											
						</td>
					</tr>
					</table>									
					</td>
				</tr>		
			<c:forEach var="unittestLineItem" items="${ListUnittestForm.lineItems}" varStatus="loop">
				...
				<span class="text2">			
					...
					<td class='<c:out value="${_class}"/>' width="20%" align="right">
	  					...
	  					<app:linkUnittestLineItem page="/EditUnittest.do?action=Edit"><bean:message key="prompt.edit"/></app:linkUnittestLineItem>												</td>							
										</tr>
									</table>												  
					</td>								 										 
				</span>
