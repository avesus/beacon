...
<head>
<title><bean:message key="ccy.title.list"/></title>
...
<!-- BREADCRUMBS -----------------> 
<tr bgcolor="#F1F1F1"><td><span class="header2"><bean:message key="ccy.title.list"/></span></td></tr>  
			...
			<html:hidden property="gotoPage" />
            		...
            		<td><html:img src="images/spacer.gif" border="0" width="1" height="1"/></td>
       				...
       				<td width="100%">      
      					<table border="0" cellpadding="5" cellspacing="5" width="100%" bgcolor="#ffffff">
            				...
            				<tr><td class="label2"><bean:message key="prompt.ccy.search"/>:</td></tr>
    						<tr><td class="label2">
				...
				<tr><td colspan="2">
					<div class="btnPane">	        
						...
						<button id="addButton" class="btn btnFF" type="button" onClick="document.location.href='EditCcy.do?action=Create'">
...
<%String _class = "column-cell1";if ((row % 2) == 0) _class = "column-cell2";row++;%>	
  								...
  								<tr>
									<td class="<%= _class %>"><bean:write name="ccyLineItem" property="ccykey" filter="true"/></td> 

									<td class="<%= _class %>"><bean:write name="ccyLineItem" property="ccyname" filter="true"/></td>                                                                                                                                         					 
									<td>
										<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
											<tr>
		  										<td class="<%= _class %>"></td>
...
<html:link action="/EditCcy.do?action=Edit" paramId="ccykey" paramName="ccyLineItem" paramProperty="ccykey"><bean:message key="prompt.edit"/></html:link>
&nbsp;&nbsp;|&nbsp;&nbsp;
<html:link action="/EditCcy.do?action=Copy" paramId="ccykey" paramName="ccyLineItem" paramProperty="ccykey"><bean:message key="prompt.copy"/></html:link>
&nbsp;&nbsp;|&nbsp;&nbsp;
<html:link action="/EditCcy.do?action=Delete" paramId="ccykey" paramName="ccyLineItem" paramProperty="ccykey">
