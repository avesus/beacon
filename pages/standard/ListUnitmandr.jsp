...
<head>
<title><bean:message key="unitmandr.title.list"/></title>
...
<span class="header2"><bean:message key="unitmandr.title.list"/></span>
...
<img class="NavigationSprite Expand" title="Show More Information" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;"/>
    ...
    <tr>
      <td class="label10"><bean:write name="ListUnitmandrForm" property="headerInfo1" scope="session"/></td>
      <td class="label10"><bean:write name="ListUnitmandrForm" property="headerInfo2" scope="session"/></td>
      <td class="label10"></td>              
    </tr>
...
<tr><td><img src="images/spacer.gif" height="5"/></td></tr>        
    	...
    	<tr>
		    <td class="label10" colspan="3"><bean:write name="ListUnitmandrForm" property="headerInfo3" scope="session"/></td>               
		</tr>           
...
<html:hidden property="gotoPage" />
	<html:hidden name="ListUnitmandrForm" property="headerInfo1"/>        
	<html:hidden name="ListUnitmandrForm" property="id"/>            
...
document.location.href='EditUnitmandr.do?'+
'&amp;unitId='+
 						...
 						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
		  						<td class="column-header1" width="10%">              
                    				<button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListUnitmandr.do?orderBy=Mandrdate&gotoPage=0'">
										<span><bean:message key="heading.mandrdate"/></span>                        
										<logic:notEqual name="ListUnitmandrForm" property="orderBy" scope="session" value="Mandrdate">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListUnitmandrForm" property="orderBy" scope="session" value="Mandrdate">              
		  						...
		  						<td class="column-header2" width="10%">              
                    				<button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListUnitmandr.do?orderBy=Mandrref&gotoPage=0'">
										<span><bean:message key="heading.reference"/></span>                        
										<logic:notEqual name="ListUnitmandrForm" property="orderBy" scope="session" value="Mandrref">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListUnitmandrForm" property="orderBy" scope="session" value="Mandrref">              
									         <img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>
							        </button>
								</td>  
 		  						...
 		  						<td class="column-header2" width="15%">              
                    				<button id="sortButton" class="column-header-btn1" type="button" onClick="#">
										<span><bean:message key="heading.location"/></span>                        
							        </button>
								</td>                                                                                                                                                    		  								<td class="column-header2" width="10%">              
                    				<button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListUnitmandr.do?orderBy=Labouramt&gotoPage=0'">
										<span><bean:message key="heading.labouramt"/></span>                        
										<logic:notEqual name="ListUnitmandrForm" property="orderBy" scope="session" value="Labouramt">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListUnitmandrForm" property="orderBy" scope="session" value="Labouramt">              
									         <img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>
							        </button>
								</td> 
  								...
  								<td class="column-header2" width="10%">              
                    				<button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListUnitmandr.do?orderBy=Materialamt&gotoPage=0'">
										<span><bean:message key="heading.materialamt"/></span>                        
										<logic:notEqual name="ListUnitmandrForm" property="orderBy" scope="session" value="Materialamt">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListUnitmandrForm" property="orderBy" scope="session" value="Materialamt">              
									         <img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>
							        </button>
								</td>
  								...
  								<td class="column-header2" width="30%">              
                    				<button id="sortButton" class="column-header-btn1" type="button" onClick="document.location.href='ListUnitmandr.do?orderBy=Mandrdesc&gotoPage=0'">
										<span><bean:message key="heading.mandrdescription"/></span>                        
										<logic:notEqual name="ListUnitmandrForm" property="orderBy" scope="session" value="Mandrdesc">              
									         <img class=" IM2 Spacer-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:notEqual>
										<logic:equal name="ListUnitmandrForm" property="orderBy" scope="session" value="Mandrdesc">              
									         <img class=" IM2 Sortdown-IM2" title="" src="images/buttons/clear1x1.gif" alt="" style="border-width:0px;" />       
										</logic:equal>
							        </button>
								</td>
...
<%int row=0;%>			
	<logic:iterate id="lineItem" name="ListUnitmandrForm" property="lineItems">
