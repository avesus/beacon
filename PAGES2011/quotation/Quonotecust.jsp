...
<logic:equal name="QuonotecustForm" property="action"
  ...
  <title><bean:message key="quonotecust.title.create"/></title>
</logic:equal>
<logic:equal name="QuonotecustForm" property="action"
            scope="request" value="Delete">
  <title><bean:message key="quonotecust.title.delete"/></title>
</logic:equal>
<logic:equal name="QuonotecustForm" property="action"
            scope="request" value="Edit">
  <title><bean:message key="quonotecust.title.edit"/></title>
</logic:equal>
<logic:equal name="QuonotecustForm" property="action"
            scope="request" value="View">
  <title><bean:message key="quonotecust.title.view"/></title>
</logic:equal>	
...
<logic:equal name="QuonotecustForm" property="action"
  ...
  <bean:message key="quonotecust.title.view"/>
      ...
      <logic:notEqual name="QuonotecustForm" property="action"
                     scope="request" value="Delete">  
  ...
  <tr>
	...
	<table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#999999">
      <tr>
		...
		&nbsp;<bean:write name="QuonotecustForm" property="createdate_" format="dd-MMM-yyyy" scope="request"/>
</span>
		</td>	      </tr>
      <tr>  
        <td width="40%" class="td2">
        ...
        <td width="60%" class="td2">
		<span  styleClass="ftforminputsmall">
		&nbsp;<bean:write name="QuonotecustForm" property="createtime_" scope="request"/>
</span>
		</td>			
      </tr>	  
      <tr>  
...
<logic:notEqual name="QuonotecustForm" property="action" scope="request" value="View"> 			  
  <tr>
    <td colspan="2">
	<table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#999999">
        <tr>
