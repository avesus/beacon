...
<%--      <td height="20" bgcolor="#CCCCCC">&nbsp;</td>--%>  
	<td class="tdwht"><span class="heading2">     
		<strong><bean:message key="city.title"/></strong> 
		</span>
		<span class="heading2">
			<html:link action="/ListCity" styleClass="link5">
...
<html:form action="/ListCity" focus="searchString1">
...
&nbsp; <bean:message key="prompt.city.search"/>
</h1>
</td></tr>
...
<table border="0" cellpadding="2" cellspacing="2" width="100%" bgcolor="#ffffff">
  <tr>
	<td class="text2">	
	<bean:message key="prompt.sortby"/>: <strong><bean:message key="prompt.city"/></strong>
	</td>	
  </tr>
</table>
	</td>
...
<logic:equal name="ListCityForm" property="lastPage"
			scope="session" value="false">
<INPUT type="image" id="nextButton" name="nextButton" src="images/arrow_next.gif"/>				
</logic:equal>
<logic:notEqual name="ListCityForm" property="lastPage"
			scope="session" value="false">
	...
	<tr>
		<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
				<tr>
		  			<td class="tddkgry" width="75%"><span class="heading4">
						<bean:message key="heading.city"/>
		  			</span>		
					</td>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    ...
    <td align="right" class="heading4"><html:link action="/EditCity?action=Create"><bean:message key="prompt.city.add"/></html:link></td>
  </tr>
</table>						
					</td>
				</tr>
...
int row=0;
%>			
			<logic:iterate id="cityLineItem" name="ListCityForm" property="lineItems">
			<%
...
%>			
				...
				<span class="text2">
					<td class="<%= _class %>" width="75%">
						<bean:write name="cityLineItem" property="city" filter="true"/>
					</td>  
					<td class="<%= _class %>" width="25%">
					<span class="link1">
	  					<app:linkCityLineItem page="/EditCity.do?action=Delete"><bean:message key="prompt.delete"/></app:linkCityLineItem><%-- &nbsp;|&nbsp; --%>
					</span>
					<%--
	  					<app:linkCityLineItem page="/EditCity.do?action=Edit"><bean:message key="prompt.edit"/></app:linkCityLineItem>&nbsp;|&nbsp;
	  					<app:linkCityLineItem page="/EditCity.do?action=Copy"><bean:message key="prompt.copy"/></app:linkCityLineItem>	  
						--%>
					</td>
				</span>
  				</tr>
