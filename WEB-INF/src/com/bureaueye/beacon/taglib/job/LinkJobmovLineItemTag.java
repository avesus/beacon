...
public class LinkJobmovLineItemTag extends TagSupport {
	...
	public int doStartTag() throws JspException {
		...
		String name = "jobmovLineItem";

		JobmovDTO lineItem = null;
		try {
			lineItem = (JobmovDTO) pageContext.findAttribute(name);
		} catch (ClassCastException e) {
		}
		if (lineItem == null)
			throw new JspException(messages.getMessage(
					"lineItem.noJobmov", name));
		if (page.indexOf("?") < 0)
			url.append("?");
		else
			url.append("&");
