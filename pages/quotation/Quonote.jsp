...
<!-- BREADCRUMBS -----------------> 
	...
	<bean:message key="prompt.quotno"/>&nbsp;-&nbsp;<bean:write name="ListQuonoteForm" property="headerInfo1" scope="session"/>&nbsp;
</span>
		    <span class="header2">
    			<logic:equal name="QuonoteForm" property="action" scope="request" value="Create">
		    		<bean:message key="quonote.title.create"/>
    			</logic:equal>
		    	<logic:equal name="QuonoteForm" property="action" scope="request" value="Delete">
		      		<bean:message key="quonote.title.delete"/>
      			</logic:equal>
		    	<logic:equal name="QuonoteForm" property="action" scope="request" value="Edit">
		        	<bean:message key="quonote.title.edit"/>
     			</logic:equal>	
		    	<logic:equal name="QuonoteForm" property="action" scope="request" value="View">
...
<html:link action="/ListQuonote"><span class="header4"><bean:message key="quonote.title.list"/></span></html:link>
<span class="header2">&gt;</span>                             
        ...
        <html:text property="status" size="20" maxlength="10" styleClass="forminput1" disabled="true"/>                                  
							...
							<table border="0" cellpadding="5" cellspacing="5" width="100%" bgcolor="#ffffff">   
         							...
         							<tr><td class="label2"><bean:message key="prompt.createdate"/>:<html:img src="images/spacer.gif" border="0" width="1" height="15"/></td></tr>                                   
              						<tr><td class="label2">
<bean:write name="QuonoteForm" property="createdate_" format="dd-MMM-yyyy" scope="request"/><html:img src="images/spacer.gif" border="0" width="1" height="15"/>
              						</td></tr>	  
         							<tr><td class="label2"><bean:message key="prompt.createtime"/>:<html:img src="images/spacer.gif" border="0" width="1" height="15"/></td></tr>                                    
              						<tr><td class="label2">
<bean:write name="QuonoteForm" property="createtime_" scope="request"/><html:img src="images/spacer.gif" border="0" width="1" height="15"/>
              						</td></tr>                                
...
<bean:write name="QuonoteForm" property="createuserid_" scope="request"/>
				        	...
				        	<logic:notEqual name="QuonoteForm" property="action"  scope="request" value="Delete"> 
