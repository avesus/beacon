...
<tr>
	<td class="label2"><bean:message key="prompt.activeexpired"/>:</td>
</tr>
<tr>
      <td class="label2">
              <html:select property="searchString15" styleClass="forminput1">
              	<html:option value="ALL"><bean:message key="prompt.all"/></html:option>
              	<html:option value="ACTIVE"><bean:message key="prompt.active"/></html:option>        
              	<html:option value="EXPIRED"><bean:message key="prompt.expired"/></html:option>     
              </html:select>
      </td>   
</tr>
...
<tr><td><table border="0" cellpadding="1" cellspacing="3" bgcolor="#ffffff" width="210px">   
    ...
    <tr>
      <td class="label2"><bean:message key="prompt.customername"/>:</td>
    </tr>
    <tr>
      <td class="label2">

<html:text property="searchString14" size="30" maxlength="40" styleClass="forminput1" onkeypress="return noenter()"/>
