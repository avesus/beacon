...
public final class ListPihdrdtlAction extends ListAction {
	...
	throws ApplicationException {
		...
		if (!listForm.getSearchString1().equals("")) {
			listForm.setLineItems(pihdrbd.findPihdrdtlsForSearchByPino(listForm));
			processedflag = true;
		}
		if (!processedflag) {
			listForm.setLineItems(pihdrbd.findPihdrdtlsForSearch(listForm));
		}
