...
public final class SaveQuochargeAction extends BaseAction {
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		QuochargeForm quochargeForm = (QuochargeForm) form;
		String action = quochargeForm.getAction();
		...
		QuochargeBD bd = new QuochargeBD(this.getSessionFactoryClusterMap());

		// set primary key
		Integer pk = null;		
		try {
			pk = new Integer(quochargeForm.getQuochargeId());			
		} catch (Exception e) {}
		// find data-access-object using primary key
		Quocharge dto = bd.read(pk);
		...
		BeanUtils.copyProperties(dto, quochargeForm);
					
		
		
		if (action.equals("Delete")) {		
			bd.delete(new Quocharge(pk), user);		
		} else {
