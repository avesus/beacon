...
<!-- BREADCRUMBS -----------------> 
	...
	<bean:message key="prompt.orderno"/>&nbsp;-&nbsp;<bean:write name="ListJobhdrForm" property="headerInfo1" scope="session"/>&nbsp;
		    ...
		    <span class="header2">
		    	...
		    	<logic:equal name="JobhdrcostForm" property="action" scope="request" value="Delete">
		      		<bean:message key="jobcost.title.delete"/>
      			</logic:equal>
		    	<logic:equal name="JobhdrcostForm" property="action" scope="request" value="Edit">
		        	<bean:message key="jobcost.title.edit"/>
     			</logic:equal>	
		    	<logic:equal name="JobhdrcostForm" property="action" scope="request" value="View">
...
<html:link action="/ListJobhdrcost"><span class="header4"><bean:message key="jobcost.title.list"/></span></html:link>
<span class="header2">&gt;</span>                             
...
<logic:notEqual name="JobhdrcostForm" property="action" scope="request" value="View">         
