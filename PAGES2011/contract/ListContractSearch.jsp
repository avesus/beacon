...
<div id="search" style="position:absolute; left:0px; top:0px; width:200px; height:650px; z-index:10; visibility: visible;">
  <table border="0" cellpadding="1" cellspacing="2" width="100%" class="contractSearchBgcolor">
    <tr>
...
<INPUT name="searchButton" border="0" type="image" id="searchButton" src="images/refreshButtonBorderGrey.gif" align="bottom" onMouseOut="MM_swapImgRestore();" onMouseOver="MM_swapImage('searchButton','','images/refreshButtonBorderGrey.gif','searchButton','','images/refreshButtonBorderGrey_over_blue.gif',1);"/>
          <bean:message key="contract.title.search"/>
        </h1></td>
    </tr>
    <tr>
    ...
    <tr>
      <td class="contractSearchText"><bean:message key="prompt.contractno"/>
        : </td>
    </tr>
    <tr>
      <td class="contractSearchText"><html:text property="searchString1" size="30" maxlength="40" styleClass="ftforminputsmall" onkeypress="return noenter()"/>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="left" class="contractSearchText"><bean:message key="prompt.lessee"/>:</td>
    </tr>
    <tr>
    ...
    <tr>
      <td class="contractSearchText"><bean:message key="prompt.createdate"/>: </td>
    </tr>
    <tr>
      <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <td class="contractSearchText">&nbsp;<bean:message key="prompt.from"/>:</td>
          </tr>
          <tr>
          ...
          <tr>
            <td class="contractSearchText">&nbsp;<bean:message key="prompt.to"/>:</td>
          </tr>
          <tr>
    ...
    <tr>
      <td class="contractSearchText"><bean:message key="prompt.company"/>: </td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="left" class="contractSearchText"><bean:message key="prompt.department"/>: </td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="left" class="contractSearchText"><bean:message key="prompt.activity"/>: </td>
    </tr>
    <tr>
      <td align="left" valign="top"><html:select property="searchString6" styleClass="ftforminputsmall">
          <html:option value="">
    ...
    <tr>
      <td align="left" class="contractSearchText">
