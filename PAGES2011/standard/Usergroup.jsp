...
<logic:equal name="UsergroupForm" property="action"
  ...
  <title><bean:message key="usergroup.title.create"/></title>
</logic:equal>
<logic:equal name="UsergroupForm" property="action"
            scope="request" value="Delete">
  <title><bean:message key="usergroup.title.delete"/></title>
</logic:equal>
<logic:equal name="UsergroupForm" property="action"
            scope="request" value="Edit">
  <title><bean:message key="usergroup.title.edit"/></title>
</logic:equal>	
...
<logic:equal name="UsergroupForm" property="action"
  ...
  <tr>
	...
	<table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#999999">  				
        ...
        <logic:notEqual name="UsergroupForm" property="action"
                     scope="request" value="Delete"> 
  <tr>
    <td><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#999999">
        <tr>
		  ...
		  <c:if test="${UsergroupForm.action == 'Create'}">
        	<html:text property="usergroupid" size="30" maxlength="20" styleClass="ftforminputsmall"/>
		  </c:if>
		  <c:if test="${UsergroupForm.action != 'Create'}">
        	<html:text property="usergroupid" size="30" disabled="true" maxlength="20" styleClass="ftforminputsmall"/>
        ...
        <tr>
          <td width="22%" class="td2">
		  <div align="right"><bean:message key="prompt.name"/>:		  </div>		  </td>
          <td width="78%" class="td2">
        ...
        <tr>
          ...
          <td width="78%" class="td2">
		  <html:text property="email" size="30" maxlength="20" styleClass="ftforminputsmall"/>
          </td>
        </tr>					  			
    </table>
	</td>
