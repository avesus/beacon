 ...
 *
 * NT	2009-09-09		200900035			Problem with Active/Expired Search Selection
 * 												
...
<%--      <td height="20" bgcolor="#CCCCCC">&nbsp;</td>--%>  
	<td class="tdwht"><span class="heading2">     
		<strong>Quotation List Report</strong> 
		</span>					
	</td> 
</tr>  
...
<html:form action="/ReportQuotationList" focus="searchString1">
<html:hidden property="gotoPage" />
<html:hidden property="searchDate3dd" /><!--200900035-->
<html:hidden property="searchDate3mm" /><!--200900035-->
<html:hidden property="searchDate3yyyy" /><!--200900035-->
