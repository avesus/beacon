...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
  <tr>
   <td bgcolor="#f6f6f6"><html:img src="images/icons/icon_address_search.png" alt="Search" border="0" align="middle"/><span class="heading9">Address Search</span></td>  
  </tr>
...
<html:hidden property="maxResults" />
	...
	<tr>                                  
                                  <tr>
                                    ...
                                    <td width="78%" class="td2"><html:text property="searchString2" size="50" styleClass="ftforminputsmall"/> </td>
                                  </tr>
                                </table></td>
                            </tr>
                            <tr>
                              <td><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#ffffff">
                                  ...
                                  <tr>
                                    <td width="22%" class="td2">&nbsp;</td>
                                    <td width="78%" class="td2"><html:text property="searchString6" size="50" styleClass="ftforminputsmall"/> </td>
                                  </tr>
                                  <tr>
