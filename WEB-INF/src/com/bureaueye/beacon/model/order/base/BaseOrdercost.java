...
/**
 * This is an object that contains data related to the ordercost table.
...
public abstract class BaseOrdercost  implements Serializable {

	public static String REF = "Ordercost";
	...
	public static String PROP_ORDERCOST_ID = "OrdercostId";
	 ...
	 */
	public BaseOrdercost (java.lang.Integer ordercostId) {
		this.setOrdercostId(ordercostId);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.bureaueye.beacon.model.order.Ordercost)) return false;
		else {
			com.bureaueye.beacon.model.order.Ordercost ordercost = (com.bureaueye.beacon.model.order.Ordercost) obj;
			if (null == this.getOrdercostId() || null == ordercost.getOrdercostId()) return false;
			else return (this.getOrdercostId().equals(ordercost.getOrdercostId()));
		}
	}

	public int hashCode () {
		if (Integer.MIN_VALUE == this.hashCode) {
			if (null == this.getOrdercostId()) return super.hashCode();
			else {
				String hashStr = this.getClass().getName() + ":" + this.getOrdercostId().hashCode();
