...
<%
com.bureaueye.beacon.bean.AnalysisPool analysisPool=
(com.bureaueye.beacon.bean.AnalysisPool)session.getAttribute(com.bureaueye.beacon.bean.Constants.ANALYSIS_POOL_KEY);
%>
...
<span id='spanid-<bean:write name="usermenu" property="menuid"/>'><bean:write name="usermenu" property="menuid"/></span>
		...
		<td width="100%"><html:img src="images/spacer.gif" border="0" width="100%" height="1"/></td>
