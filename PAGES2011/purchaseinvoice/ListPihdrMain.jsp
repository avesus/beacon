...
<html:html>
  <head>
  <title>
  <bean:message key="pihdr.title.list"/>
  </title>
...
<html:form action="/ListPihdr" focus="searchString1">
	<html:hidden property="gotoPage" />
          <jsp:include page="/pages/purchaseinvoice/ListPihdrSearch.jsp" flush="true" />
          <jsp:include page="/pages/purchaseinvoice/ListPihdrResults.jsp" flush="true" />
</html:form>	
