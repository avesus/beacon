...
public class ListVendortariffdtlForm extends ActionForm {
	...
	public VendortariffdtlDTO getVendortariffdtlDTO(int i) {
		if (getList() == null) {
			setList(new ArrayList());
		}

		while (getList().size() <= i) {
			getList().add(new VendortariffdtlDTO());
		}

		return (VendortariffdtlDTO) getList().get(i);
	}
