 ...
 * 	
 */
public final class BuildOrderconfirmation
{
	...
	public void build(
		...
		try {
			...
			String title=
				resourceProps.getString("title.orderconfirmation");
	...
	public void doBody1() throws DocumentException, BadElementException,  Exception
	{
		...
		try {
			...
			label.setPhrase(new Phrase(resourceProps.getString("prompt.ourquotationnumber"),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(": "+getTagValue("quotno",elementOrdhdr1),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			...
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(": "+getTagValue("g4ldesc",elementLdgaddrkey)+", "+getTagValue("g3ldesc",elementLdgaddrkey),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(resourceProps.getString("prompt.to"),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(": "+getTagValue("g4ldesc",elementDchaddrkey)+", "+getTagValue("g3ldesc",elementDchaddrkey),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);		
		...
		try {
			float[] widths = {0.04f, 0.24f, 0.12f, 0.1f, 0.15f, 0.2f, 0.15f};
			...
			_text.addCell(new Phrase(resourceProps.getString("heading.yourref"),font));		               			
			...
			_text.addCell(new Phrase(resourceProps.getString("heading.quantity"),font));			
			...
			_text.addCell(new Phrase(resourceProps.getString("heading.loadingdatetime"),font));	
			...
			_text.addCell(new Phrase(resourceProps.getString("heading.loadingref"),font));	
	...
	public void doBody2() throws DocumentException, BadElementException,  Exception
	{
		...
		org.w3c.dom.Element elementOrdhdr1Ordtxt1 = null;
		...
		elementOrdhdr1Ordtxt1=(org.w3c.dom.Element) elementOrdhdr1.getElementsByTagName("ordtxt1").item(0);
		...
		try {
			...
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(": "+xmlToPdf.formatDate(getTagValue("frdate",elementDespmovshipping)),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			...
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(resourceProps.getString("prompt.amsclosing"),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(
					new Phrase(
							": "+
							xmlToPdf.formatDate(getTagValue("AMSclosedate",elementOrdhdr1)),
							font
					)
			);
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(resourceProps.getString("prompt.cutoffdatetime"),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(
					new Phrase(
							": "+
							xmlToPdf.formatDate(getTagValue("cutoffdate",elementOrdhdr1)),
							font
					)
			);
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
		...
		try {
			...
			//derive loading notes
			String notes = "";
			//use loading notes for EXPORT			
			notes=getTagValue("txt",elementOrdhdr1Ordtxt1)+" "+getTagValue("txt2",elementOrdhdr1Ordtxt1);
	...
	) throws DocumentException, BadElementException,  Exception
	{
		...
		try {
			...
			_text.addCell(new Phrase(getTagValue("loadno",elementOrdhdr),font));	
