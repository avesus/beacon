...
public abstract class BaseJobcost  implements Serializable {

	public static String REF = "Jobcost";
	...
	public static String PROP_INVSTAT = "Invstat";
	public static String PROP_SYSTEMLOGACTION = "Systemlogaction";
	public static String PROP_SYSTEMLOGPROGRAM = "Systemlogprogram";
	public static String PROP_CREATEDATE = "Createdate";
	public static String PROP_COSTKEY = "Costkey";
	public static String PROP_PI_LINKKEY = "PiLinkkey";
	...
	public static String PROP_ACCRLOG_LINKKEY = "AccrlogLinkkey";
	public static String PROP_JOBMOV_ID = "JobmovId";
	public static String PROP_AIOUT_ID = "AioutId";
	public static String PROP_POSTSTATUS = "Poststatus";
	...
	public static String PROP_LABOURCSTAMT = "Labourcstamt";
	public static String PROP_ACCRSTAT = "Accrstat";
	public static String PROP_TXT = "Txt";
	public static String PROP_SELFBILLSTAT = "Selfbillstat";
	...
	public static String PROP_INVDATE = "Invdate";
	 ...
	 */
	public BaseJobcost (java.lang.Integer jobcostId) {
	...
	/**
	 * Return the value associated with the column: poststatus
	 */
	...
	/**
	 * Set the value related to the column: poststatus
	 * @param poststatus the poststatus value
	 */
