...
/**
 * This is an object that contains data related to the g1code table.
...
public abstract class BaseG1code  implements Serializable {

	public static String REF = "G1code";
	public static String PROP_SYSTEMLOGTIME = "Systemlogtime";
	public static String PROP_CREATEUSERID = "Createuserid";
	public static String PROP_G1CODEKEY = "G1codekey";
	public static String PROP_G1CODE_ID = "G1codeId";
	...
	public static String PROP_GROUPG1CODEKEY = "Groupg1codekey";
	 ...
	 */
	public BaseG1code (java.lang.Integer g1codeId) {
		this.setG1codeId(g1codeId);
		initialize();
	}
	...
	// primary key
	private java.lang.Integer g1codeId;
     ...
     *  column="G1CODE_ID"
     */
	public java.lang.Integer getG1codeId () {
		return g1codeId;
	}
	 ...
	 */
	public void setG1codeId (java.lang.Integer g1codeId) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.bureaueye.beacon.model.standard.G1code)) return false;
		else {
			com.bureaueye.beacon.model.standard.G1code g1code = (com.bureaueye.beacon.model.standard.G1code) obj;
			if (null == this.getG1codeId() || null == g1code.getG1codeId()) return false;
			else return (this.getG1codeId().equals(g1code.getG1codeId()));
		}
	}

	public int hashCode () {
		if (Integer.MIN_VALUE == this.hashCode) {
			if (null == this.getG1codeId()) return super.hashCode();
			else {
				String hashStr = this.getClass().getName() + ":" + this.getG1codeId().hashCode();
