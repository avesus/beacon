...
<%--      <td height="20" bgcolor="#CCCCCC">&nbsp;</td>--%>  
	<td class="tdwht"><span class="heading2">     
		<strong><bean:message key="vessel.title"/></strong> 
		</span>
		<span class="heading2">
			<html:link action="/ListVessel" styleClass="link5">
...
&nbsp;<bean:message key="prompt.vessel.search"/>
</h1>
</td></tr>
...
<logic:equal name="ListVesselForm" property="orderBy"
			scope="session" value="Vesselkey">		
	<strong><bean:message key="prompt.vessel"/></strong>
</logic:equal>
<logic:equal name="ListVesselForm" property="orderBy"
			scope="session" value="Vesselname">
			<span class="link4">
	<html:link action="/ListVessel?orderBy=Vesselkey" styleClass="link4"><bean:message key="prompt.vessel"/></html:link>	
			</span>
</logic:equal>	
	<strong>&nbsp;|&nbsp;</strong>
<logic:equal name="ListVesselForm" property="orderBy"
			scope="session" value="Vesselkey">		
	<html:link action="/ListVessel?orderBy=Vesselname" styleClass="link4"><bean:message key="prompt.name"/></html:link>	
</logic:equal>
<logic:equal name="ListVesselForm" property="orderBy"
			scope="session" value="Vesselname">		
...
<table border="0" cellpadding="2" cellspacing="2" width="100%" bgcolor="#ffffff">
  <tr>
	<td align="right">
<logic:equal name="ListVesselForm" property="firstPage"
			scope="session" value="false">			
<INPUT type="image" id="startButton" name="startButton" src="images/arrow_start.gif"/>			
 </logic:equal>	
<logic:notEqual name="ListVesselForm" property="firstPage"
			scope="session" value="false">
...
<logic:equal name="ListVesselForm" property="lastPage"
			scope="session" value="false">
<INPUT type="image" id="nextButton" name="nextButton" src="images/arrow_next.gif"/>				
</logic:equal>
<logic:notEqual name="ListVesselForm" property="lastPage"
			scope="session" value="false">
			...
			<table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
				<tr>
		  			<td class="tddkgry" width="15%"><span class="heading4">
						<bean:message key="heading.vessel"/>
		  			</span>
					</td>
...
<html:link action="/EditVessel?action=Create"><bean:message key="prompt.vessel.add"/></html:link>								
						</td>
					</tr>
					</table>									
					</td>
...
%>				
				...
				<span class="text2">
					<td class="<%= _class %>" width="15%">
						<bean:write name="vesselLineItem" property="vesselkey" filter="true"/>
					</td> 
					<td class="<%= _class %>" width="60%">
						<bean:write name="vesselLineItem" property="vesselname" filter="true"/>
					</td> 					 
					<td class="<%= _class %>" width="25%">
	  					<app:linkVesselLineItem page="/EditVessel.do?action=Delete"><bean:message key="prompt.delete"/></app:linkVesselLineItem>&nbsp;|&nbsp;						
	  					<app:linkVesselLineItem page="/EditVessel.do?action=Edit"><bean:message key="prompt.edit"/></app:linkVesselLineItem>&nbsp;|&nbsp;
	  					<app:linkVesselLineItem page="/EditVessel.do?action=Copy"><bean:message key="prompt.copy"/></app:linkVesselLineItem>							  
					</td>
				</span>
  				</tr>
			</logic:iterate>
