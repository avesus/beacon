...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
  <tr>
   <td bgcolor="#f6f6f6"><html:img src="images/icons/icon_customertariff_search.png" alt="Search" border="0" align="middle"/><span class="header2"><bean:message key="title.tariffsearch"/></span></td>  
  </tr>
...
<html:form action="/ListQuotationCustomertariffSearch" focus="searchString1"> 
<html:hidden property="maxResults" />                       
            ...
            <td><html:img src="images/spacer.gif" border="0" width="1" height="1"/></td>
       		...
       		<td width="100%"><table border="0" cellpadding="5" cellspacing="5" width="100%" bgcolor="#ffffff">
                                  ...
                                  <tr>
                                    <td class="label2"><bean:message key="prompt.customer"/>: </td></tr>
                                    <tr><td class="label2">
		<html:select property="searchString1" styleClass="forminput1">
			...
			<html:options collection="customers" property="addrkey" labelProperty="name"/>
                                  ...
                                  <tr>
                                    <td class="label2"><bean:message key="prompt.charge"/>: </td></tr>
                                    <tr>
                                    <td class="label2">
		<html:select property="searchString2" styleClass="forminput1"> 
			...
			<html:options collection="charges" property="chargekey" labelProperty="ldesc"/> 
                                  ...
                                  <tr>
                                    <td class="label2"> <bean:message key="prompt.pickup"/>: </td></tr>
                                    <tr>
                                    <td class="label2">
		<html:select property="searchString3" styleClass="forminput1">
			...
			<html:options collection="locations" property="locationkey" labelProperty="labelProperty"/>	
                                  ...
                                  <tr>
                                    <td class="label2"><bean:message key="prompt.portloading"/>: </td></tr>
                                    <tr>
                                    <td class="label2">
		<html:select property="searchString4" styleClass="forminput1">
			...
			<html:options collection="locations" property="locationkey" labelProperty="labelProperty"/>	
                                  ...
                                  <tr>
                                    <td class="label2"><bean:message key="prompt.portdischarge"/>: </td></tr>
                                    <tr>
                                    <td class="label2">
		<html:select property="searchString5" styleClass="forminput1">
			...
			<html:options collection="locations" property="locationkey" labelProperty="labelProperty"/>	
                                  ...
                                  <tr>
                                    <td class="label2"><bean:message key="prompt.delivery"/>: </td></tr>
                                    <tr>
                                    <td class="label2">
		<html:select property="searchString6" styleClass="forminput1">
			...
			<html:options collection="locations" property="locationkey" labelProperty="labelProperty"/>	
                                  ...
                                  <tr>
                                    <td width="22%" class="td2"><bean:message key="prompt.product"/>: </td></tr>
                                    <tr>
...
<bean:write name="ListCustomertariffSearchForm" property="searchString10" scope="session"/></strong>
									</td>
                                  </tr>	
...
<bean:write name="ListCustomertariffSearchForm" property="searchDate1" format="dd-MMM-yyyy" scope="session"/>	</strong>								
									</td>
                                  </tr>
