...
<%--      <td height="20" bgcolor="#CCCCCC">&nbsp;</td>--%>  
	<td class="tdwht"><span class="heading2">     
		...
		<span class="heading2">
			<html:link action="/ListUser" styleClass="link5">
...
&nbsp;<bean:message key="user.title.search"/></h1>
</td></tr>
...
<logic:notEqual name="ListUserForm" property="orderBy"
			scope="session" value="Userid">
	<html:link action="/ListUser?orderBy=Userid&gotoPage=0" styleClass="link6"><bean:message key="prompt.userid"/></html:link>	
</logic:notEqual>
<logic:equal name="ListUserForm" property="orderBy"
			scope="session" value="Userid">
...
<logic:equal name="ListUserForm" property="lastPage"
			scope="session" value="false">
<INPUT type="image" id="nextButton" name="nextButton" src="images/arrow_next.gif"/>				
</logic:equal>
<logic:notEqual name="ListUserForm" property="lastPage"
			scope="session" value="false">
			...
			<table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
				<tr>
		  			...
		  			<td class="tddkgry" width="60%"><span class="heading4">
						<bean:message key="heading.groupid"/></span>	
					</td>					
...
<html:link action="/EditUser?action=Create"><bean:message key="prompt.addauser"/></html:link>								
						</td>
					</tr>
					</table>									
					</td>
...
int row=0;
%>			
			<logic:iterate id="userLineItem" name="ListUserForm" property="lineItems">
<%
...
<bean:write name="userLineItem" property="userid" filter="true"/>
					</td> 
					<td class="<%= _class %>" width="60%">
<bean:write name="userLineItem" property="usergroupid" filter="true"/>					
					</td> 					 
					<td class="<%= _class %>" width="25%">
	  					<app:linkUserLineItem page="/EditUser.do?action=Delete"><bean:message key="prompt.delete"/></app:linkUserLineItem>&nbsp;|&nbsp;						
	  					<app:linkUserLineItem page="/EditUser.do?action=Edit"><bean:message key="prompt.edit"/></app:linkUserLineItem>&nbsp;|&nbsp;
	  					<app:linkUserLineItem page="/EditUser.do?action=Copy"><bean:message key="prompt.copy"/></app:linkUserLineItem>							  
					</td>
				</span>
  				</tr>
...
<app:linkUserLineItem page="/ListUsermenu.do"><bean:message key="prompt.menus"/></app:linkUserLineItem>&nbsp;|&nbsp;<app:linkUserLineItem page="/ListUseraccess.do"><bean:message key="prompt.access"/></app:linkUserLineItem>
					</td>
				</tr>	
