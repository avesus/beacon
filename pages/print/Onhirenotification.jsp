...
<html:html>
<head>
<title>On Hire Notification</title>
...
function refreshData(){
	var url     = '/beacon/EditOnhirenotification.do?'+
						'companyheaderId='+
						document.forms[0].companyheaderId.value+ 
						'&orderhdrId='+
						document.forms[0].onhireId.value+
						'&printId='+
						document.forms[0].onhireId.value+'Onhirenotification'+
						'&refreshdata=Y'+
						'&action=Print'
						;
...
<html:form action="/SaveOnhirenotification">
...
<table width="100%"  border="0" cellpadding="3" cellspacing="3">
        <tr>
          <td colspan="2" class="body2">You may release the following Unit(s) beginning <bean:write name="PrinthdrForm" property="poldateest" format="dd-MMM-yyyy" scope="session" filter="true"/> with release reference <bean:write name="PrinthdrForm" property="customerRef" scope="session"/> to <bean:write name="PrinthdrForm" property="customer" scope="session"/>. </td>
          </tr>
        <tr>
          <td class="body3black">&nbsp;</td>
          <td class="body2">&nbsp;</td>
...
<table width="100%" border="0" cellpadding="2" cellspacing="0" bgcolor="white">
  <tr>
	...
	<td width="10%"><span class="heading7">Next Test</span></td>	
	<td width="30%"><span class="heading7">Last Contents</span></td>
	<td width="10%"><span class="heading7">Release Date</span> </td>	
  </tr>
</table>
...
<tr><td><table width="100%" border="0" cellpadding="0" cellspacing="0">				 
  <tr>
	...
	<td width="10%" nowrap class="<%= _class %>">
<bean:write name="printdtlLineItem" property="puPlantLoadDate" format="dd-MMM-yyyy" filter="true"/>	
	</td>	
