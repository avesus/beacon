...
public class LinkCustomertariffdtlLineItemTag extends TagSupport {
	...
	public int doStartTag() throws JspException {
		...
		String name = "customertariffdtlLineItem";

		try {
			customertariffdtl = (Customertariffdtl) pageContext
					.findAttribute(name);
		...
		if (page.indexOf("?") < 0)
			...
			url.append("&");
		url.append("custtarfhdrId=").append(
				customertariffdtl.getCusttarfhdrId());
		url.append("&custtarfdtlId=").append(customertariffdtl.getCusttarfdtlId());
