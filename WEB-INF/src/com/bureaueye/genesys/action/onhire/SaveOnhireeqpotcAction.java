...
public final class SaveOnhireeqpotcAction extends BaseAction {
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		OnhireeqpotcForm saveForm = (OnhireeqpotcForm) form;
		...
		OnhireeqpotcBD bd = new OnhireeqpotcBD(this.getSessionFactoryClusterMap());

		// set primary key
		Integer pk = null;		
		try {
			pk = new Integer(saveForm.getOnhireeqpotcId());			
		} catch (Exception e) {}
		// find data-access-object using primary key
		Onhireeqpotc dto = bd.read(pk);
		// not found create empty object
		if (dto == null) {
			dto = new Onhireeqpotc();
		}
		...
		if (action.equals("Delete")) {		
			bd.delete(new Onhireeqpotc(pk), user);		
		} else {
