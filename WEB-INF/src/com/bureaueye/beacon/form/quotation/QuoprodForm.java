...
public final class QuoprodForm extends BaseForm {
	private static final long serialVersionUID = 1L;

	
	private String _action;

	private java.lang.String _quoprodId;
     ...
     *  column="QUOPROD_ID"
     */
	public java.lang.String getQuoprodId () {
		return _quoprodId;
	}
	 ...
	 */
	public void setQuoprodId (java.lang.String _quoprodId) {
		this._quoprodId = _quoprodId;
	}
	...
	protected ArrayList keysToSkip() {
		...
		//keysToSkip.add("quohdrId");
		//keysToSkip.add("productname");
		keysToSkip.add("unno");
		keysToSkip.add("imo");	
		keysToSkip.add("quotno");
		//keysToSkip.add("wghtunit");		
		//keysToSkip.add("lqdtemp");
		//keysToSkip.add("ldgtemp");
		//keysToSkip.add("weight");		
		//keysToSkip.add("surftemp");		
		
		//keysToSkip.add("volunit");		
		//keysToSkip.add("productkey");		
		//keysToSkip.add("ldgtemp");		
		//keysToSkip.add("comprt");		
		//keysToSkip.add("volume");		
		//keysToSkip.add("tempunit");		
		//keysToSkip.add("dchtemp");		
