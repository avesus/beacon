...
function tariffSearch(){
	...
	var url     = 'EditQuotationVendortariffSearch.do?'+
						'searchString1='+
...
<head>
<logic:equal name="QuocostForm" property="action"
...
<!-- BREADCRUMBS -----------------> 
	...
	<bean:message key="prompt.quotno"/>&nbsp;-&nbsp;<bean:write name="ListQuocostForm" property="headerInfo1" scope="session"/>&nbsp;
</span>
		    <span class="header2">
    			<logic:equal name="QuocostForm" property="action" scope="request" value="Create">
		    		<bean:message key="quocost.title.create"/>
    			</logic:equal>
		    	<logic:equal name="QuocostForm" property="action" scope="request" value="Delete">
		      		<bean:message key="quocost.title.delete"/>
      			</logic:equal>
		    	<logic:equal name="QuocostForm" property="action" scope="request" value="Edit">
		        	<bean:message key="quocost.title.edit"/>
     			</logic:equal>	
		    	<logic:equal name="QuocostForm" property="action" scope="request" value="View">
...
<html:link action="/ListQuocost"><span class="header4"><bean:message key="quocost.title.list"/></span></html:link>
<span class="header2">&gt;</span>                             
...
<html:form action="/SaveQuocost" focus="vendoraddrkey.addrkey" onsubmit="return amtCalc();">
...
<%--<html:hidden property="vendtarfhdrId"/>--%>
		...
		<html:select property="costkey" disabled="true" styleClass="forminput1"> 
			...
			<html:options collection="costs" property="costkey" labelProperty="descr"/> 
				        	...
				        	<logic:notEqual name="QuocostForm" property="action"  scope="request" value="Delete"> 
...
<logic:notEqual name="QuocostForm" property="action" scope="request" value="View">         
