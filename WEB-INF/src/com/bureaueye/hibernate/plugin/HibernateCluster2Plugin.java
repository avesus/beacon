...
public class HibernateCluster2Plugin implements PlugIn {
	...
	private static Class clazz = HibernateCluster2Plugin.class;
	...
	throws ServletException {
		...
		try {
			URL url = HibernateCluster2Plugin.class.getResource(path);
