...
<%--      <td height="20" bgcolor="#CCCCCC">&nbsp;</td>--%>  
	<td class="tdwht"><span class="heading2">     
		...
		<span class="heading2">
			<html:link action="/ListCharge" styleClass="link4">
...
<logic:equal name="ChargeForm" property="action"
  ...
  <tr>
    <td><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#ffffff">
      ...
      <logic:equal name="ChargeForm" property="action"
                  scope="request" value="Create">
        <html:text property="chargekey" maxlength="10" size="20" styleClass="ftforminputsmall"/>
      </logic:equal>
      <logic:notEqual name="ChargeForm" property="action"
                     scope="request" value="Create">
        <strong><html:hidden property="chargekey" write="true"/></strong>
      </logic:notEqual>
          </td>
        </tr>
    </table></td>
  ...
  <tr>
    <td><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#ffffff">  		
        <tr>
          ...
          <td width="78%" class="td2">
        <html:text property="ldesc" size="50" styleClass="ftforminputsmall"/>
          </td>
        </tr>		
    </table></td>
  </tr>	
  <tr>
    <td><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#ffffff">  		
        <tr>
          <td width="22%" class="td2">
		  <div align="right">
		        <bean:message key="prompt.incomeaccount"/>:
		  </div>
		  </td>
          <td width="78%" class="td2">
        <html:text property="incacct" size="10" styleClass="ftforminputsmall"/>
          </td>
        </tr>		
    </table></td>
  </tr>	  
  <tr>
    <td><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#ffffff">  			
        <tr>
          <td width="22%" class="td2">
		  <div align="right">
		        <bean:message key="prompt.charge.tax"/>:
		  </div>
		  </td>
          <td width="78%" class="td2">
