 ...
 * 	
 */
public final class BuildBookingconfirmation
{
	...
	public void build(
		...
		try {
			...
			String title1 = resourceProps.getString("title.deepsea");
	...
	public void doBody1() throws DocumentException, BadElementException,  Exception
	{
		...
		try {
			...
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(new Phrase(resourceProps.getString("prompt.cutoffdate"),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
			label.setPhrase(
					new Phrase(
