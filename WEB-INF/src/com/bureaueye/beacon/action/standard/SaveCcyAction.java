...
public final class SaveCcyAction extends BaseAction {
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		if (action.equals("Delete")) {
			ccybd.delete(new Ccy(ccyform.getCcykey()), user);
		} else {
			Ccy ccy = ccybd.read(ccyform.getCcykey());

			if (ccy == null) {
				ccy = new Ccy();
			}

			BeanUtils.copyProperties(ccy, ccyform);

			ccybd.createOrUpdate(ccy, user);
			...
			//listform.setSearchString1(ccy.getCcykey());
