...
<div style="position:relative;">
		...
		<html:select property="ldglocationkey2" styleClass="forminput1">
			...
			<html:options collection="ports" property="locationkey" labelProperty="shortLabel"/>	
             							...
             							<tr>
                                        	<td class="label2" width="30%"><bean:message key="prompt.loadingdatetime"/>:</td>
                                        </tr>
	              						<tr>
                                        	<td class="label2">
		  <table width="80%"  border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="5%" class="label2"><div align="right">From:</div></td>
              <td width="45%" class="label2">
		...
		/
		<html:select property="ldgtotimehh" styleClass="forminput1">
			<html:option value="00">HH</html:option>				
			<html:options collection="hours" property="value" labelProperty="label"/>	
		</html:select>:		  
		<html:select property="ldgtotimemm" styleClass="forminput1">
			<html:option value="00">MM</html:option>				
			<html:options collection="minutes" property="value" labelProperty="label"/>	
		</html:select>				  
			  </td>
		...
		<html:select property="dchlocationkey2" styleClass="forminput1">
			...
			<html:options collection="ports" property="locationkey" labelProperty="shortLabel"/>	
             							...
             							<tr>
                                        	<td class="label2" width="30%"><bean:message key="prompt.dischargedatetime"/>:</td>
                                        </tr>
	              						<tr>
                                        	<td class="label2">
		  <table width="80%"  border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="5%" class="label2"><div align="right">From:</div></td>
              <td width="45%" class="label2">
		<html:select property="dchfromdatedd" styleClass="forminput1">
			<html:option value=""><bean:message key="prompt.day"/></html:option>				
			<html:options collection="days" property="value" labelProperty="label"/>	
		</html:select>		  
		<html:select property="dchfromdatemm" styleClass="forminput1">
			<html:option value=""><bean:message key="prompt.month"/></html:option>				
			<html:options collection="months" property="value" labelProperty="label"/>	
		</html:select>
		<html:select property="dchfromdateyyyy" styleClass="forminput1">
			<html:option value=""><bean:message key="prompt.year"/></html:option>				
			<html:options collection="years" property="value" labelProperty="label"/>	
		</html:select>
		/
		<html:select property="dchfromtimehh" styleClass="forminput1">
			<html:option value="00">HH</html:option>				
			<html:options collection="hours" property="value" labelProperty="label"/>	
		</html:select>:		  
		<html:select property="dchfromtimemm" styleClass="forminput1">
			<html:option value="00">MM</html:option>				
			<html:options collection="minutes" property="value" labelProperty="label"/>	
		</html:select>			  
			  </td>
              <td width="5%" class="label2"><div align="right">To:</div></td>
              <td width="45%" class="label2">
		<html:select property="dchtodatedd" styleClass="forminput1">
			<html:option value=""><bean:message key="prompt.day"/></html:option>				
			<html:options collection="days" property="value" labelProperty="label"/>	
		</html:select>		  
		<html:select property="dchtodatemm" styleClass="forminput1">
			<html:option value=""><bean:message key="prompt.month"/></html:option>				
			<html:options collection="months" property="value" labelProperty="label"/>	
		</html:select>
		<html:select property="dchtodateyyyy" styleClass="forminput1">
			<html:option value=""><bean:message key="prompt.year"/></html:option>				
			<html:options collection="years" property="value" labelProperty="label"/>	
		</html:select>
		/
		<html:select property="dchtotimehh" styleClass="forminput1">
			<html:option value="00">HH</html:option>				
			<html:options collection="hours" property="value" labelProperty="label"/>	
		</html:select>:		  
		<html:select property="dchtotimemm" styleClass="forminput1">
			<html:option value="00">MM</html:option>				
			<html:options collection="minutes" property="value" labelProperty="label"/>	
		</html:select>				  
			  </td>
		...
		<html:select property="dmrglocationkey" styleClass="forminput1">
			...
			<html:options collection="ports" property="locationkey" labelProperty="locationName"/>	
             							...
             							<tr>
                                        	<td class="label2" width="30%"><bean:message key="prompt.billto"/>:</td>
                                        </tr>
	              						<tr>
                                        	<td class="label2">
		<html:select property="dmrgbilltoaddrkey" styleClass="forminput1">
			<html:option value=""><bean:message key="prompt.selectabillto"/></html:option>
