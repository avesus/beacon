 ...
 * 	
 */
public final class BuildTankrelease
{
	...
	public void build(
		...
		try {
			...
			String title=
				resourceProps.getString("title.tankrelease");
	...
	public void doBody1() throws DocumentException, BadElementException,  Exception
	{
		...
		try {
			...
			label.setPhrase(new Phrase(resourceProps.getString("prompt.pleaserelease"),font));
		...
		try {
			...
			label.setPhrase(new Phrase(resourceProps.getString("prompt.terminal"),font));
			label.setHorizontalAlignment(Element.ALIGN_LEFT);
			wrapper.addCell(label);
		...
		try {
			float[] widths = {0.04f, 0.16f, 0.20f, 0.45f, 0.15f};
			...
			_text.addCell(new Phrase(resourceProps.getString("heading.product"),font));		
	...
	) throws DocumentException, BadElementException,  Exception
	{
		...
		try{elementOrdprod10=(org.w3c.dom.Element) elementOrdhdr.getElementsByTagName("ordprod10").item(0);}catch(Exception e){}
		...
		try {
			...
			_text.addCell(new Phrase(getTagValue("prodname",elementOrdprod10),font));
