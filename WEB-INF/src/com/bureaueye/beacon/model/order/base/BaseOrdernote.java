...
/**
 * This is an object that contains data related to the ordernote table.
...
public abstract class BaseOrdernote  implements Serializable {
	 ...
	 */
	public BaseOrdernote (java.lang.Integer ordernoteId) {
		this.setOrdernoteId(ordernoteId);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.bureaueye.beacon.model.order.Ordernote)) return false;
		else {
			com.bureaueye.beacon.model.order.Ordernote ordernote = (com.bureaueye.beacon.model.order.Ordernote) obj;
			if (null == this.getOrdernoteId() || null == ordernote.getOrdernoteId()) return false;
			else return (this.getOrdernoteId().equals(ordernote.getOrdernoteId()));
		}
	}

	public int hashCode () {
		if (Integer.MIN_VALUE == this.hashCode) {
			if (null == this.getOrdernoteId()) return super.hashCode();
			else {
				String hashStr = this.getClass().getName() + ":" + this.getOrdernoteId().hashCode();
