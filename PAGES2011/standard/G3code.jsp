...
<tr>
	<td class="tdwht"><span class="heading2">     
		...
		<span class="heading2">
			<html:link action="/ListG3code" styleClass="link4">
...
<logic:equal name="G3codeForm" property="action"
  ...
  <tr>
	...
	<table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#999999">  				
        ...
        <logic:notEqual name="G3codeForm" property="action"
                     scope="request" value="Delete"> 
  <tr>
    <td><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#999999">
        <tr>
        ...
        <tr>
          ...
          <td width="78%" class="td2">
		  <c:if test="${G3codeForm.action == 'Create'}">
        <html:select property="g2codekey" styleClass="ftforminputsmall">
			<html:option value=""> <bean:message key="prompt.selectacode"/></html:option>	
		</html:select>
		  </c:if>
		  <c:if test="${G3codeForm.action != 'Create'}">
        ...
        <tr>
          ...
          <td width="78%" class="td2">
		  <c:if test="${G3codeForm.action == 'Create'}">
        	<html:text property="g3codekey" size="30" maxlength="20" styleClass="ftforminputsmall"/>
		  </c:if>
		  <c:if test="${G3codeForm.action != 'Create'}">
