...
public final class EditCustomertariffSearchAction extends PopupBaseAction {
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		if (hdr == null) {
			...
			Quohdr quohdr = new QuohdrBD(this.getSessionFactoryClusterMap()).read(new Integer(tariffsearchForm.getSearchString9()));
	
			//tariffsearchForm.setSearchString7(quohdr.getProductkey());		
