...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
  <tr>
   <td bgcolor="#f6f6f6"><html:img src="images/icons/icon_vendortariff_search.png" alt="Search" border="0" align="middle"/><span class="heading9"><bean:message key="title.tariffsearch"/></span></td>  
  </tr>
...
<html:form action="/ListStandardVendortariffSearch" focus="searchString1">
	...
	<div style="OVERFLOW:auto; width:700px; height:450px;">
                      ...
                      <tr>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              <td><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#ffffff">
                                  <tr>
                                    <td width="22%" class="td2"><div align="right"><bean:message key="prompt.vendor"/>: </div></td>
		...
		<html:select property="searchString1" styleClass="ftforminputsmall">
			...
			<html:options collection="vendors" property="addrkey" labelProperty="name"/>	
                                  ...
                                  <tr>
                                    <td width="22%" class="td2"><div align="right"><bean:message key="prompt.cost"/>: </div></td>
                                    <td width="78%" class="td2">
		<html:select property="searchString2" styleClass="ftforminputsmall"> 
			...
			<html:options collection="costs" property="costkey" labelProperty="descr"/> 
                                  ...
                                  <tr>
                                    <td width="22%" class="td2"><div align="right"> <bean:message key="prompt.fromlocation"/>: </div></td>
                                    <td width="78%" class="td2">
		<html:select property="searchString3" styleClass="ftforminputsmall">
			...
			<html:options collection="locations" property="locationkey" labelProperty="labelProperty"/>	
                                  ...
                                  <tr>
                                    <td width="22%" class="td2"><div align="right"> <bean:message key="prompt.transhipmentlocation"/>: </div></td>
                                    <td width="78%" class="td2">
		<html:select property="searchString5" styleClass="ftforminputsmall">
			...
			<html:options collection="locations" property="locationkey" labelProperty="labelProperty"/>	
                                  ...
                                  <tr>
                                    <td width="22%" class="td2"><div align="right"> <bean:message key="prompt.tolocation"/>: </div></td>
                                    <td width="78%" class="td2">
		<html:select property="searchString4" styleClass="ftforminputsmall">
			...
			<html:options collection="locations" property="locationkey" labelProperty="labelProperty"/>	
                                  ...
                                  <tr>
                                    <td width="22%" class="td2"><div align="right"> <bean:message key="prompt.product"/>: </div></td>
                                    <td width="78%" class="td2">
		...
		<html:options collection="products" property="productkey" labelProperty="tradname"/> 
                                  ...
                                  <tr>
                                    ...
                                    <td width="78%" class="td2">
<bean:write name="ListVendortariffSearchForm" property="searchString7" scope="session"/>									
									</td>
                                  </tr>
                                  <tr>
                                    <td width="22%" class="td2"><div align="right"> Type: </div></td>
                                    <td width="78%" class="td2"> 
<bean:write name="ListVendortariffSearchForm" property="searchString9" scope="session"/>
									</td>
                                  </tr>									  
                                  <tr>
                                    <td width="22%" class="td2"><div align="right"> <bean:message key="prompt.expirydate"/> >=: </div></td>
                                    <td width="78%" class="td2"> 
<bean:write name="ListVendortariffSearchForm" property="searchDate1" format="dd-MMM-yyyy" scope="session"/>									
									</td>
                                  </tr>
                                </table></td>
                            </tr>
