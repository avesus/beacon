...
public final class ListG4codeAction extends ListAction {
	...
	throws ApplicationException {
		...
		listForm.setLineItems(new G4codeBD(this.getSessionFactoryClusterMap()).findG4codesBySearch(listForm));
