...
<tr>
	<td class="tdwht"><span class="heading2">     
		...
		<span class="heading2">
			<html:link action="/ListG3code" styleClass="link5">
...
<logic:notEqual name="ListG3codeForm" property="orderBy"
			scope="session" value="G1codekey">
	<html:link action="/ListG3code?orderBy=G1codekey&gotoPage=0" styleClass="link6"><bean:message key="prompt.g1code"/></html:link>	
</logic:notEqual>
<logic:equal name="ListG3codeForm" property="orderBy"
			scope="session" value="G1codekey">
...
<logic:notEqual name="ListG3codeForm" property="orderBy"
	...
	<html:link action="/ListG3code?orderBy=G2codekey&gotoPage=0" styleClass="link6"><bean:message key="prompt.g2code"/></html:link>	
</logic:notEqual>
<logic:equal name="ListG3codeForm" property="orderBy"
			scope="session" value="G2codekey">
...
&nbsp;|&nbsp;
<logic:notEqual name="ListG3codeForm" property="orderBy"
			scope="session" value="G3codekey">
	<html:link action="/ListG3code?orderBy=G3codekey&gotoPage=0" styleClass="link6"><bean:message key="prompt.g3code"/></html:link>	
</logic:notEqual>
<logic:equal name="ListG3codeForm" property="orderBy"
			scope="session" value="G3codekey">
	<strong><bean:message key="prompt.g3code"/></strong>
</logic:equal>
    &nbsp;|&nbsp;	
<logic:notEqual name="ListG3codeForm" property="orderBy"
			scope="session" value="Ldesc">
	<html:link action="/ListG3code?orderBy=Ldesc&gotoPage=0" styleClass="link6"><bean:message key="prompt.description"/></html:link>	
</logic:notEqual>
<logic:equal name="ListG3codeForm" property="orderBy"
			scope="session" value="Ldesc">
...
<html:link action="/EditG3code?action=Create"><bean:message key="prompt.addagcode"/></html:link>								
						</td>
					</tr>
					</table>									
					</td>
...
<bean:write name="lineItem" property="g2codekey" filter="true"/>
                    					...
                    					<td class="<%= _class %>" width="10%">
<bean:write name="lineItem" property="g3codekey" filter="true"/>
					</td> 
					<td class="<%= _class %>" width="40%">
