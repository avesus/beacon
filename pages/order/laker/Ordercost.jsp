...
<head>
<logic:equal name="OrdercostForm" property="action"
...
<!-- BREADCRUMBS -----------------> 
	...
	<bean:message key="prompt.orderno"/>&nbsp;-&nbsp;<bean:write name="ListOrdercostForm" property="headerInfo1" scope="session"/>&nbsp;
</span>
		    <span class="header2">
    			<logic:equal name="OrdercostForm" property="action" scope="request" value="Create">
		    		<bean:message key="ordercost.title.create"/>
    			</logic:equal>
		    	<logic:equal name="OrdercostForm" property="action" scope="request" value="Delete">
		      		<bean:message key="ordercost.title.delete"/>
      			</logic:equal>
		    	<logic:equal name="OrdercostForm" property="action" scope="request" value="Edit">
		        	<bean:message key="ordercost.title.edit"/>
     			</logic:equal>	
		    	<logic:equal name="OrdercostForm" property="action" scope="request" value="View">
		        	<bean:message key="ordercost.title.view"/>
     			</logic:equal>	 
                </span>
                <span class="header2">&gt;</span>               	  

			             
<html:link action="/ListOrdercostLaker"><span class="header4"><bean:message key="ordercost.title.list"/></span></html:link>
<span class="header2">&gt;</span>                             
...
<html:form action="/SaveOrdercostLaker" focus="vendoraddrkey.addrkey" onsubmit="return amtCalc();">
<html:hidden property="action"/>
<html:hidden property="ordercostId"/>
...
<html:hidden property="vendtarfhdrId" value=""/>
<html:hidden property="costtype" value="LUMPSUM"/>
		...
		<html:select property="costkey" disabled="true" styleClass="forminput1"> 
			...
			<html:options collection="costs" property="costkey" labelProperty="descr"/> 
				        	...
				        	<logic:notEqual name="OrdercostForm" property="action"  scope="request" value="Delete"> 
...
<logic:notEqual name="OrdercostForm" property="action" scope="request" value="View">         
        ...
        <html:text property="unitname" size="20" maxlength="20" styleClass="forminput1"/>	
         							...
         							<tr><td class="label2"><bean:message key="prompt.cstamt"/>:</td></tr>
              						<tr><td class="label2">
        <html:text property="cstamt" size="20" readonly="true" maxlength="20" styleClass="forminput1"/>
              						</td></tr>
        ...
        <html:text property="rate" size="20" onblur="amtCalc()" maxlength="20" styleClass="forminput1"/>		
							...
							<table border="0" cellpadding="5" cellspacing="5" width="100%" bgcolor="#ffffff">   
              						...
              						<tr><td class="label2">
         <html:text property="txt" size="120" styleClass="forminput1"/>	                                   
									</td></tr>
