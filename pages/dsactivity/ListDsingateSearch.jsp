...
<div id="search" style="position:absolute; left:0px; top:0px; width:200px; height:650px; z-index:10; visibility: visible;">
  <table border="0" cellpadding="1" cellspacing="2" width="100%" class="searchBgcolor99">
    <tr>
...
<INPUT name="searchButton" border="0" type="image" id="searchButton" src="images/refreshButtonBorderGrey.gif" align="bottom" onMouseOut="MM_swapImgRestore();" onMouseOver="MM_swapImage('searchButton','','images/refreshButtonBorderGrey.gif','searchButton','','images/refreshButtonBorderGrey_over_blue.gif',1);"/>
    ...
    <tr>
      <td class="searchText99"><bean:message key="prompt.eirno"/>
        : </td>
    </tr>
    <tr>
      <td class="searchText99"><html:text property="searchString1" size="30" maxlength="40" styleClass="ftforminputsmall" onkeypress="return noenter()"/>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="left" width="60%" class="searchText99"><bean:message key="prompt.customer"/>:</td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="left" width="60%" class="searchText99"><bean:message key="prompt.depot"/>:</td>
    </tr>
    <tr>
      <td align="left" width="60%"><html:select property="searchString4" styleClass="ftforminputsmall">
          <html:option value="%">
            <bean:message key="prompt.selectadepot"/>
          </html:option>
          <html:options collection="depots" property="locationkey" labelProperty="shortName"/>
        </html:select>
      </td>
    </tr>    
    <tr>
    ...
    <tr>
      <td class="searchText99"><bean:message key="prompt.indate"/>: </td>
    </tr>
    <tr>
      <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <td class="searchText99">&nbsp;<bean:message key="prompt.from"/>:</td>
          </tr>
          <tr>
          ...
          <tr>
            <td class="searchText99">&nbsp;<bean:message key="prompt.to"/>:</td>
          </tr>
          <tr>
