 ...
 * 												
 */
public final class SaveG1codeAction extends BaseAction {
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		G1codeForm saveForm = (G1codeForm) form;
		...
		G1codeBD bd = new G1codeBD(this.getSessionFactoryClusterMap());
		
		
		// set primary key
		Integer pk = null;		
		try {
			pk = new Integer(saveForm.getG1codeId());			
		} catch (Exception e) {}
		// find data-access-object using primary key
		G1code dao = bd.read(pk);
		...
		if (action.equals("Create")) {
			...
			G1code duplicate = null;
			try{duplicate=bd.findG1codeByG1codekey(saveForm.getG1codekey());}catch(ApplicationException ae){}
			if (duplicate != null) {
				errors.add("informationMessage",new ActionMessage("error.g1code.unique"));				
			}
		}
