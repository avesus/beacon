...
<head>
<logic:equal name="G2codeForm" property="action"
...
<!-- BREADCRUMBS -----------------> 
		<tr bgcolor="#F1F1F1"><td><span class="header2">
    			<logic:equal name="G2codeForm" property="action" scope="request" value="Create">
		    		<bean:message key="gcode.title.create"/>
    			</logic:equal>
		    	<logic:equal name="G2codeForm" property="action" scope="request" value="Delete">
		      		<bean:message key="gcode.title.delete"/>
      			</logic:equal>
		    	<logic:equal name="G2codeForm" property="action" scope="request" value="Edit">
		        	<bean:message key="gcode.title.edit"/>
     			</logic:equal>		  
          		&gt;
            </span>
			<span class="header3">             
      	  		<html:link action="/ListG2code"><bean:message key="gcode.title.list"/> </html:link>        
          	</span>      						
		</td></tr>  
...
<html:form action="/SaveG2code" focus="g1codekey">
<html:hidden property="action"/>
<html:hidden property="readonly"/>
<html:hidden property="g2codeId"/>
				        	...
				        	<logic:notEqual name="G2codeForm" property="action"  scope="request" value="Delete"> 
								...
								<table border="0" cellpadding="5" cellspacing="5" width="100%" bgcolor="#ffffff">                                    
									<tr><td class="label2"><bean:message key="prompt.g1code"/>:</td></tr>
              						<tr><td class="label2">
		  <c:if test="${G2codeForm.action == 'Create'}">
