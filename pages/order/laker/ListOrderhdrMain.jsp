...
<tr><td>
	...
	<div style="width:1430px; height:650px; position:relative;">
		...
		<html:form action="/ListOrderhdrLaker" focus="searchString1">
	    <html:hidden property="gotoPage" />
    	    <jsp:include page="/pages/order/laker/ListOrderhdrSearch.jsp" flush="true" />                  
        	<jsp:include page="/pages/order/laker/ListOrderhdrResults.jsp" flush="true" />
		</html:form> 	
