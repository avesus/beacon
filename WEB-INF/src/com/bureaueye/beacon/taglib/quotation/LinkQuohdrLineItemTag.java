...
public class LinkQuohdrLineItemTag extends TagSupport {
     ...
     * The attribute name.
     */
    private String name = "quohdrLineItem";
	...
	url.append(config.getPrefix());
        url.append(page);
        QuohdrDTO lineItem = null;
	try {
		lineItem = (QuohdrDTO) pageContext.findAttribute(name);
